...
namespace Solution.Bussines.Components
{
    ...
    public class oAuthTwitterComponent : OAuthBase
    {
        ...
        private string _consumerKey = AppLogic.AppConfigs("TwitterConsumerKey");
        private string _consumerSecret = AppLogic.AppConfigs("TwitterConsumerSecret");
