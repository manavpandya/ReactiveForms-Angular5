<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true"
    CodeBehind="PaymentTypeList.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Configuration.PaymentTypeList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function checkCount() {
            ...
            if (count == 0) {
                $(document).ready(function () { jAlert('Check at least One Payment Option !', 'Message'); });
                return false;
            }
            else {
                return checkaa();
        ...
        function checkaa() {
            jConfirm('Are you sure want to delete all selected Payment Option ?', 'Confirmation', function (r) {
                if (r == true) {
    ...
    <div class="content-row1">
        <div class="create-new-order" style="width: 100%;">
            <span style="vertical-align: middle; margin-right: 3px; margin-top: 4px; float: left;">
                ...
                href="/Admin/configuration/PaymentType.aspx">
                <img alt="Add Payment Type" title="Add Payment Type" src="/App_Themes/<%=Page.Theme %>/images/add-payment-type.png" /></a></span>
        </div>
    </div>
                        ...
                        <tr>
                            <td class="border-td-sub">
                                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="add-product">
                                    <tr>
                                        <th>
                                            <div class="main-title-left">
                                                <img class="img-left" title="Payment Option" alt="Payment Option" src="/App_Themes/<%=Page.Theme %>/Images/payment-option-icon.png" />
                                                <h2>
                                                    Payment Option</h2>
                                            </div>
                                        </th>
                                    ...
                                    <tr class="altrow">
                                        <td align="right">
                                            ...
                                            <asp:ObjectDataSource ID="_gridObjectDataSource" runat="server" EnablePaging="True"
                                                TypeName="Solution.Bussines.Components.PaymentComponent" SelectMethod="GetDataByFilter"
                                                StartRowIndexParameterName="startIndex" MaximumRowsParameterName="pageSize" SortParameterName="sortBy"
                                                SelectCountMethod="GetCount">
                                                <SelectParameters>
                                                    <asp:ControlParameter ControlID="hdnpayment" DbType="String" DefaultValue="StateID"
                                                        Name="CName" />
                                                    <asp:ControlParameter ControlID="drpstore" DbType="Int32" DefaultValue="" Name="pStoreId" />
                                    ...
                                    <tr class="even-row">
                                        <td>
                                            <asp:GridView ID="grdpayment" runat="server" AutoGenerateColumns="False" DataKeyNames="PaymentId"
                                                ...
                                                CellPadding="2" DataSourceID="_gridObjectDataSource" OnRowDataBound="_paymentgridview_RowDataBound"
                                                OnRowCommand="_paymentgridview_RowCommand">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Payment Type" HeaderStyle-Width="25%">
                                                        <HeaderTemplate>
                                                            Payment Type
                                                            <asp:ImageButton ID="lbName" runat="server" CommandArgument="DESC" CommandName="PaymentType"
                                                                AlternateText="Ascending Order" OnClick="Sorting" />
                                                        </HeaderTemplate>
                                                        <ItemStyle HorizontalAlign="Left" />
                                                        <HeaderStyle HorizontalAlign="Left" />
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbpayment" runat="server" Text='<%# bind("PaymentType") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Operations" HeaderStyle-Width="15%">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:ImageButton runat="server" ID="_editLinkButton" ToolTip="Edit" CommandName="edit"
                                                                CommandArgument='<%# Eval("PaymentID") %>'></asp:ImageButton>
                                                            <asp:ImageButton runat="server" ID="_deleteLinkButton" ToolTip="Delete" CommandName="Deletepayment"
                                                                CommandArgument='<%# Eval("PaymentID") %>' message="Are you sure want to delete current Payment Option ?"
