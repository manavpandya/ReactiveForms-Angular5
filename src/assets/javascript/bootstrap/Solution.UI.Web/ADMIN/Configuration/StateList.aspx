<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true"
    CodeBehind="StateList.aspx.cs" Inherits="Solution.UI.Web.ADMIN.configuration.ListState" %>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Operations">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:ImageButton runat="server" ID="_deleteLinkButton" ToolTip="Delete" CommandName="DeleteState"
                                                                    CommandArgument='<%# Eval("StateID") %>' message='<%# Eval("StateID") %>' OnClientClick='return checkondelete(this.getAttribute("message"));'>
                                                                </asp:ImageButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
