<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true"
    CodeBehind="TestimonialList.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Content.TestimonialList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function checkondelete(id, name) {
            ...
            var a;
            if (name == "Approve") {
                a = 'Are you sure you want to Approve Testimonial?';
            }
            else
                a = 'Are you sure you want to Disapprove Testimonial?';
    ...
    <script language="javascript" type="text/javascript">
        function checkCount() {
            ...
            if (count == 0) {
                $(document).ready(function () { jAlert('Check at least One Testimonial !', 'Message'); });
                return false;
            }
            else {
                var message = "Do you want to Approve all selected Testimonials ?";
                        ...
                        <tr>
                            <td class="border-td-sub">
                                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="add-product">
                                    <tr>
                                        <th>
                                            <div class="main-title-left">
                                                <img class="img-left" title="Testimonial List" alt="Testimonial List" src="/App_Themes/gray/Images/product-rating-icon.png" />
                                                <h2>
                                                    Testimonial List</h2>
                                            </div>
                                        </th>
                                    ...
                                    <tr class="altrow">
                                        <td>
                                            ...
                                            <asp:ObjectDataSource ID="_gridObjectDataSource" runat="server" EnablePaging="True"
                                                TypeName="Solution.Bussines.Components.TestimonialComponent" SelectMethod="GetDataByFilterForTestimonials"
                                                StartRowIndexParameterName="startIndex" MaximumRowsParameterName="pageSize" SortParameterName="sortBy"
                                                SelectCountMethod="GetCount">
                                                <SelectParameters>
                                                    <asp:ControlParameter ControlID="hdnrating" DbType="String" DefaultValue="TestimonialID"
                                                        Name="CName" />
                                    ...
                                    <tr class="even-row">
                                        <td>
                                            <asp:GridView ID="grdTestimonials" runat="server" AutoGenerateColumns="False" EmptyDataText="No Record(s) Found."
                                                ...
                                                BorderStyle="Solid" BorderColor="#E7E7E7" BorderWidth="1" OnRowDataBound="grdTestimonials_RowDataBound"
                                                CellSpacing="1" OnRowCommand="grdTestimonials_RowCommand">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Select" Visible="false">
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:HiddenField ID="hdntestimonialid" runat="server" Value='<%#Eval("TestimonialID") %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Name" ItemStyle-Width="30%">
                                                        ...
                                                        <ItemTemplate>
                                                            <%--<a style="color: #212121; text-decoration: underline" href='<%# "Product.aspx?Mode=edit&ID=" + DataBinder.Eval(Container.DataItem,"ProductID")+"&StoreID=" + DataBinder.Eval(Container.DataItem,"StoreID") %>'></a>--%>
                                                            <asp:Label ID="lbname" runat="server" Text='<%# bind("Name") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Name" ItemStyle-Width="10%" Visible="false">
                                                        <ItemStyle HorizontalAlign="Left" />
                                                        <HeaderStyle HorizontalAlign="Left" />
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbcustomername" runat="server" Text='<%# bind("Name") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Approve" ItemStyle-Width="10%">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:ImageButton runat="server" ID="btnApprove" ImageUrl="/App_Themes/<%= Page.Theme %>/images/approve.png"
                                                                ToolTip="Approve" CommandName="Approve" CommandArgument='<%# Eval("TestimonialID") %>'
                                                                message='<%# Eval("TestimonialID") %>' OnClientClick='return checkondelete(this.getAttribute("message"),"Approve");'>
                                                            </asp:ImageButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Disapprove" ItemStyle-Width="10%">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:ImageButton runat="server" ID="btnUnApprove" ImageUrl="/App_Themes/<%= Page.Theme %>/images/disapprove.png"
                                                                ToolTip="Disapprove" CommandName="Disapprove" CommandArgument='<%# Eval("TestimonialID") %>'
                                                                message='<%# Eval("TestimonialID") %>' OnClientClick='return checkondelete(this.getAttribute("message"),"Disapprove");'>
                                                            </asp:ImageButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            ...
                                            <table width="100%">
                                                <tr id="trBottom" runat="server">
                                                    ...
                                                    <td align="right" style="width: 10%">
                                                        <asp:ImageButton ID="btnapproverating" runat="server" ToolTip="Delete" OnClientClick='return checkCount()'
