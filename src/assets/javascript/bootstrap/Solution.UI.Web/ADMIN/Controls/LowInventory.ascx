<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LowInventory.ascx.cs"
    Inherits="Solution.UI.Web.ADMIN.Controls.LowInventory" %>
<div>
                ...
                <th>
                    <div class="main-title-left">
                        <img src="/App_Themes/<%=Page.Theme %>/icon/item-by-sale.png" alt="Top 10 Low Inventory Items"
                            title="Top 10 Low Inventory Items" class="img-left" />
                        <h2>
                            Top 10 Low Inventory Items</h2>
                    </div>
                    <div class="main-title-right">
                        <a title="Minimize" href="javascript:void(0);" onclick="ShowDiv('imgLinvt','trlowinventory','tblLowInvtlst');">
                            <img class="minimize" title="Minimize" id="imgLinvt" alt="Minimize" src="/App_Themes/<%=Page.Theme %>/images/minimize.png" /></a>
                    </div>
                </th>
            </tr>
            <tr id="trlowinventory">
                <td align="center" valign="middle">
                    <asp:GridView ID="grdLowInventory" runat="server" CssClass="dashboard-left" CellPadding="0"
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tbody>
                            <tr>
                                ...
                                <td align="right" width="50%">
                                    <a title="View List" href="/Admin/Reports/LowInventory.aspx?Storeid=<%=storeid%>" style="cursor: pointer;"><span>View List</span></a>
