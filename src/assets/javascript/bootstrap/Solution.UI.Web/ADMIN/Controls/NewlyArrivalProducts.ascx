<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NewlyArrivalProducts.ascx.cs" Inherits="Solution.UI.Web.ADMIN.Controls.NewlyArrivalProducts" %>
<div>
            ...
            <tr>
                <th>
                    <div class="main-title-left">
                        <img src="/App_Themes/<%=Page.Theme %>/icon/item-by-sale.png" alt="NewArrival Products"
                            title="NewArrival Products" class="img-left" />
                        <h2>
                            New Arrival Products</h2>
                    </div>
                    <div class="main-title-right">
                        <a title="Minimize" href="javascript:void(0);" onclick="ShowDiv('imgNewArrivalItem','trNewArrivalProduct','tblNewArrivalItem');">
                            <img class="minimize" title="Minimize" id="imgNewArrivalItem" alt="Minimize" src="/App_Themes/<%=Page.Theme %>/images/minimize.png" /></a>
                    </div>
                </th>
            </tr>
            <tr id="trNewArrivalProduct">
                <td align="center" valign="middle">
                    <asp:GridView ID="grdNewArrivalProducts" runat="server" CssClass="dashboard-left" CellPadding="0"
                        ...
                        OnRowDataBound="grdNewArrivalProducts_RowDataBound">
                        <Columns>
