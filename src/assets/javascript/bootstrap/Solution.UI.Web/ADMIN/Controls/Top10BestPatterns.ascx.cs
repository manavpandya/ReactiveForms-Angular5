...
{
    public partial class Top10BestPatterns : System.Web.UI.UserControl
    {
        public int storeid = 1;

        protected void Page_Load(object sender, EventArgs e)
        {
            TopTenBestSellingPattern();
        }
        /// <summary>
        ...
        private void TopTenBestSellingPattern()
        {
            ...
            if (objCon != null)
            {
                ...
                storeid = ss;
                dsTop5Items = DashboardComponent.GetTop10BestSellingPattern(ss);
                if (dsTop5Items != null && dsTop5Items.Tables.Count > 0 && dsTop5Items.Tables[0].Rows.Count > 0)
                {
                    grdTopPatternlist.DataSource = dsTop5Items.Tables[0];
                    grdTopPatternlist.DataBind();
                    tdviewReport.Visible = true;
                }
                else
                {
                    grdTopPatternlist.DataSource = null;
                    grdTopPatternlist.DataBind();
