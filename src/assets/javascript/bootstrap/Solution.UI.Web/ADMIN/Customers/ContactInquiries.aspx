<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true"
    CodeBehind="ContactInquiries.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Customers.ContactInquiries" %>
                                            ...
                                            <td align="center" colspan="3">
                                                <div id="divGrid">
                                                    <asp:GridView ID="grvContactReport" runat="server" AutoGenerateColumns="False" BorderStyle="Solid"
                                                        ...
                                                        OnPageIndexChanging="grvContactReport_PageIndexChanging">
                                                        <Columns>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    Name
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <a href="javascript:void(0);" style="color: #212121;" onclick="OpenCenterWindow('/admin/Reports/ContactDetails.aspx?MID=<%# DataBinder.Eval(Container.DataItem,"ContactUsID") %>',800,400);">
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <HeaderStyle HorizontalAlign="Center" />
                                                                <ItemTemplate>
                                                                    <a href="javascript:void(0);" style="color: #212121;" onclick="OpenCenterWindow('/admin/Reports/ContactSendMail.aspx?MID=<%# DataBinder.Eval(Container.DataItem,"ContactUsID") %>',800,400);">
