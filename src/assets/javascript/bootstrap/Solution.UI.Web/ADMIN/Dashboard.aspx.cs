...
{
    /// <summary>
    /// DashBoard Store related Information     
    /// <author>
    ...
    public partial class Dashboard : BasePage
    {
        ...
        {
            if (Session["AdminType"] != null && Session["AdminType"].ToString() != "0" && Session["AdminType"].ToString() != "3")
            {
            ...
            if (Session["AdminID"] != null)
            {
                ...
                if (admin != null && admin.Rights != null)
                {
                    ...
                    {
                        spanDashboardSetting.Visible = true;
                    }
                    else
                    {
