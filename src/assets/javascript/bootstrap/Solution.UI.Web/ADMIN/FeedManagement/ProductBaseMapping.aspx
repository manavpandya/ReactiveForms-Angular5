<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true"
    CodeBehind="ProductBaseMapping.aspx.cs" Inherits="Solution.UI.Web.ADMIN.FeedManagement.ProductBaseMapping" %>
                                        ...
                                        <tr>
                                            <th>
                                                <div class="main-title-left">
                                                    <img class="img-left" title="Product - Base Mapping" alt="Product - Base Mapping" src="/App_Themes/<%=Page.Theme %>/Images/admin-list-icon.png">
                                                    <h2>
                                                        <asp:Label runat="server" Text="Product - Base Mapping" ID="lblTitle"></asp:Label></h2>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr class="altrow">
                                                            ...
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td align="left" style="height: 30px;" valign="top">
                                                                        <asp:ListBox ID="lbProductSchema" runat="server" Height="500px" Width="300px"></asp:ListBox>
                                                                        <br />
                                                                        <asp:RequiredFieldValidator ID="rfvProductSchema" runat="server" ControlToValidate="lbProductSchema"
                                                                        ...
                                                                        <asp:GridView ID="grdMappedFields" runat="server" AutoGenerateColumns="False" CellPadding="3"
                                                                            ...
                                                                            <Columns>
                                                                                <asp:TemplateField>
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="lblProductField" Font-Size="12px" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"ProductField") %>'></asp:Label>
                                                                                    </ItemTemplate>
                                                                                ...
                                                                                <asp:TemplateField>
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="lblFieldName" Font-Size="12px" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"FieldName") %>'></asp:Label>
                                                                                    </ItemTemplate>
                                                                                    <HeaderStyle BackColor="#E7E7E7" HorizontalAlign="Left" />
                                                                                    <ItemStyle HorizontalAlign="Left" />
                                                                                </asp:TemplateField>
                                                                                <asp:TemplateField>
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <asp:HiddenField ID="hdnProductMappingID" runat="server" Value='<%#Eval("ProductMappingID") %>' />
                                                                                        <div style="text-align: center">
                                                                                            <asp:ImageButton ID="btnRemove" runat="server" ImageUrl="~/Admin/images/delete-icon.gif"
                                                                                                CommandArgument='<%#Eval("ProductMappingID") %>' CommandName="Remove" OnClientClick="return ConfirmRemove()" />
                                                                                        </div>
                                                                                    </ItemTemplate>
                                                                                    <HeaderStyle BackColor="#E7E7E7" HorizontalAlign="Left" />
