<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true"
    CodeBehind="BulkOrderPrint.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Orders.BulkOrderPrint" %>
                                    ...
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="add-product">
                                            ...
                                            <td align="right" colspan="2">
                                                <table cellpadding="3" cellspacing="3">
                                                    <tr>
                                                        ...
                                                        <td align="right">
                                                            <asp:Button ID="btnPrintBulk" runat="server" OnClientClick="return chkSelect();"
                                                                OnClick="btnPrintBulk_Click" />
                                                        </td>
                                                        <td align="right" style="display:none;">
                                                            <asp:Button ID="btnPrintBulkpackage" Text="Print Package Slip" runat="server" OnClientClick="return chkSelect();"
                                                                OnClick="btnPrintBulkpackaeSlip_Click" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        ...
                                        <tr id="trTop" runat="server">
                                            ...
                                            <%--<td align="right" colspan="2" style="padding-right: 10px;">
                                                <asp:Button ID="Button1" runat="server" OnClick="btnPrintBulk_Click" />
                                            </td>--%>
                                        </tr>
                                        <tr>
                                            <td align="center" colspan="3">
                                                <div id="divGrid">
                                                    <asp:GridView ID="grvBulkPrint" runat="server" CssClass="order-table" BorderStyle="Solid"
                                                        ...
                                                        EmptyDataRowStyle-HorizontalAlign="Center" OnPageIndexChanging="grvBulkPrint_PageIndexChanging"
                                                        OnRowDataBound="grvBulkPrint_RowDataBound">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Is Printed" HeaderStyle-Width="10%">
                                                                <ItemTemplate>
                                                                    <asp:Literal ID="ltrPrinted" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"Isprinted") %>'></asp:Literal>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Center" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                        ...
                                        <tr id="trBottom" runat="server">
                                            ...
                                            <%--<td align="right" colspan="2" style="padding-right: 10px;">
                                                <asp:Button ID="btnPrintBulk" runat="server" OnClick="btnPrintBulk_Click" />
                                            </td>--%>
                                        </tr>
                                    </table>
                                </td>
