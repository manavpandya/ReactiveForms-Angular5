<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerQuoteProductSku.aspx.cs"
    Inherits="Solution.UI.Web.ADMIN.Orders.CustomerQuoteProductSku" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function chkAddtocartForMadetoMeasure(RowIndex) {
            ...
            if (document.getElementById('gvListProducts_ddlcustomstyle_' + RowIndex + '') != null && document.getElementById('gvListProducts_ddlcustomstyle_' + RowIndex + '').selectedIndex > 0) {
                ...
                strMeasureValue = strMeasureValue + document.getElementById('gvListProducts_ddlcustomstyle_' + RowIndex + '').options[document.getElementById('gvListProducts_ddlcustomstyle_' + RowIndex + '').selectedIndex].value.replace(' ', '') + ',';
            }
            if (document.getElementById('gvListProducts_ddlcustomwidth_' + RowIndex + '') != null && document.getElementById('gvListProducts_ddlcustomwidth_' + RowIndex + '').selectedIndex > 0) {
            ...
            if (document.getElementById('gvListProducts_ddlcustomoptin_' + RowIndex + '') != null && document.getElementById('gvListProducts_ddlcustomoptin_' + RowIndex + '').selectedIndex > 0) {
                ...
                strMeasureValue = strMeasureValue + document.getElementById('gvListProducts_ddlcustomoptin_' + RowIndex + '').options[document.getElementById('gvListProducts_ddlcustomoptin_' + RowIndex + '').selectedIndex].value.replace(' ', '') + ',';
            }
            //            if (document.getElementById('gvListProducts_dlcustomqty_' + RowIndex + '') != null && document.getElementById('gvListProducts_dlcustomqty_' + RowIndex + '').selectedIndex > 0) {
        ...
        function chkAddtocart(RowIndex, IsRoman) {
            ...
            for (k = 0; k < allDiv.length; k++) {
                ...
                if (controlid.id == "divSelectvariant-0") {
                        ...
                        if (eltSelect.type == "radio") {
                            if (eltSelect.checked == true) {
                                if (eltSelect.id.indexOf('Selectvariant-000') > -1) {
                                    ...
                                    strname = strname + 'Width' + ',';
                                    strvalue = strvalue + Width + ',';
                                }
                ...
                if (controlid.id == "divSelectvariant-9999999") {
                    strname = strname + "divvariantname=";
                    strvalue = strvalue + "divvariantname=";
                    var allselect01 = document.getElementById(controlid.id).getElementsByTagName('input');
                    for (var iS = 0; iS < allselect01.length; iS++) {
                ...
                if (controlid.id == "divSelectvariant-200000") {
                    strname = strname + "divvariantname=";
                    strvalue = strvalue + "divvariantname=";
                    var allselect01 = document.getElementById(controlid.id).getElementsByTagName('input');
                    for (var iS = 0; iS < allselect01.length; iS++) {
                ...
                if (controlid.id == "divSelectvariant-100000") {
                    strname = strname + "divvariantname=";
                    strvalue = strvalue + "divvariantname=";
                    var allselect01 = document.getElementById(controlid.id).getElementsByTagName('input');
                    for (var iS = 0; iS < allselect01.length; iS++) {
                    ...
                    if (controlid.id.indexOf('divvariantname-') > -1) {
                        ...
                        if (document.getElementById(divVarival) != null) {
                            ...
                            for (var iS = 0; iS < allselect.length; iS++) {
                                ...
                                if (eltSelect.type == "radio") {
                                    if (eltSelect.checked == true) {
                                        if (eltSelect.id.indexOf('Selectvariant-000') > -1 || eltSelect.id.indexOf('SelectvariantExtraWidthValue-0') > -1 || eltSelect.id.indexOf('Selectvariant-9999999') > -1 || eltSelect.id.indexOf('SelectvariantExtraLengthValue-9999999') > -1 || eltSelect.id.indexOf('Selectvariant-20000') > -1 || eltSelect.id.indexOf('Selectvariant-10000') > -1) {
        ...
        function PriceChangeondropdownforroman(RowIndex) {
            ...
            var Width = "", Width2 = "", Length = "", Length2 = "", options = "";
        ...
        function ChangeCustomprice(productid, RowIndex) {
            ...
            //if (document.getElementById('gvListProducts_ddlcustomstyle_' + RowIndex + '') != null && document.getElementById('gvListProducts_ddlcustomstyle_' + RowIndex + '').selectedIndex != 0)
            // && document.getElementById('gvListProducts_ddlcustomoptin_' + RowIndex + '').selectedIndex != 0 && document.getElementById('gvListProducts_ddlcustomlength_' + RowIndex + '').selectedIndex != 0 && document.getElementById('gvListProducts_ddlcustomwidth_' + RowIndex + '').selectedIndex != 0 && document.getElementById('gvListProducts_dlcustomqty_' + RowIndex + '').selectedIndex != 0) 
            //{

            //            var allselect = document.getElementById('gvListProducts_divSelectcustomstyle_' + RowIndex).getElementsByTagName('input');
            //            for (var iS = 0; iS < allselect.length; iS++) {
            //                var eltSelect = allselect[iS];
            //                if (eltSelect.type == "radio") {
            //                    if (eltSelect.checked == true) {
            ...
            //            var divcustomwidth = document.getElementById('gvListProducts_divSelectcustomwidth_' + RowIndex).getElementsByTagName('input');
            //            for (var iS = 0; iS < divcustomwidth.length; iS++) {
            //                var eltSelect = divcustomwidth[iS];
            //                if (eltSelect.type == "radio") {
            ...
            //            var divcustomlength = document.getElementById('gvListProducts_divSelectcustomlength_' + RowIndex).getElementsByTagName('input');
            //            for (var iS = 0; iS < divcustomlength.length; iS++) {
            //                var eltSelect = divcustomlength[iS];
            //                if (eltSelect.type == "radio") {
            //                    if (eltSelect.checked == true) {
            //                        lid = eltSelect.value;
            //                    }
            ...
            //            var divcustomoptin = document.getElementById('gvListProducts_divSelectcustomoptin_' + RowIndex).getElementsByTagName('input');
            //            for (var iS = 0; iS < divcustomoptin.length; iS++) {
            //                var eltSelect = divcustomoptin[iS];
            //                if (eltSelect.type == "radio") {
            //                    if (eltSelect.checked == true) {
            //                        oid = eltSelect.value;
            ...
            //            var divcustomqty = document.getElementById('gvListProducts_divSelectcustomqty_' + RowIndex).getElementsByTagName('input');
            //            for (var iS = 0; iS < divcustomqty.length; iS++) {
            //                var eltSelect = divcustomqty[iS];
            //                if (eltSelect.type == "radio") {
            //                    if (eltSelect.checked == true) {
            //                        qid = eltSelect.value;
            //                    }
                                        ...
                                        <tr style="background-color: #E5F0EF; height: 26px">
                                            ...
                                            <td align="right" style="padding-top: 5px; padding-right: 5px; background-color: #fff !important;">
                                                <asp:ImageButton ID="btnSubmit" OnClientClick="chkHeight();" runat="server" OnClick="btnSubmit_Click"
                                                    Visible="false" />
                                                <asp:ImageButton ID="ImgColse2" runat="server" Style="border: 0px" OnClick="ClearShopping" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="3">&nbsp;
                                        ...
                                        <div style="background-color: rgb(242, 242, 242); height: 20px; font-weight: bold; padding-top: 2px; width: 100%; border-bottom: 1px solid #C1C1C1;">
                                            <table cellpadding="0" cellspacing="0" id="divgridhead" runat="server" style="width: 100%">
                                                <tr>
                                                    ...
                                                    <td width="10%" id="tdDiscountPrice" runat="server" visible="false" align="center">Discount&nbsp;Price&nbsp;<asp:Label ID="lblHeaderDiscount" runat="server"></asp:Label>
                                                    </td>
                                                ...
                                                <Columns>
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:Label ID="lblCustomerCartId" runat="server" Visible="false" Text='<%#DataBinder.Eval(Container.DataItem,"CustomerQuoteItemID") %>'></asp:Label>
                                                            ...
                                                            <asp:Label ID="lblProductType" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"ProductType") %>'
                                                                Visible="false"></asp:Label>
                                                            <asp:Label ID="lblisProductType" runat="server" Visible="false" Text='<%# Eval("ProductType")%>'></asp:Label>
                                                    ...
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            ...
                                                            <%--  $<%# Math.Round(Convert.ToDecimal(DataBinder.Eval(Container.DataItem, "Price")), 2)%>--%>
                                                            <asp:Label ID="lblSalePrice" runat="server" Text='<%#Eval("Price")%>' Visible="false"></asp:Label>
                                                        </ItemTemplate>
                                                        <ItemStyle Width="10%" HorizontalAlign="center" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            $<asp:Label ID="lblGridPrice" runat="server" Text='<%# GetSubTotal(Convert.ToDecimal(DataBinder.Eval(Container.DataItem,"Price")), Convert.ToInt32(DataBinder.Eval(Container.DataItem,"Quantity"))) %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <ItemStyle Width="10%" HorizontalAlign="Right" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="btndel" runat="server" ImageUrl="~/Admin/images/btndel.gif"
                                                                ...
                                                                CommandArgument='<%# DataBinder.Eval(Container.DataItem,"CustomerQuoteItemID") %>'
                                                                CommandName="delMe" />
                                                        </ItemTemplate>
                                            ...
                                            <asp:GridView ID="gvListProducts" runat="server" AutoGenerateColumns="False" BorderStyle="Solid"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Quanity" HeaderStyle-ForeColor="White">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtProQty" Width="25" onkeypress="return onKeyPressBlockNumbers(event);"
