<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Invoice.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Orders.Invoice" %>
...
<body style="background: none !important; font-family: Arial, Helvetica, sans-serif; font-size: 11px;
    color: #2A2A2A;">
    ...
    <div class="body12">
        ...
        <table width="100%" cellspacing="0" cellpadding="0" align="center" class="table">
                        ...
                        <div align="center" class="bkground123">
                            <table width="100%" cellspacing="0" cellpadding="0" align="center" class="popup_cantain">
                                <tbody>
                                    ...
                                    <tr>
                                        <td align="left">
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="popup_cantain">
                                                <tr>
         ...
         <img src='/images/watermark_canceled.png' style='left:30%;top:30%;position:fixed;z-index:1000;' id="idcanceledtag" runat="server" alt="" visible="false" />
    </div>
