<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PopUpProduct.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Customers.PopUpProduct" %>
    ...
    <script type="text/javascript">
        ...
        function checkCount() {
            ...
            if (count == 0) {
                ...
                var strSku = "";
                for (var i = 0; i < 20; i++) {
                    if (document.getElementById('grdProduct_txtQuantity_' + i)) {
                        if (document.getElementById('grdProduct_chkSelect_' + i).checked) {
                            var discount = parseFloat(document.getElementById('grdProduct_txtQuantity_' + i).value);
                            if (discount == 0) {
                ...
                if (Skus.length > 0) {
                    alert('Please enter Quantity for following SKU(s): ' + Skus);
                    return false;
                }
            }
            return true;
                            ...
                            <asp:GridView ID="grdSelected" runat="server" AutoGenerateColumns="False" CellPadding="0"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            &nbsp;
                                            <asp:TextBox ID="lblSKU" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"SKU") %>'></asp:TextBox>
                                        </ItemTemplate>
                                        <ItemStyle Width="12%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                            ...
                            <asp:GridView ID="grdProduct" runat="server" AutoGenerateColumns="False" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Quantity">
                                        ...
                                        <ItemStyle />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtQuantity" Text="0" runat="server" Width="70px" CssClass="textboxcommonstyle" Style="text-align: center"
