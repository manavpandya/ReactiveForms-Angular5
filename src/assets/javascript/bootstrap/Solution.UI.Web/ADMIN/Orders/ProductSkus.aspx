<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductSkus.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Orders.ProductSkus" %>
...
//        function chkAddtocart(RowIndex) {
//            var strname = "";
//            var strvalue = "";
...
//                                    if (eltSelect.id.indexOf('SelectvariantExtraWidthValue') > -1) {
//                                        strname = strname + 'Width,';
//                                        strvalue = strvalue + eltSelect.value + ',';
//                                    }
//                                    else if (eltSelect.id.indexOf('SelectvariantExtraLengthValue') > -1) {
...
//            return false;
        ...
        function chkAddtocart(RowIndex, IsRoman) {
            ...
            for (k = 0; k < allDiv.length; k++) {
                ...
                if (controlid.id == "divSelectvariant-9000000") {
                    strname = strname + "divvariantname=";
                    strvalue = strvalue + "divvariantname=";
                    var allselect01 = document.getElementById(controlid.id).getElementsByTagName('input');
                    for (var iS = 0; iS < allselect01.length; iS++) {
                            ...
                            if (eltSelect.type == "radio") {
                                if (eltSelect.checked == true) {
                                    if (eltSelect.id.indexOf('SelectvariantExtraValue') > -1) { }
                                        ...
                                        //  strvalue = strvalue + eltSelect.value.replace(' ', '') + ',';
                                        strvalue = strvalue + eltSelect.value + ',';
                                }
                            }
                        }
        ...
        function PriceChangeondropdown(RowIndex) {
            ...
            var qid = '0';
            //var pid = document.getElementById('gvListProducts_hdnproductid_' + RowIndex).innerHTML;
            //document.getElementById('hdnType').value = document.getElementById('gvListProducts_hdnCurrTabvalue_' + RowIndex).value;
        ...
        function PriceChangeondropdownforroman(RowIndex) {
            ...
            var strMeasureValue = document.getElementById('hdnforMeasureVValue').value;
            if (strMeasureName == "") {
                strMeasureName = 'Width,Width2,Length,Length2,options,';
            }
            if (strMeasureValue == "") {
                strMeasureValue = Width + ',' + Width2 + ',' + Length + ',' + Length2 + ',' + options + ',';
            }
            $.ajax(
                        {
                            type: "POST",
...
<body style="background: none;" onunload="refresh();">
                                    ...
                                    <tr style="background-color: #E5F0EF; height: 26px">
                                        ...
                                        <td align="right" style="padding-top: 5px; padding-right: 5px; background-color: #fff !important;">
                                           ...
                                           <asp:ImageButton ID="ImgColse2" OnClientClick="chkHeight();" runat="server" Style="border: 0px"
                                                OnClick="ClearShopping" Visible="false" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="3">
                                ...
                                <div style="border: 1px solid #C1C1C1; font-size: 11px; color: #323232; font-family: Verdana,Arial,Helvetica,sans-serif;">
                                    <div style="background-color: rgb(242, 242, 242); height: 20px; font-weight: bold;
                                        ...
                                        <table cellpadding="0" cellspacing="0" id="divgridhead" runat="server" style="width: 100%">
                                            <tr>
                                                ...
                                                <td width="10%" id="tdDiscountPrice" runat="server" visible="false" align="center">
                                                    Dis.price<asp:Label ID="lblHeaderDiscount" runat="server"></asp:Label>
                                                </td>
                                                <td width="10%" align="center">
                                                    SubTotal&nbsp;
                                                </td>
                                    ...
                                    <div id="divselected" runat="server" style="padding-left: 5px;">
                                        <asp:GridView ID="grdSelected" runat="server" AutoGenerateColumns="False" BorderStyle="Solid"
                                            CellPadding="0" CellSpacing="1" CssClass="list-table-border" GridLines="Horizontal"
                                            ...
                                            <Columns>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Label ID="lblChnageOrderProductId" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"ProductId") %>'
                                                            Visible="false"></asp:Label>
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblQtyGrid" runat="server" Style="padding-left: 15px" Text='<%# DataBinder.Eval(Container.DataItem,"Quantity") %>'></asp:Label>
                                                    </ItemTemplate>
                                    ...
                                    <tr>
                                        ...
                                        <td style="color: #666666; font-size: 12px; font-family: Verdana,Arial,Helvetica,sans-serif;"
                                            ...
                                            <asp:ImageButton ID="btnSelectItem" runat="server" OnClick="btnSelectItem_Click"
                                                Visible="false" OnClientClick="return chkselect();" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                                        ...
                                                        <div style="display: none; position: absolute; width: 70%; background-color: #fbfbfb;
                                                            ...
                                                            <div style="float: left; margin: 10px; text-align: left; width: 100%;" id="divproductvariant"
                                                                        ...
                                                                        <ul class="tabbernav">
                                                                            <li class="tabberactive" id="liready" runat="server" onclick="tabdisplaycart(this.id,1);">
                                                                                <a href="javascript:void(null);" title="READY MADE" id="areadymade" runat="server">READY
                                                                                    MADE</a></li><li onclick="tabdisplaycart(this.id,2);" id="licustom" runat="server"><a
                                                                                        href="javascript:void(null);" title="MADE TO ORDER" id="amadetomeasure" runat="server">
                                                                                        MADE TO ORDER</a></li></ul>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div id="content-right1" class="tabberlive">
                                                                    <div class="tabbertab" id="divready" runat="server" style="padding-top: 5px; padding-left: 5px;
                                                                        ...
                                                                        <div class="readymade-detail-pt1" style="border-bottom: 1px dotted #E7E7E7; margin-bottom: 5px;
                                                                            display: none;" id="divallowlockQty" runat="server">
                                                                        ...
                                                                        <div class="readymade-detail-pt1" style="color: #000; font-weight: normal;">
                                                                            <div class="readymade-detail-left">
                                                                                <span style="color: #848383; float: left; font-family: Arial,Helvetica,sans-serif;
                                                                                    font-size: 12px; line-height: 25px;">Quantity :</span>
                                                                            </div>
                                                                    ...
                                                                    <div class="tabbertab" id="divcustom" runat="server" style="display: none; padding-top: 5px;
                                                                        padding-left: 5px; width: 96%; background: none repeat scroll 0 0 #FFFFFF;">
                                                                        <div>
                                                                                ...
                                                                                <div class="readymade-detail-pt1" style="border-bottom: 1px dotted #E7E7E7; margin-bottom: 5px;">
                                                                                    <table align="left" cellpadding="0" cellspacing="0">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td align="left" style="font-weight: bold;">
                                                                                                &nbsp;&nbsp;&nbsp;<asp:Label ID="lblAvailaDate" Font-Size="11px" runat="server"></asp:Label>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </div>
