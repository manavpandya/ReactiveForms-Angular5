<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewFailedTransaction.aspx.cs"
    Inherits="Solution.UI.Web.ADMIN.Orders.ViewFailedTransaction" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Failed Order Transaction Detail(s)</title>
    <style type="text/css">
    ...
    <div>
        <table width="624" border="0" align="center" cellpadding="0" cellspacing="0" class="popup_docwidth">
            ...
            <tr style="min-height:250px;">
                <td>
                    <table border="0" align="left" cellpadding="0" cellspacing="0" id="tblMaintbl" runat="server">
                        <tr>
                            <td width="20">
                                &nbsp;
                            </td>
                    ...
                    <center>
                        <span style="font-size: 12px; color: red;" id="lblMsg" runat="server"></span>
                    </center>
                </td>
            </tr>
            <tr>
