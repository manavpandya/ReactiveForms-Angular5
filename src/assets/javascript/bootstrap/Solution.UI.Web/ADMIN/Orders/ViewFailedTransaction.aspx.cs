...
{
    public partial class ViewFailedTransaction : System.Web.UI.Page
    {
        /// <summary>
        /// Page Load Event
        /// </summary>
        ...
        private void GetOrderDetails(Int32 OrderNumber)
        {
            ...
            if (objDsorder != null && objDsorder.Tables.Count > 0 && objDsorder.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    ltrorderNumber.Text += " (Ref. Order #: " + objDsorder.Tables[0].Rows[0]["ReforderId"].ToString() + ")";
                }
