<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WarehousePOPopup.aspx.cs"
    Inherits="Solution.UI.Web.ADMIN.Orders.WarehousePOPopup" %>
                            ...
                            <asp:GridView ID="grdProduct" runat="server" AutoGenerateColumns="False" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Name">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblAvailInventory" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Inventory") %>'></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Name">
                                        ...
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtQuantity" runat="server" Text='<%#Bind("Inventory") %>' onkeypress="return keyRestrict(event,'0123456789');"
                                                Width="80%" MaxLength="4" Style="text-align: center"></asp:TextBox>
                                        </ItemTemplate>
                                        <HeaderStyle Width="10%" HorizontalAlign="Center" />
                                        <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                    </asp:TemplateField>
