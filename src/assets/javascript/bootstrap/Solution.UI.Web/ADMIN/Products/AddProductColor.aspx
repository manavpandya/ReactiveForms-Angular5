<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true"
    CodeBehind="AddProductColor.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Product.AddProductColor"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function ValidatePage() {
            ...
            if ((document.getElementById('ContentPlaceHolder1_txtColor').value).replace(/^\s*\s*$/g, '') == '') {
                jAlert('Please Enter Color Name', 'Message', 'ContentPlaceHolder1_txtColor');
                $('html, body').animate({ scrollTop: $('#ContentPlaceHolder1_txtColor').offset().top }, 'slow');
                return false;
            }
                                    ...
                                    <tr style="width: 1126px;">
                                        <th>
                                            <div class="main-title-left">
                                                <img class="img-left" title="Add Product Color" alt="Add Product Color" src="/App_Themes/<%=Page.Theme %>/images/add-product-icon.png" />
                                                <h2 style="padding-top: 3px;">Add Product Color</h2>
                                            </div>
                                                        ...
                                                        <td>
                                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                <tr class="altrow">
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtColor" runat="server" MaxLength="500" class="order-textfield"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr class="altrow">
                                                                    <td width="13%">
