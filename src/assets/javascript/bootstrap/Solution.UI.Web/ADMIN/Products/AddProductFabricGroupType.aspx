<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true"
    CodeBehind="AddProductFabricGroupType.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Product.AddProductFabricGroupType"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function ValidatePage() {
            ...
            if ((document.getElementById('ContentPlaceHolder1_txtFabricGroupName').value).replace(/^\s*\s*$/g, '') == '') {
                jAlert('Please Enter Fabric Group Name', 'Message', 'ContentPlaceHolder1_txtFabricGroupName');
                $('html, body').animate({ scrollTop: $('#ContentPlaceHolder1_txtFabricGroupName').offset().top }, 'slow');
                return false;
            }
                                    ...
                                    <tr style="width: 1126px;">
                                        <th>
                                            <div class="main-title-left">
                                                <img class="img-left" title="Add Product Fabric Group Type" alt="Add Product Fabric Group Type" src="/App_Themes/<%=Page.Theme %>/images/add-product-icon.png" />
                                                <h2 style="padding-top: 3px;">Add Product Fabric Group Type</h2>
                                            </div>
                                                    ...
                                                    <tr class="even-row">
                                                        <td>
                                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                <tr class="altrow">
                                                                    <td width="13%">
                                                                        <span class="star">*</span>Fabric Group Name:
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtFabricGroupName" runat="server" MaxLength="500" class="order-textfield"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr class="altrow">
                                                                    <td width="13%">
