<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true"
    CodeBehind="AddProductFeature.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Product.AddProductFeature"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function ValidatePage() {
            ...
            if ((document.getElementById('ContentPlaceHolder1_txtFeature').value).replace(/^\s*\s*$/g, '') == '') {
                jAlert('Please Enter Feature Name', 'Message', 'ContentPlaceHolder1_txtFeature');
                $('html, body').animate({ scrollTop: $('#ContentPlaceHolder1_txtFeature').offset().top }, 'slow');
                return false;
            }
            if ((document.getElementById('ContentPlaceHolder1_txtDescription').value).replace(/^\s*\s*$/g, '') == '') {
                jAlert('Please Enter Feature Description', 'Message', 'ContentPlaceHolder1_txtDescription');
                                    ...
                                    <tr style="width: 1126px;">
                                        <th>
                                            <div class="main-title-left">
                                                <img class="img-left" title="Add Product Feature" alt="Add Product Feature" src="/App_Themes/<%=Page.Theme %>/images/add-product-icon.png" />
                                                <h2 style="padding-top: 3px;">Add Product Feature</h2>
                                            </div>
                                                        ...
                                                        <td>
                                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                <tr class="altrow">
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtFeature" runat="server" MaxLength="500" class="order-textfield"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr class="altrow">
                                                                    <td width="13%">
                                                                        <span class="star">*</span>Feature Description:
                                                                    </td>
                                                                    <td>
                                                                        <asp:DropDownList ID="ddlFeatureGroupType" onchange="chkHeight();" CssClass="order-list" runat="server"
                                                                ...
                                                                <tr class="altrow">
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtDisplayOrder" runat="server" MaxLength="500" class="order-textfield"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr class="oddrow">
                                                                    <td width="13%">
