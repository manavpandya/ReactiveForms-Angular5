<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true"
    CodeBehind="AddProductFeatureGroupType.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Product.AddProductFeatureGroupType"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function ValidatePage() {
            ...
            if ((document.getElementById('ContentPlaceHolder1_txtFeatureGroupName').value).replace(/^\s*\s*$/g, '') == '') {
                jAlert('Please Enter Feature Group Name', 'Message', 'ContentPlaceHolder1_txtFeatureGroupName');
                $('html, body').animate({ scrollTop: $('#ContentPlaceHolder1_txtFeatureGroupName').offset().top }, 'slow');
                return false;
            }
                                    ...
                                    <tr style="width: 1126px;">
                                        <th>
                                            <div class="main-title-left">
                                                <img class="img-left" title="Add Product Feature Group Type" alt="Add Product Feature Group Type" src="/App_Themes/<%=Page.Theme %>/images/add-product-icon.png" />
                                                <h2 style="padding-top: 3px;">Add Product Feature Group Type</h2>
                                            </div>
                                                    ...
                                                    <tr class="even-row">
                                                        <td>
                                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                <tr class="altrow">
                                                                    <td width="13%">
                                                                        <span class="star">*</span>Feature Group Name:
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtFeatureGroupName" runat="server" MaxLength="500" class="order-textfield"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr class="altrow">
                                                                    <td width="13%">
