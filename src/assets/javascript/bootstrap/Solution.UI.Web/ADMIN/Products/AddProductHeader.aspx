<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true"
    CodeBehind="AddProductHeader.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Product.AddProductHeader"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function ValidatePage() {
            ...
            if ((document.getElementById('ContentPlaceHolder1_txtHeader').value).replace(/^\s*\s*$/g, '') == '') {
                jAlert('Please Enter Header Name', 'Message', 'ContentPlaceHolder1_txtHeader');
                $('html, body').animate({ scrollTop: $('#ContentPlaceHolder1_txtHeader').offset().top }, 'slow');
                return false;
            }
            if ((document.getElementById('ContentPlaceHolder1_txtDescription').value).replace(/^\s*\s*$/g, '') == '') {
                jAlert('Please Enter Header Description', 'Message', 'ContentPlaceHolder1_txtDescription');
                                    ...
                                    <tr style="width: 1126px;">
                                        <th>
                                            <div class="main-title-left">
                                                <img class="img-left" title="Add Product Header" alt="Add Product Header" src="/App_Themes/<%=Page.Theme %>/images/add-product-icon.png" />
                                                <h2 style="padding-top: 3px;">Add Product Header</h2>
                                            </div>
                                                        ...
                                                        <td>
                                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                <tr class="altrow">
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtHeader" runat="server" MaxLength="500" class="order-textfield"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr class="altrow">
                                                                    <td width="13%">
                                                                        <span class="star">*</span>Header Description:
                                                                    </td>
                                                                    <td>
