<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true"
    CodeBehind="AddProductPattern.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Product.AddProductPattern"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function ValidatePage() {
            ...
            if ((document.getElementById('ContentPlaceHolder1_txtPattern').value).replace(/^\s*\s*$/g, '') == '') {
                jAlert('Please Enter Pattern Name', 'Message', 'ContentPlaceHolder1_txtPattern');
                $('html, body').animate({ scrollTop: $('#ContentPlaceHolder1_txtPattern').offset().top }, 'slow');
                return false;
            }
            if ((document.getElementById('ContentPlaceHolder1_txtDescription').value).replace(/^\s*\s*$/g, '') == '') {
                jAlert('Please Enter Pattern Description', 'Message', 'ContentPlaceHolder1_txtDescription');
                                    ...
                                    <tr style="width: 1126px;">
                                        <th>
                                            <div class="main-title-left">
                                                <img class="img-left" title="Add Product Pattern" alt="Add Product" src="/App_Themes/<%=Page.Theme %>/images/add-product-icon.png" />
                                                <h2 style="padding-top: 3px;">Add Product Pattern</h2>
                                            </div>
                                                    ...
                                                    <tr class="even-row">
                                                        <td>
                                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                <tr class="altrow">
                                                                    <td width="13%">
                                                                        <span class="star">*</span>Pattern Name:
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtPattern" runat="server" MaxLength="500" class="order-textfield"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr class="altrow">
                                                                    <td width="13%">
                                                                        <span class="star">*</span>Pattern Description:
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtDescription" runat="server" MaxLength="500" class="order-textfield" TextMode="MultiLine" Height="100" Width="220"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr class="altrow">
                                                                    <td width="13%">
