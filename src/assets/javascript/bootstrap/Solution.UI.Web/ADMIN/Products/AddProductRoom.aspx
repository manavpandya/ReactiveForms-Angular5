<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true"
    CodeBehind="AddProductRoom.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Product.AddProductRoom"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function ValidatePage() {
            ...
            if ((document.getElementById('ContentPlaceHolder1_txtRoom').value).replace(/^\s*\s*$/g, '') == '') {
                jAlert('Please Enter Room Name', 'Message', 'ContentPlaceHolder1_txtRoom');
                $('html, body').animate({ scrollTop: $('#ContentPlaceHolder1_txtRoom').offset().top }, 'slow');
                return false;
            }
            if ((document.getElementById('ContentPlaceHolder1_txtDescription').value).replace(/^\s*\s*$/g, '') == '') {
                jAlert('Please Enter Room Description', 'Message', 'ContentPlaceHolder1_txtDescription');
                                    ...
                                    <tr style="width: 1126px;">
                                        <th>
                                            <div class="main-title-left">
                                                <img class="img-left" title="Add Product Room" alt="Add Product Room" src="/App_Themes/<%=Page.Theme %>/images/add-product-icon.png" />
                                                <h2 style="padding-top: 3px;">Add Product Room</h2>
                                            </div>
                                                    ...
                                                    <tr class="even-row">
                                                        <td>
                                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                <tr class="altrow">
                                                                    <td width="13%">
                                                                        <span class="star">*</span>Room Name:
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtRoom" runat="server" MaxLength="500" class="order-textfield"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr class="altrow">
                                                                    <td width="13%">
                                                                        <span class="star">*</span>Room Description:
                                                                    </td>
                                                                    <td>
