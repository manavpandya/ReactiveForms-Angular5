<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true"
    CodeBehind="AddProductStyle.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Product.AddProductStyle"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function ValidatePage() {
            ...
            if ((document.getElementById('ContentPlaceHolder1_txtStyle').value).replace(/^\s*\s*$/g, '') == '') {
                jAlert('Please Enter Style Name', 'Message', 'ContentPlaceHolder1_txtStyle');
                $('html, body').animate({ scrollTop: $('#ContentPlaceHolder1_txtStyle').offset().top }, 'slow');
                return false;
            }
            if ((document.getElementById('ContentPlaceHolder1_txtDescription').value).replace(/^\s*\s*$/g, '') == '') {
                jAlert('Please Enter Style Description', 'Message', 'ContentPlaceHolder1_txtDescription');
                                    ...
                                    <tr style="width: 1126px;">
                                        <th>
                                            <div class="main-title-left">
                                                <img class="img-left" title="Add Product Style" alt="Add Product Style" src="/App_Themes/<%=Page.Theme %>/images/add-product-icon.png" />
                                                <h2 style="padding-top: 3px;">Add Product Style</h2>
                                            </div>
                                                    ...
                                                    <tr class="even-row">
                                                        <td>
                                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                <tr class="altrow">
                                                                    <td width="13%">
                                                                        <span class="star">*</span>Style Name:
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtStyle" runat="server" MaxLength="500" class="order-textfield"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr class="altrow">
                                                                    <td width="13%">
                                                                        <span class="star">*</span>Style Description:
                                                                    </td>
                                                                    <td>
