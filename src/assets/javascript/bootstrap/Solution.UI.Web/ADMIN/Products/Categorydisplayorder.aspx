<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true" CodeBehind="Categorydisplayorder.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Products.Categorydisplayorder" %>
                                        ...
                                        <tr>
                                            <th>
                                                <div class="main-title-left">
                                                    ...
                                                    <h2>Category Display Order List</h2>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Select" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="7%">
                                                                                        ...
                                                                                        <FooterTemplate>
                                                                                            <div class="row-fluid" style="width: 150px;">
                                                                                                ...
                                                                                                <span><a id="lkbAllowAll" runat="server">Check All</a> | <a id="lkbClearAll" runat="server"
                                                                                                    >Clear All</a> </span><span style="float: right;"></span>
