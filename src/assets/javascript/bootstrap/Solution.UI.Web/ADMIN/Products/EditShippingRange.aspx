<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditShippingRange.aspx.cs" MasterPageFile="~/ADMIN/Admin.Master" Inherits="Solution.UI.Web.ADMIN.Products.EditShippingRange" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="content-width">
        <asp:HiddenField runat="server" ID="hdnrangeid"/>
                                    ...
                                    <tr>
                                        <th>
                                            <div class="main-title-left">
                                                <img class="img-left" title="Edit Shipping Range" alt="Edit Shipping Range" src="/App_Themes/<%=Page.Theme %>/Images/shipping-services-icon.png" />
                                                <h2>
                                                    <asp:Label runat="server" Text="Edit Shipping Price Range" ID="lblTitle"></asp:Label></h2>
                                            </div>
                                        </th>
                                    </tr>
                                    <tr class="altrow">
