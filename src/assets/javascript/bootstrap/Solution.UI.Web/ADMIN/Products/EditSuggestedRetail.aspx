<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditSuggestedRetail.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Products.EditSuggestedRetail" %>
    ...
    <script type="text/javascript">
       ...
       <%-- $(function () {
        ...
        function SearchValidation() {
            ...
            if (document.getElementById('txtSuggestedRetail').value == '') {
                jAlert('Please Enter Suggested Retail Value.', 'Required Information', 'txtSuggestedRetail');
                    return false;
                }
                ...
                <tr>
                    <th>
                        <div class="main-title-left" style="color: #fff; text-align: left; padding-top: 8px;">
                            <asp:Label ID="lblPagetitle" Text="Shade Suggested Retail" runat="server"></asp:Label>
                        </div>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr style="height: 30px;">
                                ...
                                <td valign="middle" align="left">
                                    <asp:TextBox ID="txtSuggestedRetail"  MaxLength="10" runat="server" class="order-textfield" ReadOnly="false"
