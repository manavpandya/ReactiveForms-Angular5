<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true" CodeBehind="ExportProductBuy1Get1.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Products.ExportProductBuy1Get1" %>
                                    ...
                                    <tr style="width: 1126px;">
                                        <th>
                                            <div class="main-title-left">
                                                <img class="img-left" title="Import Export Buy1Get1" alt="Import Export Buy1Get1" src="/App_Themes/<%=Page.Theme %>/icon/add-product.png" />
                                                <h2>Import / Export for Buy1Get1 Products</h2>
                                            </div>
                                                                    ...
                                                                    <tr class="oddrow">
                                                                        ...
                                                                        <td style="margin-left: 950px; float: right;">
                                                                            <a style="color: red; text-decoration: none;" id="alog" runat="server" class="fancybox fancybox.iframe"
                                                                                href="/Admin/Products/ViewBuy1get1Log.aspx">
