<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true"
    CodeBehind="FabricVendorPortal.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Products.FabricVendorPortal" %>
    ...
    <script type="text/javascript">
        ...
        function ClacuOnHandQty(OrderQtyId, BookId, BookUploadId, BalQtyId, poqty) {
            ...
            if (document.getElementById(BookId) != null && document.getElementById(OrderQtyId) != null && document.getElementById(BookUploadId) != null) {
                ...
                var ids = OrderQtyId.replace('txtpoorderqty', 'hdnvendorqty');
        ...
        function ClacuOnHandQtynew(OrderQtyId, BookId, BookUploadId, BalQtyId, poqty) {
            var QtyOnHand = 0;

            if (document.getElementById(BookId) != null && document.getElementById(OrderQtyId) != null && document.getElementById(BookUploadId) != null) {
                document.getElementById(BookUploadId).value = 0;
                //document.getElementById(BookId).value = 0;
                var ids = OrderQtyId.replace('txtqtyonhand', 'hdnvendorqty1');
                document.getElementById(ids).value = '1';
                var BookedQty = document.getElementById(BookId).value;
                var OrderQty = document.getElementById(OrderQtyId).value;
                var BookUpload = document.getElementById(BookUploadId).value;
                                    ...
                                    <tr style="width: 1126px;">
                                        <th>
                                            <div class="main-title-left">
                                                <img class="img-left" title="Fabric Vendor Portal" alt="Fabric Vendor Portal" src="/App_Themes/<%=Page.Theme %>/icon/add-product.png" />
                                                            ...
                                                            <fieldset>
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0">
                                                                    <tr class="oddrow">
                                                                        ...
                                                                        <td align="left">
                                                                            <asp:Button ID="btnExport" runat="server" Visible="false" OnClick="btnExport_Click" /></td>
                                                                              <td align="left"  style="float:right;margin-left:673px;">
 <asp:Button ID="btnimport1" PostBackUrl="~/ADMIN/Products/importfabricinventory.aspx"  runat="server" OnClick="btnExport_Click" />
                                                                               </td>
                                                                       
                                                                            <asp:Button ID="btnImport" visible="false" runat="server" OnClick="btnImport_Click" />
                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" align="left" colspan="2">
                                                                            <asp:GridView ID="grdVendorPortal" runat="server" AutoGenerateColumns="False" BorderColor="#e7e7e7"
                                                                                ...
                                                                                AllowPaging="True" PageSize="48" PagerSettings-Mode="NumericFirstLast" OnPageIndexChanging="grdVendorPortal_PageIndexChanging" OnRowCommand="grdVendorPortal_RowCommand">
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField>
                                                                                        ...
                                                                                        <ItemTemplate>
                                                                                            ...
                                                                                            <asp:Label ID="lblsku"  runat="server" Visible="false" Text='<%#Bind("code1") %>'></asp:Label>
                                                                                             <asp:Label ID="lblorder" runat="server" Text='<%#Bind("code1") %>'></asp:Label>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    ...
                                                                                    <asp:TemplateField>
                                                                                        ...
                                                                                        <ItemTemplate>
                                                                                            ...
                                                                                            <input type="hidden" id="hdnvendorqty1" runat="server" value="0" />

                                                                                            <asp:Label ID="lblqtyonhand" runat="server"  Text='<%#  Convert.ToInt32(DataBinder.Eval(Container.DataItem,"QtyOnHand"))  %>' Visible="false"></asp:Label>
                                                                                    ...
                                                                                    <asp:TemplateField>
                                                                                        ...
                                                                                        <ItemTemplate>
                                                                                            ...
                                                                                            <asp:Label ID="lblbookedqty" runat="server" Visible="false" Text='<%#DataBinder.Eval(Container.DataItem,"BookedQty")%>'></asp:Label>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField>
                                                                                        <HeaderTemplate>
                                                                                        ...
                                                                                        <ItemTemplate>
                                                                                            ...
                                                                                            <asp:Label ID="lblbookupload" runat="server" Visible="false" Text='<%#DataBinder.Eval(Container.DataItem,"QtyBoookedNAV")%>' ></asp:Label>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField>
                                                                                        <HeaderTemplate>
                                                                                        ...
                                                                                        <ItemTemplate>
                                                                                            ...
                                                                                            <asp:Label ID="lblbalanceqty" runat="server" Visible="false" ></asp:Label>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField >
                                                                                        <HeaderTemplate>
                                                                                        ...
                                                                                        <ItemTemplate>
                                                                                            <asp:TextBox ID="txtpoorderqty" runat="server" Width="60px" CssClass="order-textfield"
                                                                                                onkeypress="return keyRestrictforIntOnly(event,'0123456789');" Style="text-align: center;"
                                                                                                Text='<%#  Convert.ToInt32(DataBinder.Eval(Container.DataItem,"POQty"))  %>'></asp:TextBox>

                                                                                            <asp:Label ID="lblpoorderqty" Visible="false" runat="server" Text='<%#  Convert.ToInt32(DataBinder.Eval(Container.DataItem,"POQty"))  %>'></asp:Label>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField>
                                                                                        <HeaderTemplate>
                                                                                        ...
                                                                                        <ItemTemplate>
                                                                                            ...
                                                                                            <asp:Label ID="lblproductiondate" runat="server" Visible="false" Text='<%#  DataBinder.Eval(Container.DataItem,"ProductionDate")  %>' ></asp:Label>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                     <asp:TemplateField>
                                                                                        <HeaderTemplate>
                                                                                        ...
                                                                                        <HeaderStyle HorizontalAlign="Center" Width="10%" />
                                                                                        <ItemTemplate>
                                                                                            <asp:Label ID="lbllastmodifiedon" runat="server" Text='<%#  DataBinder.Eval(Container.DataItem,"Updatedon")  %>'></asp:Label>
