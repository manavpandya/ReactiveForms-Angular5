<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true"
    CodeBehind="FeatureList.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Products.FeatureList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function checkondelete(uniqueID) {
            ...
            jConfirm('Are you sure want to delete Product Feature ?', 'Confirmation', function (r) {
                if (r == true) {
        ...
        <div class="content-row1">
            <div class="create-new-order" style="width: 100%">
                <span style="vertical-align: middle; margin-right: 3px; float: left;">
                  ...
                  <asp:ImageButton ID="ImgTagAddFeature" runat="server" OnClick="ImgTagAddFeature_Click"  style="padding-top: 6px;" /></span>
                            ...
                            <tr>
                                <td class="border-td-sub">
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="add-product">
                                        ...
                                        <tr class="altrow">
                                            <td align="right">
                                                <asp:ObjectDataSource ID="_gridObjectDataSource" runat="server" EnablePaging="True"
                                                    TypeName="Solution.Bussines.Components.ProductComponent" SelectMethod="GetDataByFilterProductFeature"
                                                     DeleteMethod="DeleteFeatureList"  StartRowIndexParameterName="startIndex" 
                                                    MaximumRowsParameterName="pageSize" SortParameterName="sortBy"
                                                    SelectCountMethod="GetCountProductFeature" 
                                                    ondeleted="_gridObjectDataSource_Deleted">
                                                    <SelectParameters>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 10%" align="right">
                                                            <asp:DropDownList ID="ddlSearch" AutoPostBack="False" Width="110px" runat="server"
                                                                CssClass="order-list">
                                                                <asp:ListItem>Feature Name</asp:ListItem>
                                        ...
                                        <tr class="even-row">
                                            <td>
                                                <asp:GridView ID="grdFeature" runat="server" AutoGenerateColumns="False" DataKeyNames="FeatureID"
                                                    EmptyDataText="No Record(s) Found." AllowSorting="True" EmptyDataRowStyle-ForeColor="Red"
                                                    EmptyDataRowStyle-HorizontalAlign="Center" ViewStateMode="Enabled" OnRowCommand="grdFeature_RowCommand"
                                                    ...
                                                    PagerSettings-Mode="NumericFirstLast" DataSourceID="_gridObjectDataSource" OnRowDataBound="grdFeature_RowDataBound">
                                                    <Columns>
                                                        <asp:TemplateField>
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                            <HeaderTemplate>
                                                                Feature Name
                                                                <asp:ImageButton ID="btnFeatureName" runat="server" CommandArgument="DESC" CommandName="Name"
                                                            ...
                                                            <ItemTemplate>
                                                               <asp:ImageButton runat="server" ID="_editLinkButton" ToolTip="Edit" CommandName="edit"
                                                                ...
                                                                <asp:ImageButton runat="server" ID="_deleteLinkButton" ToolTip="Delete" CommandName="delete"
                                                                    message='<%# Eval("FeatureId") %>' CommandArgument='<%# Eval("FeatureId") %>'
