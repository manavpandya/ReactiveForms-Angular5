<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true"
    CodeBehind="GenerateGoogleXML.aspx.cs" ValidateRequest="false" Inherits="Solution.UI.Web.ADMIN.Products.GenerateGoogleXML" %>
                                        ...
                                        <tr>
                                            <th>
                                                <div class="main-title-left">
                                                    <img class="img-left" title="Generate Google XML" alt="Generate Google XML" src="/App_Themes/<%=Page.Theme %>/Images/seo-icon.png" />
                                                    <h2>
                                                        <asp:Label ID="lblHeader" runat="server" Text="Generate Google XML"></asp:Label></h2>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr class="even-row">
