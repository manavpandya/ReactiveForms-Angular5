<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true" CodeBehind="ImportVariantPrice.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Products.ImportVariantPrice" %>
                                    ...
                                    <tr style="width: 1126px;">
                                        <th>
                                            <div class="main-title-left">
                                                <img class="img-left" title="Import / Export of Products" alt="Import / Export of Products" src="/App_Themes/<%=Page.Theme %>/icon/add-product.png" />
                                                <h2>Import / Export of Products</h2>
                                            </div>
                                                                    ...
                                                                    <tr class="oddrow">
                                                                        ...
                                                                        <td style="margin-left: 950px; float: right;">
                                                                            <a style="color: red; text-decoration: none;" id="alog" runat="server" class="fancybox fancybox.iframe"
                                                                                href="/Admin/Products/ViewPriceImportLog.aspx">
