<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true"
    CodeBehind="ProductColorList.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Products.ProductColorList"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function checkCount() {
            ...
            if (count == 0) {
                $(document).ready(function () { jAlert('Check at least One Product Color!', 'Message', ''); });
                return false;
            }
            else {
                return checkaa();
        ...
        function checkaa() {
            jConfirm('Are you sure want to delete all selected Product Color?', 'Confirmation', function (r) {
                if (r == true) {
        ...
        <div class="content-row1">
            <div class="create-new-order" style="width: 100%;">
                <span style="vertical-align: middle; margin-right: 3px; margin-top: 4px; float: left;">
                    ...
                    <a href="AddProductColor.aspx">
                        <img alt="Add New Color" title="Add New Color" src="/App_Themes/<%=Page.Theme %>/images/add-new-product-color.png" />
                    </a>
                </span>
            </div>
        </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 10%">
                                                            <asp:DropDownList ID="ddlSearch" runat="server" CssClass="order-list">
                                                                <asp:ListItem Value="ColorName">Color Name</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td style="width: 5%">
                                                    ...
                                                    <ContentTemplate>
                                                        <asp:GridView ID="gvProductSize" runat="server" AutoGenerateColumns="false" GridLines="None"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Color Name" ItemStyle-HorizontalAlign="Left" 
                                                                ...
                                                                <asp:TemplateField HeaderText="Edit Color" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="60px"
                                                                    HeaderStyle-HorizontalAlign="Center">
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <asp:ImageButton ID="btnSave" runat="server" CommandArgument='<%#Eval("ColorID") %>'
                                                                        ...
                                                                        <asp:ImageButton ID="btnCancel" runat="server" CommandName="Stop" ImageUrl="~/Admin/images/cancel.jpg"
                                                                            Visible="False" CommandArgument='<%# Eval("ColorID") %>' />
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
