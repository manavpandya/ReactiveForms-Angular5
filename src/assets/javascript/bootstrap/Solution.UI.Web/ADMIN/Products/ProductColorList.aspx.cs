...
{
    public partial class ProductColorList : BasePage
    {
        ...
        private void binddata()
        {
            ...
            dsproduct = objproduct.GetProductColorList(0, Issearch, SearchBy, SearchValue);
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow r in gvProductSize.Rows)
            {
                ...
                Label lb = (Label)r.FindControl("lblColorID");
        ...
        protected void gvProductSize_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "edit")
            {
                try
                {
                    ...
                    Response.Redirect("AddProductColor.aspx?Mode=Edit&ID=" + ColorID);
                }
                catch
                { }
            }
