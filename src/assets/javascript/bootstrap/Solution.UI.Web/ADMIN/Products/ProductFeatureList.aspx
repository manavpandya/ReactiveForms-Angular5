<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true"
    CodeBehind="ProductFeatureList.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Products.ProductFeatureList"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function checkCount() {
            ...
            if (count == 0) {
                $(document).ready(function () { jAlert('Check at least One Product Feature!', 'Message', ''); });
                return false;
            }
            else {
                return checkaa();
        ...
        function checkaa() {
            jConfirm('Are you sure want to delete all selected Product Feature?', 'Confirmation', function (r) {
                if (r == true) {
        ...
        <div class="content-row1">
            <div class="create-new-order" style="width: 100%;">
                <span style="vertical-align: middle; margin-right: 3px; float: right;">
                    <a href="AddProductFeature.aspx">
                        <img alt="Add New Feature" title="Add New Feature" src="/App_Themes/<%=Page.Theme %>/images/add-new-product-feature.png" />
                    </a>
                </span>
            </div>
        </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 10%">
                                                            <asp:DropDownList ID="ddlSearch" runat="server" CssClass="order-list">
                                                                <asp:ListItem Value="FeatureName">Feature Name</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td style="width: 5%">
                                                        ...
                                                        <asp:GridView ID="gvProductSize" runat="server" AutoGenerateColumns="false" GridLines="None"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField Visible="False">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblFeatureID" runat="server" Text='<%#Eval("FeatureID") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Feature Name" ItemStyle-HorizontalAlign="Left"
                                                                ...
                                                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="250px"
                                                                    HeaderStyle-HorizontalAlign="Center">
                                                                    <HeaderTemplate>
                                                                        Feature Group Type
                                                                    </HeaderTemplate>
                                                                    <ItemTemplate>
                                                                        <%#Eval("FeatureGroupName")%>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField ItemStyle-Width="200px">
                                                                    ...
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblimgname" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container.DataItem,"ImgName")%>'></asp:Label>
                                                                        <a target="_blank" href="/">
                                                                            <img style="border: 1px solid #000;width: 20px;" src='<%# GetIconImageProduct(Convert.ToString(Eval("ImgName"))) %>' />
                                                                        </a>
                                                                    </ItemTemplate>
                                                                    <ItemStyle VerticalAlign="Top" HorizontalAlign="Center" CssClass="border" Width="10%" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Edit Feature" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="60px"
                                                                    HeaderStyle-HorizontalAlign="Center">
                                                                    <ItemTemplate>
                                                                        <asp:ImageButton runat="server" ID="_editLinkButton" ToolTip="Edit" CommandName="edit"
                                                                            CommandArgument='<%# Eval("FeatureID") %>'></asp:ImageButton>
                                                                        <asp:ImageButton ID="btnSave" runat="server" CommandArgument='<%#Eval("FeatureID") %>'
                                                                        ...
                                                                        <asp:ImageButton ID="btnCancel" runat="server" CommandName="Stop" ImageUrl="~/Admin/images/cancel.jpg"
                                                                            Visible="False" CommandArgument='<%# Eval("FeatureID") %>' />
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
