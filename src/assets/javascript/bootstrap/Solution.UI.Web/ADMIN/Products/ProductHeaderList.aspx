<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true"
    CodeBehind="ProductHeaderList.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Products.ProductHeaderList"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function checkCount() {
            ...
            if (count == 0) {
                $(document).ready(function () { jAlert('Check at least One Product Header!', 'Message', ''); });
                return false;
            }
            else {
                return checkaa();
        ...
        function checkaa() {
            jConfirm('Are you sure want to delete all selected Product Header?', 'Confirmation', function (r) {
                if (r == true) {
        ...
        <div class="content-row1">
            <div class="create-new-order" style="width: 100%;">
                <span style="vertical-align: middle; margin-right: 3px; float: right;">
                    <a href="AddProductHeader.aspx">
                        <img alt="Add New Header" title="Add New Header" src="/App_Themes/<%=Page.Theme %>/images/add-new-product-header.png" />
                    </a>
                </span>
            </div>
        </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 10%">
                                                            <asp:DropDownList ID="ddlSearch" runat="server" CssClass="order-list">
                                                                <asp:ListItem Value="HeaderName">Header Name</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td style="width: 5%">
                                                    ...
                                                    <ContentTemplate>
                                                        <asp:GridView ID="gvProductSize" runat="server" AutoGenerateColumns="false" GridLines="None"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Header Name" ItemStyle-HorizontalAlign="Left"
                                                                ...
                                                                <asp:TemplateField ItemStyle-Width="200px">
                                                                    ...
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <a target="_blank" href="/">
                                                                            <img style="border: 1px solid #000;width:20px;" src='<%# GetIconImageProduct(Convert.ToString(Eval("ImageName"))) %>' />
                                                                        </a>
                                                                    </ItemTemplate>
                                                                    <ItemStyle VerticalAlign="Top" HorizontalAlign="Center" CssClass="border" Width="10%" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Edit Header" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="60px"
                                                                    HeaderStyle-HorizontalAlign="Center">
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <asp:ImageButton ID="btnSave" runat="server" CommandArgument='<%#Eval("HeaderID") %>'
                                                                        ...
                                                                        <asp:ImageButton ID="btnCancel" runat="server" CommandName="Stop" ImageUrl="~/Admin/images/cancel.jpg"
                                                                            Visible="False" CommandArgument='<%# Eval("HeaderID") %>' />
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
