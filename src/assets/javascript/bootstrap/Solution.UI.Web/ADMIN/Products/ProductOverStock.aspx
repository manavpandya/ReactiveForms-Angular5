<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true"
    CodeBehind="ProductOverStock.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Products.ProductOverStock" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../JS/ProductOverStockValidation.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(".slidingDivWarranty").show();
            $(".show_hideWarranty").show();

            $('.show_hideWarranty').click(function () {
                $(".slidingDivWarranty").slideToggle();
            });
        });
        $(document).ready(function () {
                                        ...
                                        <th>
                                            <div class="main-title-left">
                                                ...
                                                <h2 style="padding-top: 3px;">
                                                    Add/Edit Over Stock Product</h2>
                                            </div>
                                                                    ...
                                                                    <td>
                                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                            ...
                                                                            <tr class="oddrow">
                                                                                ...
                                                                                <td colspan="2">
                                                                                    <asp:TextBox ID="txtShortName" runat="server" MaxLength="250" class="order-textfield"
                                                                                                                        ...
                                                                                                                        <asp:TemplateField HeaderText="Inventory">
                                                                                                                            <ItemTemplate>
                                                                                                                                <asp:TextBox ID="txtInventory" CssClass="order-textfield" Style="width: 50px; text-align: center;"
                                                                                                                                    ...
                                                                                                                                    onblur="SetTotalWeight();" MaxLength="5" TabIndex="11" onkeyup="SetTotalWeight();"></asp:TextBox>
                                                                                                                            </ItemTemplate>
                                                                            ...
                                                                            <tr class="altrow">
                                                                                ...
                                                                                <td align="left">
                                                                                    <asp:TextBox ID="txtSKU" runat="server" MaxLength="500" class="order-textfield" TabIndex="3"></asp:TextBox>
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="oddrow">
                                                                                <td width="12%" valign="top">
                                                                                ...
                                                                                <td align="left">
                                                                                    <asp:TextBox ID="txtOptionSKU" runat="server" MaxLength="500" class="order-textfield"
                                                                            ...
                                                                            <tr class="altrow">
                                                                                ...
                                                                                <td>
                                                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                                                        <tr>
                                                                                            <td>
                                                                                                <asp:TextBox ID="txtUPC" runat="server" MaxLength="100" class="order-textfield" TabIndex="5"></asp:TextBox>
                                                                                            </td>
                                                                            ...
                                                                            <tr class="oddrow">
                                                                                ...
                                                                                <td colspan="2">
                                                                                    <asp:DropDownList ID="ddlManufacture" runat="server" class="order-list" TabIndex="6">
                                                                                    </asp:DropDownList>
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="oddrow" style="display: none;">
                                                                                ...
                                                                                <td colspan="">
                                                                                    <asp:DropDownList ID="ddlDistributor" runat="server" class="order-list" TabIndex="7">
                                                                                    </asp:DropDownList>
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="altrow">
                                                                                <td width="12%">
                                                                                    <span class="star">&nbsp;</span>Part Number:
                                                                                </td>
                                                                                <td colspan="">
                                                                                    <asp:TextBox ID="txtPartNumber" runat="server" MaxLength="500" class="order-textfield"
                                                                                        TabIndex="8"></asp:TextBox>
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="oddrow">
                                                                                <td width="12%">
                                                                                    <span class="star">&nbsp;</span>Materials:
                                                                                </td>
                                                                                <td colspan="">
                                                                                    <asp:TextBox ID="txtMaterials" runat="server" MaxLength="500" class="order-textfield"
                                                                                        TabIndex="9"></asp:TextBox>
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="altrow">
                                                                                <td width="12%">
                                                                                    <span class="star">*</span>Condition:
                                                                                </td>
                                                                                <td colspan="4">
                                                                                    <asp:DropDownList ID="ddlProductCondition" runat="server" class="order-list" TabIndex="10">
                                                                                        <asp:ListItem Value="Select Condition">Select Condition</asp:ListItem>
                                                                            ...
                                                                            <tr class="oddrow">
                                                                                ...
                                                                                <td colspan="4">
                                                                                    <asp:UpdatePanel runat="server" ID="inv">
                                                                                        <ContentTemplate>
                                                                                            <asp:TextBox ID="txtInventory" runat="server" TabIndex="12" class="status-textfield"
                                                                            ...
                                                                            <tr class="oddrow">
                                                                                ...
                                                                                <td width="15%" colspan="4">
                                                                                    $<asp:TextBox ID="txtSalePrice" runat="server" class="order-textfield" Width="80px"
                                                                                        onkeypress="return keyRestrict(event,'0123456789.');" TabIndex="15"></asp:TextBox>
                                                                                    Ex (8.62) &nbsp;&nbsp;
                                                                            ...
                                                                            <tr class="altrow">
                                                                                <td>
                                                                                    <span class="star">&nbsp;</span>Source Zip Code:
                                                                                </td>
                                                                                <td width="15%">
                                                                                    <asp:TextBox ID="txtSourceZipCode" runat="server" class="order-textfield" Width="100px"
                                                                                ...
                                                                                <td width="">
                                                                                    <asp:TextBox ID="txtBrand" runat="server" class="order-textfield" TabIndex="16"></asp:TextBox>
                                                                                </td>
                                                                            </tr>
                                                                            <tr class="altrow" style="display: none;">
                                                                                <td>
                                                                            ...
                                                                            <tr class="oddrow">
                                                                                ...
                                                                                <td colspan="4">
                                                                                    <asp:TextBox ID="txtDisplayOrder" runat="server" class="status-textfield" MaxLength="4"
                                                                                        onkeypress="return keyRestrict(event,'0123456789');" TabIndex="17" Width="80"></asp:TextBox>
                                                                                </td>
                                                                                <td style="display: none;">
                                                                                    SurCharge:
                                                                                </td>
                                                                            ...
                                                                            <tr class="altrow">
                                                                                ...
                                                                                <td colspan="4">
                                                                                    <asp:CheckBox ID="chkPublished" runat="server" Checked="true" TabIndex="18" />
                                                                                </td>
                                                                                <td style="display: none;">
                                                                            ...
                                                                            <tr class="oddrow" style="display:none;">
                                                                                ...
                                                                                <td colspan="2">
                                                                                    <table cellpadding="0" cellspacing="0">
                                                                                        <tr>
                                                                                            <td>
                                                                                                <asp:CheckBox ID="chkIsHamming" runat="server" onchange="return SetHammingValue();"
                                                                                                    TabIndex="16" />
                                                                                            </td>
                                                                                            <td id="tdHamminglbl" runat="server" style="display: none;">
                                                                                                &nbsp;<span class="star">*</span>Hemming Safety Quantity
                                                                                            </td>
                                                                                    ...
                                                                                    <asp:UpdatePanel ID="upProductType" runat="server" UpdateMode="Always">
                                                                                        <ContentTemplate>
                                                                                            <asp:DropDownList ID="ddlProductType" AutoPostBack="true" runat="server" class="product-type"
                                                                                                OnSelectedIndexChanged="ddlProductType_SelectedIndexChanged" TabIndex="23">
                                                                                            </asp:DropDownList>
                                                                                        </ContentTemplate>
                                                                                    </asp:UpdatePanel>
                                                                                </td>
                                                            ...
                                                            <tr>
                                                                                                                                ...
                                                                                                                                <tr>
                                                                                                                                    <td width="144px">
                                                                                                                                        <asp:DropDownList ID="ddlDescription" runat="server" class="product-type" AutoPostBack="True"
                                                                                                                                            OnSelectedIndexChanged="ddlDescription_SelectedIndexChanged" Width="142px" TabIndex="24">
                                                                                                                                    ...
                                                                                                                                    <td style="text-align: left">
                                                                                                                                        ...
                                                                                                                                        <asp:TextBox ID="txtTitleDesc" runat="server" class="order-textfield" MaxLength="50"
                                                                                                                                            Width="175px" TabIndex="25"></asp:TextBox>&nbsp;&nbsp;
                                                                                                                                        <asp:LinkButton ID="lnkSaveDesc" runat="server" Font-Bold="true" Font-Size="12px"
                                                                                                                                            Font-Underline="true" Text="Save Description" TabIndex="26" OnClick="lnkSaveDesc_Click1">Save Description</asp:LinkButton>
                                                                                                                                    </td>
                                                                                                                                    <td align="left">
                                                                                                                                    </td>
                                                                                                                                </tr>
                                                                                                                                ...
                                                                                                                                <tr>
                                                                                                                                    <td width="10%">
                                                                                                                                        <asp:FileUpload ID="fuProductIcon" runat="server" Width="220px" Style="border: 1px solid #1a1a1a;
                                                                                                                                            background: #f5f5f5; color: #000000;" TabIndex="28" />
                                                                                                                                    </td>
                                                                                                                                    <td width="9%">
                                                                                                    ...
                                                                                                    <div class="tab-content-2 order-notes">
                                                                                                        <div class="tab-content-3">
                                                                                                            <asp:TextBox ID="txtSETitle" runat="server" CssClass="order-textfield" Width="100%"
                                                                                                                Columns="6" Height="90px" BorderStyle="None" Rows="6" TextMode="MultiLine" TabIndex="30"></asp:TextBox></div>
                                                                                                    </div>
                                                                                                    ...
                                                                                                    <div class="tab-content-2 gift-notes">
                                                                                                        <div class="tab-content-3">
                                                                                                            <asp:TextBox ID="txtSEDescription" runat="server" CssClass="order-textfield" Width="100%"
                                                                                                                Columns="6" Height="90px" BorderStyle="None" Rows="6" TextMode="MultiLine" TabIndex="32"></asp:TextBox></div>
                                                                                                    </div>
                                                                                                    <div class="tab-content-2 my-account">
                                                                                                        <div class="tab-content-3">
                                                                                                            <asp:TextBox Height="19px" ID="txtToolTip" BorderStyle="None" runat="server" MaxLength="500"
                                                                                                                CssClass="status-textfield" Width="100%" TabIndex="33"></asp:TextBox></div>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </td>
                                                                                        </tr>
                                                                ...
                                                                <td width="40%" valign="top">
                                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="border-td content-table">
                                                                                    <tr>
                                                                                        <th>
                                                                                            <div class="main-title-left">
                                                                                                <img class="img-left" title="Warranty" alt="Warranty" src="/App_Themes/<%=Page.Theme %>/icon/add-product.png">
                                                                                                <h2>
                                                                                                    Warranty
                                                                                                </h2>
                                                                                            </div>
                                                                                            <div class="main-title-right">
                                                                                                <a href="javascript:void(0);" class="show_hideWarranty" onclick="return ShowHideButton('ImgWarranty','tdCategories');">
                                                                                                    <img id="ImgWarranty" src="/App_Themes/<%=Page.Theme %>/images/minimize.png" class="minimize"
                                                                                                        title="Minimize" alt="Minimize"></a>
                                                                                            </div>
                                                                                        </th>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td id="tdWarranty">
                                                                                            <div id="tab-container-2" class="slidingDivWarranty">
                                                                                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            Provider :
                                                                                                        ...
                                                                                                        <td>
                                                                                                            <asp:DropDownList ID="ddlProvider" runat="server" class="product-type" Width="15%"
                                                                                                                TabIndex="24">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td>
                                                                                                            <asp:TextBox ID="txtWarrantyDescription" runat="server" CssClass="order-textfield"
                                                                                                                Width="95%" Columns="6" Height="90px" Rows="6" TabIndex="36" TextMode="MultiLine"></asp:TextBox>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td width="25%">
                                                                                                        ...
                                                                                                        <td>
                                                                                                            <asp:TextBox ID="txtWarrantyContactNumber" runat="server" CssClass="order-textfield"
                                                                                                                MaxLength="100" Height="19px" Width="290px" TabIndex="37"></asp:TextBox>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </div>
                                                                        ...
                                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                            <tr>
                                                                                ...
                                                                                <td align="left" colspan="2">
                                                                                    <asp:TextBox ID="txtSummary" runat="server" CssClass="status-textfield" Width="95%"
                                                                                        Columns="6" Height="60px" Rows="6" TextMode="MultiLine" TabIndex="38"></asp:TextBox>
                                                                                </td>
                                                                            </tr>
                                                                            <tr style="display: none;">
                                                                            ...
                                                                            <tr style="display: none;">
                                                                                ...
                                                                                <td align="left" colspan="2">
                                                                                    <asp:TextBox ID="txtProductURL" runat="server" CssClass="status-textfield" Width="400px"></asp:TextBox>
                                                                                </td>
                                                                            </tr>
                                                                            <tr style="display: none;">
                                                                                <td width="15%" valign="top">
                                                                                ...
                                                                                <td colspan="3">
                                                                                    <table cellpadding="0" cellspacing="0" width="100%">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <asp:CheckBox ID="chkSatisfactionGuaranteed" runat="Server" />
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        ...
                                                        <asp:ImageButton ID="btnSave" runat="server" OnClientClick="return ValidatePage();"
                                                            OnClick="btnSave_Click" TabIndex="39" />
                                                        &nbsp;&nbsp;
                                                        <asp:ImageButton ID="btnCancel" runat="server" OnClick="btnCancel_Click" TabIndex="40" />
                                                        </div>
                                                        </div>
                                                    </td>
                                                </tr>
