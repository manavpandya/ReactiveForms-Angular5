<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true"
    CodeBehind="ProductPatternList.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Products.ProductPatternList"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function checkCount() {
            ...
            if (count == 0) {
                $(document).ready(function () { jAlert('Check at least One Product Pattern!', 'Message', ''); });
                return false;
            }
            else {
                return checkaa();
        ...
        function checkaa() {
            jConfirm('Are you sure want to delete all selected Product Pattern?', 'Confirmation', function (r) {
                if (r == true) {
        ...
        <div class="content-row1">
            <div class="create-new-order" style="width: 100%;">
                <span style="vertical-align: middle; margin-right: 3px; float: right;">
                    <a href="AddProductPattern.aspx">
                        <img alt="Add New Pattern" title="Add New Pattern" src="/App_Themes/<%=Page.Theme %>/images/add-new-product-pattern.png" />
                    </a>
                </span>
            </div>
        </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 10%">
                                                            <asp:DropDownList ID="ddlSearch" runat="server" CssClass="order-list">
                                                                <asp:ListItem Value="PatternName">Pattern Name</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td style="width: 5%">
                                                        ...
                                                        <asp:GridView ID="gvProductSize" runat="server" AutoGenerateColumns="false" GridLines="None"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField Visible="False">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblPatternID" runat="server" Text='<%#Eval("PatternID") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Pattern Name" ItemStyle-HorizontalAlign="Left"
                                                                ...
                                                                <asp:TemplateField HeaderText="Edit Pattern" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="60px"
                                                                    HeaderStyle-HorizontalAlign="Center">
                                                                    <ItemTemplate>
                                                                        <asp:ImageButton runat="server" ID="_editLinkButton" ToolTip="Edit" CommandName="edit"
                                                                            CommandArgument='<%# Eval("PatternID") %>'></asp:ImageButton>
                                                                        <asp:ImageButton ID="btnSave" runat="server" CommandArgument='<%#Eval("PatternID") %>'
                                                                        ...
                                                                        <asp:ImageButton ID="btnCancel" runat="server" CommandName="Stop" ImageUrl="~/Admin/images/cancel.jpg"
                                                                            Visible="False" CommandArgument='<%# Eval("PatternID") %>' />
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
