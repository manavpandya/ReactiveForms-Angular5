<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true"
    CodeBehind="ProductRoomList.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Products.ProductRoomList"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function checkCount() {
            ...
            if (count == 0) {
                $(document).ready(function () { jAlert('Check at least One Product Room!', 'Message', ''); });
                return false;
            }
            else {
                return checkaa();
        ...
        function checkaa() {
            jConfirm('Are you sure want to delete all selected Product Room?', 'Confirmation', function (r) {
                if (r == true) {
        ...
        <div class="content-row1">
            <div class="create-new-order" style="width: 100%;">
                <span style="vertical-align: middle; margin-right: 3px; float: right;">
                    <a href="AddProductRoom.aspx">
                        <img alt="Add New Room" title="Add New Room" src="/App_Themes/<%=Page.Theme %>/images/add-New-Product-Room.png" />
                    </a>
                </span>
            </div>
        </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 10%">
                                                            <asp:DropDownList ID="ddlSearch" runat="server" CssClass="order-list">
                                                                <asp:ListItem Value="RoomName">Room Name</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td style="width: 5%">
                                                    ...
                                                    <ContentTemplate>
                                                        <asp:GridView ID="gvProductSize" runat="server" AutoGenerateColumns="false" GridLines="None"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Room Name" ItemStyle-HorizontalAlign="Left"
                                                                ...
                                                                <asp:TemplateField HeaderText="Edit Room" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="60px"
                                                                    HeaderStyle-HorizontalAlign="Center">
                                                                    <ItemTemplate>
                                                                        <asp:ImageButton runat="server" ID="_editLinkButton" ToolTip="Edit" CommandName="edit"
                                                                            CommandArgument='<%# Eval("RoomID") %>'></asp:ImageButton>
                                                                        <asp:ImageButton ID="btnSave" runat="server" CommandArgument='<%#Eval("RoomID") %>'
                                                                        ...
                                                                        <asp:ImageButton ID="btnCancel" runat="server" CommandName="Stop" ImageUrl="~/Admin/images/cancel.jpg"
                                                                            Visible="False" CommandArgument='<%# Eval("RoomID") %>' />
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
