...
{
    public partial class ProductSwatchSKU : BasePage
    {
        ...
        protected void BindSearchData()
        {
            ...
            if (!string.IsNullOrEmpty(txtSearch.Text.ToString().Trim()))
            {
                if (Request.QueryString["ProductID"] != null && Request.QueryString["ProductID"].ToString() !="")
                    ...
                    WhrClus += " Where " + ddlSearchby.SelectedValue.ToString() + " like '%" + txtSearch.Text.ToString().Trim() + "%' And (ISNULL(tb_Product.Deleted,0) != 1) And (tb_Product.Active = 1) AND (tb_Product.StoreId = " + Request.QueryString["StoreId"] + ")";
            }
            else
            {
                if (Request.QueryString["ProductID"] != null && Request.QueryString["ProductID"].ToString() != "")
                    ...
                    WhrClus = " Where (ISNULL(tb_Product.Deleted,0) != 1) And (tb_Product.Active = 1) and (tb_Product.StoreId = " + Request.QueryString["StoreId"] + ")";
            }
            //WhrClus = "";
        ...
        private void AddtoList(string lblSKU)
        {
            try
            {
                ...
                {
                    Page.ClientScript.RegisterClientScriptBlock(btnAddSelectedItems.GetType(), "@closemsg", "window.opener.document.getElementById('" + Request.QueryString["clientid"].ToString() + "').value = '" + lblSKU + "';", true);
                }
                else
                {
                    Page.ClientScript.RegisterClientScriptBlock(btnAddSelectedItems.GetType(), "@closemsg", "window.opener.document.getElementById('" + Request.QueryString["clientid"].ToString() + "').value = '" + lblSKU + "';", true);
        ...
        private void Removedata(string lblSKU)
        {
            try
            {
                ...
                if (Request.QueryString["clientid"].ToString().IndexOf("arelatedsku1") > -1)
                {
                    Page.ClientScript.RegisterClientScriptBlock(btnAddSelectedItems.GetType(), "@closemsg", "window.opener.document.getElementById('" + Request.QueryString["clientid"].ToString() + "').value = '" + ViewState["SelectedSKUs"].ToString() + "';", true);
                }
                else
                {
                    Page.ClientScript.RegisterClientScriptBlock(btnAddSelectedItems.GetType(), "@closemsg", "window.opener.document.getElementById('" + Request.QueryString["clientid"].ToString() + "').value = '" + ViewState["SelectedSKUs"].ToString() + "';", true);
            ...
            if (grdSelected.Rows.Count > 0)
            {
                try
                {
                    if (!string.IsNullOrEmpty(Request.QueryString["clientid"].ToString()))
                    {
                        ...
                        if (Request.QueryString["clientid"].ToString().IndexOf("arelatedsku1") > -1)
                        {
                            Page.ClientScript.RegisterClientScriptBlock(btnAddSelectedItems.GetType(), "@closemsg", "window.opener.document.getElementById('" + Request.QueryString["clientid"].ToString() + "').value = '" + skus + "';", true);
                        }
                        else
                        {
                            Page.ClientScript.RegisterClientScriptBlock(btnAddSelectedItems.GetType(), "@closemsg", "window.opener.document.getElementById('" + Request.QueryString["clientid"].ToString() + "').value = '" + skus + "';", true);
