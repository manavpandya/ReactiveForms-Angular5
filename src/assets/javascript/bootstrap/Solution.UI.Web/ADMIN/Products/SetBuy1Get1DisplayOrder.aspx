<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true" CodeBehind="SetBuy1Get1DisplayOrder.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Products.SetBuy1Get1DisplayOrder" %>
    ...
    <script type="text/javascript">
        ...
        function updatenn() {
            ...
            $.ajax(
              {
                  type: "POST",
                  url: "/TestMail.aspx/updatesalesoutletdisplayorder",
                  data: "{ids: '" + allids + "'}",
    ...
    <script type="text/javascript">
        ...
        function verifyoption() {
                        ...
                        $.ajax(
            {
                ...
                data: "{option: '" + options + "',pagename:'salesoutlet'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
                cache: "false",
                                    ...
                                    <tr>
                                        <th>
                                            <div class="main-title-left">
                                                <img class="img-left" title="Buy1 Get1 Products Display Order" alt="Buy1 Get1 Products Display Order" src="/App_Themes/<%=Page.Theme %>/Images/coupon-discount-icon.png" />
                                                <h2>Buy1 Get1 Products Display Order</h2>
                                            </div>
                                        </th>
                                    </tr>
                                    <tr>
