<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true" CodeBehind="SetCustomProductDisplayOrder.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Products.SetCustomProductDisplayOrder" %>
    ...
    <script type="text/javascript">
        ...
        function updatenn() {
            ...
            $.ajax(
              {
                  type: "POST",
                  url: "/TestMail.aspx/updatecustompagedisplayorder",
                  data: "{ids: '" + allids + "'}",
    ...
    <script type="text/javascript">
        ...
        function verifyoption() {
                        ...
                        $.ajax(
            {
                ...
                data: "{option: '" + options + "',pagename:'custompage'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
                cache: "false",
                                    ...
                                    <tr>
                                        <th>
                                            <div class="main-title-left">
                                                <img class="img-left" title="Custom Products Display Order" alt="Custom Products Display Order" src="/App_Themes/<%=Page.Theme %>/Images/coupon-discount-icon.png" />
                                                <h2>Custom Products Display Order</h2>
                                            </div>
                                        </th>
                                    </tr>
                                    <tr>
