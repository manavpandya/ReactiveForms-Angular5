<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true" CodeBehind="SetNewArrivalDisplayOrder.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Products.SetNewArrivalDisplayOrder" %>
    ...
    <script type="text/javascript">
        ...
        function updatenn() {
            ...
            $.ajax(
              {
                  type: "POST",
                  url: "/TestMail.aspx/updatenewarrivaldisplayorder",
                  data: "{ids: '" + allids + "'}",
    ...
    <script type="text/javascript">
        ...
        function verifyoption() {
                        ...
                        $.ajax(
            {
                ...
                data: "{option: '" + options + "',pagename:'newarrival'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
                cache: "false",
                                    ...
                                    <tr>
                                        <th>
                                            <div class="main-title-left">
                                                <img class="img-left" title="New Arrival Display Order" alt="New Arrival Display Order" src="/App_Themes/<%=Page.Theme %>/Images/coupon-discount-icon.png" />
                                                <h2>New Arrival Display Order</h2>
                                            </div>
                                        </th>
                                    </tr>
                                    <tr>
