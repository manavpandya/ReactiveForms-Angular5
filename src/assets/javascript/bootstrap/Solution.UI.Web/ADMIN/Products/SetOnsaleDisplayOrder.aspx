<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true" CodeBehind="SetOnsaleDisplayOrder.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Products.SetOnsaleDisplayOrder" %>
    ...
    <script type="text/javascript">
        ...
        function updatenn() {
            ...
            $.ajax(
              {
                  type: "POST",
                  url: "/TestMail.aspx/updateonsaledisplayorder",
                  data: "{ids: '" + allids + "'}",
    ...
    <script type="text/javascript">
        ...
        function verifyoption() {
                        ...
                        $.ajax(
            {
                ...
                data: "{option: '" + options + "',pagename:'onsale'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
                cache: "false",
                                    ...
                                    <tr>
                                        <th>
                                            <div class="main-title-left">
                                                <img class="img-left" title="OnSale Products Display Order" alt="OnSale Products Display Order" src="/App_Themes/<%=Page.Theme %>/Images/coupon-discount-icon.png" />
                                                <h2>OnSale Products Display Order</h2>
                                            </div>
                                        </th>
                                    </tr>
                                    <tr>
