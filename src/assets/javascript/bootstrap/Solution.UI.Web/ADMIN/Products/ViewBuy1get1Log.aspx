<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewBuy1get1Log.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Products.ViewBuy1get1Log" %>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblbeforeIsBuy1Get1" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"beforeIsBuy1Get1") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblbeforeBuy1Fromdate" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"beforeBuy1Fromdate") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblbeforeBuy1Todate" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"beforeBuy1Todate") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblbeforebuy1price" runat="server" Text='<%#Convert.ToDecimal(DataBinder.Eval(Container.DataItem,"beforeBuy1Price")) %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblIsBuy1Get1" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"IsBuy1Get1") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblBuy1Fromdate" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Buy1Fromdate") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblBuy1Todate" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Buy1Todate") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblafterbuy1price" runat="server" Text='<%#Convert.ToDecimal(DataBinder.Eval(Container.DataItem,"Buy1Price")) %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="left" />
                                        </asp:TemplateField>
