<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewHemmingLog.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Products.ViewHemmingLog" %>
                            ...
                            <asp:GridView ID="gvhemminglog" runat="server" AutoGenerateColumns="False" Width="100%" EmptyDataText="No Record Found."
                                ...
                                <Columns>
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                         <asp:Label ID="lblusername" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"AdminName") %>'></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField>
                                      ...
                                      <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblhemm" runat="server"  Text='<%#DataBinder.Eval(Container.DataItem,"Hemming") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" />
                                        <HeaderStyle HorizontalAlign="left" />
                                    </asp:TemplateField>
                                     <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblglobal" runat="server"  Text='<%#DataBinder.Eval(Container.DataItem,"Globalhemming") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" />
                                        <HeaderStyle HorizontalAlign="left" />
                                    </asp:TemplateField>
                                      <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblIP" runat="server"  Text='<%#DataBinder.Eval(Container.DataItem,"Ipaddress") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" />
                                        <HeaderStyle HorizontalAlign="left" />
                                    </asp:TemplateField>
