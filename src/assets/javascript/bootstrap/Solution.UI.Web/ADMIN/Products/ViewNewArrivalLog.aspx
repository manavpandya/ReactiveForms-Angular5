<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewNewArrivalLog.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Products.ViewNewArrivalLog" %>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblBeforeIsNewArrival" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"BeforeIsNewArrival") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblBeforeIsNewArrivalfromdate" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"BeforeIsNewArrivalfromdate") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblbeforeIsNewArrivaltodate" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"beforeIsNewArrivaltodate") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblIsNewArrival" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"IsNewArrival") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblIsNewArrivalFromdate" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"IsNewArrivalFromdate") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblIsNewArrivalTodate" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"IsNewArrivalTodate") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="left" />
                                        </asp:TemplateField>
