<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewPriceImportLog.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Products.ViewPriceImportLog" %>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblbeforeprice" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"beforeprice") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                                Before(BaseCustomPrice)
                                            </HeaderTemplate>
                                            <ItemTemplate>

                                                <asp:Label ID="lblbeforeBaseCustomPrice" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"beforebasecustomprice") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="left" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                                After(BaseCustomPrice)
                                            </HeaderTemplate>
                                            <ItemTemplate>

                                                <asp:Label ID="lblbasecustomprice" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"basecustomprice") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="left" />
                                        </asp:TemplateField>
