...
{
    public partial class ViewProductImages : BasePage
    {
            ...
            try
            {
                if (!string.IsNullOrEmpty(tb_Product.SKU.ToString().Trim()))
                {
                    ...
                    if (ImgAlt1.Src.ToLower().IndexOf("/temp/") > -1 && ViewState["File1"] != null)
                    {
                        ...
                        {
                            CommonComponent.ExecuteCommonData("Update tb_ProductImgDesc set Description='" + txtalt1.Text.ToString().Replace("'", "''") + "' Where ImageNo=1 and ProductId=" + ProductID + "");
                        }
                        else
                        {
                    ...
                    if (ImgAlt2.Src.ToLower().IndexOf("/temp/") > -1 && ViewState["File2"] != null)
                    {
                        ...
                        {
                            CommonComponent.ExecuteCommonData("Update tb_ProductImgDesc set Description='" + txtalt2.Text.ToString().Replace("'", "''") + "' Where ImageNo=2 and ProductId=" + ProductID + "");
                        }
                        else
                        {
                    ...
                    if (ImgAlt3.Src.ToLower().IndexOf("/temp/") > -1 && ViewState["File3"] != null)
                    {
                        ...
                        {
                            CommonComponent.ExecuteCommonData("Update tb_ProductImgDesc set Description='" + txtalt3.Text.ToString().Replace("'", "''") + "' Where ImageNo=3 and ProductId=" + ProductID + "");
                        }
                        else
                        {
                    ...
                    if (ImgAlt4.Src.ToLower().IndexOf("/temp/") > -1 && ViewState["File4"] != null)
                    {
                        ...
                        {
                            CommonComponent.ExecuteCommonData("Update tb_ProductImgDesc set Description='" + txtalt4.Text.ToString().Replace("'", "''") + "' Where ImageNo= 4 and ProductId=" + ProductID + "");
                        }
                        else
                        {
                    ...
                    if (ImgAlt5.Src.ToLower().IndexOf("/temp/") > -1 && ViewState["File5"] != null)
                    {
                        ...
                        {
                            CommonComponent.ExecuteCommonData("Update tb_ProductImgDesc set Description='" + txtalt5.Text.ToString().Replace("'", "''") + "' Where ImageNo=5 and ProductId=" + ProductID + "");
                        }
                        else
                        {
