<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Couponcategorypopup.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Promotions.Couponcategorypopup" %>
...
<body style="background: none;">
    ...
    <div id="dvCategory" runat="server">
        <table style="width: 100%" cellpadding="2" cellspacing="2" class="content-table border-td">
            <tr id="btnsavetemp" runat="server" visible ="true" >

                <td colspan="5" align="right" style="background-color:#BABABA;">
                    <span style="width:80%;float:left; font-weight:bold;text-align:left;vertical-align:top;">Selected Category</span>
                     <span style="width:20%;float:right;"><asp:ImageButton ID="imgalldatasave" runat="server" OnClick="imgalldatasave_Click" OnClientClick="return checkCountPercentage();" /></span>

                </td>
            </tr>
            <tr>
                <td colspan="5">
                    <div style="float:left;overflow-y:auto;max-height:320px;width:100%;">
                      
                    <asp:GridView ID="grdSelectedNew" runat="server" AutoGenerateColumns="false" Width="100%" EmptyDataText="No Record Found!" RowStyle-ForeColor="Black" HeaderStyle-ForeColor="#3c2b1b" EmptyDataRowStyle-HorizontalAlign="Center" AllowPaging="False" PageSize="15" OnRowDataBound="grdSelected_RowDataBound" OnRowCommand="grdSelected_RowCommand">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Parent Category Name">
                                <ItemTemplate>
                                    <asp:Label ID="lblParent" runat="server" Text='<%#Eval("PerantName") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                             <asp:TemplateField HeaderText="Percantage">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtpercentage" runat="server" Height="20px"   Width="40px" Text='<%#Eval("Percantage") %>' onkeypress="return keyRestrict(event,'0123456789.');"></asp:TextBox>
                                </ItemTemplate>
                                  <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Action">
                                <ItemTemplate>
                                     <asp:ImageButton ID="ImgbtnSave" runat="server" CommandArgument='<%#Eval("CategoryId") %>' CommandName="Save" ImageUrl="/admin/images/save.jpg" AlternateText="Save" />&nbsp;<asp:ImageButton ID="ImgbtnDelete" AlternateText="Remove" runat="server" CommandArgument='<%#Eval("CategoryId") %>' OnClientClick="javascript:if(confirm('Are you sure want to delete?')){ return true; }else{return false;}" CommandName="Del" ImageUrl="/admin/images/delete-icon.gif" />
                                </ItemTemplate>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlCategory" runat="server" Width="210px" AutoPostBack="false" CssClass="order-list"></asp:DropDownList>
                </td>
                <td style="width: 20%">
                    ...
                    <asp:GridView ID="grdCategory" runat="server" AutoGenerateColumns="false" Width="100%"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Category Name">
                                <ItemTemplate>
                                    <%#Eval("Name") %>
                                     <asp:Label ID="lblcatname" Visible="false" runat="server" Text='<%#Eval("Name") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Parent Category Name">
                                <ItemTemplate>
    ...
    <script type="text/javascript" language="javascript">
        function validation() {
            ...
            if (a == "" && document.getElementById('ddlCategory').selectedIndex <= 0) {
    ...
    <script language="javascript" type="text/javascript">
            ...
            for (var i = 0; i < len; i++) {
                if (myform.elements[i].type == 'checkbox')
                {
                    if (myform.elements[i].checked == true)
                    {
                        ...
                        if (document.getElementById(myform.elements[i].id.toString().replace('_chkSelect_', '_txtpercentage_')).value == "" || parseInt(document.getElementById(myform.elements[i].id.toString().replace('_chkSelect_', '_txtpercentage_')).value) == parseInt(0))
                        {
                            jAlert('Please enter percantage value greater then 0.', 'Message', myform.elements[i].id.toString().replace('_chkSelect_', '_txtpercentage_'));
                            return false;
                        }
                        count += 1;
                    }
        ...
        function checkCountPercentage() {

            var myform = document.getElementById('grdSelectedNew').getElementsByTagName('input');
            ...
            for (var i = 0; i < len; i++)
            {
                ...
                if (myform[i].type == 'text' && (myform[i].value == "" || parseInt(myform[i].value) == parseInt(0))) {
                    jAlert('Please enter percantage value greater then 0.', 'Message', myform[i].id);
                            return false;
                        }
