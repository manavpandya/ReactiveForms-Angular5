<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true" CodeBehind="EventList.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Promotions.EventList" %>
    ...
    <div class="content-row1">
        <div class="create-new-order" style="width: 100%;">
            <span style="vertical-align: middle; margin-top:4px; margin-right: 3px; float: left;display:none;">
                ...
                href="/Admin/Promotions/ExpireEventBanner.aspx">
                <img alt="Add Event" title="Add Event" src="/App_Themes/<%=Page.Theme %>/images/add-event.png" /></a></span>
        </div>
    </div>
...
Staus : &nbsp;<asp:DropDownList ID="ddlSearch" CssClass="order-list" runat="server" Width="90px"
                                                            ...
                                                            <asp:ListItem Value="0" Text="In Active"></asp:ListItem>
                                                             <asp:ListItem Value="2" Text="Future"></asp:ListItem>
                                                        </asp:DropDownList>
                                                        Search : &nbsp;
...
<td style="background-color: #E3E3E3; font-weight: normal">
                                                                <div style='float: left; width: 10px; height: 10px; background-color: yellow'>
                                                                </div>
                                                            </td>
                                                      <td style="background-color: #E3E3E3; font-weight: normal">Future</td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                         </td>
 ...
 <asp:HiddenField ID="hdnurlname" runat="server" Value='<%#Eval("Urlname") %>' />
                                                    ...
                                                    <asp:TemplateField HeaderText="Store Name" HeaderStyle-Width="15%">
                                                     ...
                                                     <asp:TemplateField HeaderText="Ex. Date" HeaderStyle-Width="15%">
                                                        <HeaderTemplate>
                                                           Start. Date
                                                            <asp:ImageButton ID="sortexpirestart" runat="server" CommandArgument="DESC" CommandName="ExpirationDate"
                                                                AlternateText="Ascending Order" OnClick="Sorting" />
                                                        </HeaderTemplate>
                                                        <ItemStyle HorizontalAlign="left" />
                                                        <HeaderStyle HorizontalAlign="Left" />
                                                    ...
                                                    <asp:TemplateField HeaderText="Ex. Date" HeaderStyle-Width="15%">
                                                        ...
                                                        <HeaderStyle HorizontalAlign="Left" />
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbexpiredate" runat="server" Text='<%# bind("Enddate") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Display Order" HeaderStyle-Width="15%">
                                                        ...
                                                        <HeaderStyle HorizontalAlign="Left" />
                                                        <ItemTemplate>
                                                              <a href="SalesEventDisplayOrder.aspx" id="alinkdisplay" runat="server">Change Product Display Order</a>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Edit" HeaderStyle-Width="2%">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:ImageButton runat="server" ID="lnkbtnedit" ToolTip="Edit" CommandName="edit"
                                                                CommandArgument='<%# Eval("EventID") %>'></asp:ImageButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                        ...
                                        <td>
                                            <table width="100%">
                                                <tr id="trBottom" runat="server">
                                                    ...
                                                    <td align="right" style="width: 20%; padding-right:0px;"><a href="SalesEventDisplayOrder.aspx" style="display:none;">Change Product Display Order</a>&nbsp;
