<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true" CodeBehind="ExpireCollectionBanner.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Promotions.ExpireCollectionBanner" %>
         ...
         function openCenteredCrossSaleWindow1(mode) {
            ...
            <%-- if (document.getElementById('<%=ddlStore.ClientID %>').value != "0") {--%>
             ...
             var pis = document.getElementById('<%=txtvalidforprod.ClientID %>').value;
                ...
                var StoreID = 1;
                document.getElementById('idsset').src = 'Setsession.aspx?cIds=' + pis;
                ...
                window.open('CollectionPopup.aspx?StoreID=' + StoreID + '&mode=' + mode + '&CollectionId=' + couponid, "Mywindow", windowFeatures);
                return false;
    ...
    <script type="text/javascript">
        ...
        function validation() {
            ...
            if (document.getElementById("ContentPlaceHolder1_txtEventName") != null && document.getElementById("ContentPlaceHolder1_txtEventName").value.replace(/^\s+|\s+$/g, '') == '') {
                ...
                jAlert('Please Enter Collection Name.', 'Message');
                                        ...
                                        <tr>
                                            <th>
                                                <div class="main-title-left">
                                                    ...
                                                    <h2>
                                                        <asp:Label ID="lblTitle" runat="server" Text="Add New Collection Banner"></asp:Label></h2>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr>
...
<div style="height:200px;overflow-y:auto;float:left;width:20%;border:solid 1px #d7d7d7;">
                                                        ...
                                                        <tr class="even-row">
                                                            <td align="left" class="font-black01" valign="top" width="20%;">
                                                                <span style="color: Red;">&nbsp;</span> Collection Banner :
                                                            </td>
                                                            <td align="left">
 ...
 <tr class="oddrow">
                                                            <td align="left" class="font-black01" valign="top" width="20%;">
                                                                <span style="color: Red;">&nbsp;</span> Collection Logo :
                                                            </td>
                                                            <td align="left">
