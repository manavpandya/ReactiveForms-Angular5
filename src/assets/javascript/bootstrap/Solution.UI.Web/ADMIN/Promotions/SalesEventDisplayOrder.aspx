<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true" CodeBehind="SalesEventDisplayOrder.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Promotions.SalesEventDisplayOrder" %>
    ...
    <script type="text/javascript">
        ...
        function updatenn() {
            ...
            $.ajax(
              {
                  type: "POST",
                  url: "/TestMail.aspx/updatesaleseventdisplay",
    ...
    <script type="text/javascript">
        ...
        function verifyoption() {
                        ...
                        $.ajax(
            {
                ...
                data: "{option: '" + options + "',pagename:'salesevent'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: "true",
                cache: "false",
