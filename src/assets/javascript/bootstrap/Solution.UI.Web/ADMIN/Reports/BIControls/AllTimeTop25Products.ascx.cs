...
{
    public partial class AllTimeTop25Products : System.Web.UI.UserControl
    {
        ...
        public void CreateChart(string DBAction)
        {
            try
            {
                ...
                ds = adminComponent.GetAllTimeTop25Products(DBAction, StartDate, EndDate);
                ...
                if (ds != null && ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    foreach (DataRow item in ds.Tables[0].Rows)
                    {
                        ...
                        str = str + "['" + item["ProductName"].ToString().Replace("'", "") + "'," + item["Quantity"].ToString() + "]";
                        if (i != cnt)
                        {
                            str = str + ",";
                        }
                ...
                strScript += "google.setOnLoadCallback(Top25Productchartdiv);";
                strScript += "Sys.Application.add_load(Top25Productchartdiv);";
                strScript += "function Top25Productchartdiv() {";
                strScript += "var data = google.visualization.arrayToDataTable(" + str + ");";
                strScript += "var options = {title: 'Top 10 Product',pieHole: 0.4,is3D:true};";
                strScript += "var chart = new google.visualization.PieChart(document.getElementById('Top25Productchartdiv'));";
