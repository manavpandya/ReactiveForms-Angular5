<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true"
    CodeBehind="ItemsBySales.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Reports.ItemsBySales" %>
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="add-product">
                                    <tr>
                                        <th colspan="3">
                                            <div class="main-title-left">
                                                <img class="img-left" title="Best Selling Items" alt="Best Selling Items" src="/App_Themes/<%=Page.Theme %>/Images/mail-log-icon.png" />
                                                <h2>
                                    ...
                                    <tr>
                                        <td align="center" colspan="3">
                                            <div id="divGrid">
                                                <asp:GridView ID="grdProductSalesReport" runat="server" AutoGenerateColumns="False"
                                                    ...
                                                    PagerSettings-Mode="NumericFirstLast" OnPageIndexChanging="grdProductSalesReport_PageIndexChanging">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField>
                                                            ...
                                                            <ItemTemplate>
                                                                 <a href="javascript:void(0);" onclick="productquerystring(<%# DataBinder.Eval(Container.DataItem,"RefProductID") %>,<%#  DataBinder.Eval(Container.DataItem,"StoreID") %>);"
                                                                        title='<%# DataBinder.Eval(Container.DataItem,"ProductName") %>'>
