...
{
    public partial class LowInventoryAlert : BasePage
    {
        ...
        /// </summary>
        private void FillLowInventoryAlertReport()
        {
            DataSet dsLowInventory = new DataSet();
            dsLowInventory = DashboardComponent.GetLowInventoryAlertForReport(Convert.ToInt32(ddlStore.SelectedValue.ToString()));
        ...
        /// </summary>
        private void BindLowInventoryAlertReport()
        {
            int categoryid = 0;
            DataSet dsLowInventory = new DataSet();
            DashboardComponent objDashboardComp = new DashboardComponent();
            int.TryParse(ddlCategory.SelectedValue.ToString(), out categoryid);
            dsLowInventory = objDashboardComp.SearchLowInventoryProductAlert(categoryid, Convert.ToInt32(ddlStore.SelectedValue.ToString()), ddlSearch.SelectedValue.ToString(), txtSearch.Text.Trim().ToString());
