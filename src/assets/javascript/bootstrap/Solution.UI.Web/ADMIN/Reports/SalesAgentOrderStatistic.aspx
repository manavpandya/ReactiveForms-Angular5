<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true"
    CodeBehind="SalesAgentOrderStatistic.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Reports.SalesAgentOrderStatistic" %>
                                    ...
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="add-product">
                                        <tr>
                                            <th colspan="3">
                                                <div class="main-title-left">
                                                    <img class="img-left" title="Sales Agent Order Statistics" alt="Sales Agent Order Statistics" src="/App_Themes/<%=Page.Theme %>/Images/mail-log-icon.png" />
                                                    <h2>
                                                        Sales Agent Order Statistics</h2>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr class="altrow">
                                                ...
                                                <table cellpadding="3" cellspacing="3">
                                                    <tr>
                                                        ...
                                                        <td align="left" style="width: 180px;">
                                                            <asp:DropDownList ID="ddlsalesagents" runat="server" CssClass="order-list" Width="175px"
                                                                AutoPostBack="false">
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td align="right">
                                        ...
                                        <tr>
                                            <td align="center" colspan="3">
                                                <div id="divGrid">
                                                    <asp:GridView ID="grvsalesagentordrstats" runat="server" AutoGenerateColumns="False"
                                                        ...
                                                        ShowFooter="true" PagerSettings-Mode="NumericFirstLast" OnPageIndexChanging="grvsalesagentordrstats_PageIndexChanging"
                                                        OnRowDataBound="grvsalesagentordrstats_RowDataBound">
                                                        <Columns>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    Sr No
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <HeaderStyle HorizontalAlign="Left" />
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblStorename" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"OrderStatus") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle VerticalAlign="Top" HorizontalAlign="Left" CssClass="border" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                ...
                                                                <HeaderStyle HorizontalAlign="Left" />
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblSubject" runat="server" Text='<%#String.Format("{0:C}",Convert.ToDecimal(DataBinder.Eval(Container.DataItem,"OrderSubtotal"))) %>'></asp:Label></a>
                                                                </ItemTemplate>
                                                                <FooterTemplate>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <HeaderStyle HorizontalAlign="Left" />
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblamount" runat="server" Text='<%#String.Format("{0:C}",Convert.ToDecimal(DataBinder.Eval(Container.DataItem,"OrderTotal"))) %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <FooterTemplate>
                                                        ...
                                                        <FooterStyle BackColor="#E1E1E1" ForeColor="#000" Font-Bold="true" HorizontalAlign="Left"
                                                            BorderWidth="0" />
                                                    </asp:GridView>
                                                </div>
                                            </td>
