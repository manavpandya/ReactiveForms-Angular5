<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true" CodeBehind="TopSellingProductsColorList.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Reports.TopSellingProductsColorList" %>
                                    ...
                                    <tr>
                                        <th colspan="3">
                                            <div class="main-title-left">
                                                <img class="img-left" title="Best Selling Colors" alt="Best Selling Colors" src="/App_Themes/<%=Page.Theme %>/Images/mail-log-icon.png" />
                                                <h2>
                                                    Best Selling Colors</h2>
                                            </div>
                                        </th>
                                    </tr>
                                        ...
                                        <td align="center" colspan="3">
                                            <div id="divGrid">
                                                <asp:GridView ID="grdProductColorSalesReport" runat="server" AutoGenerateColumns="False"
                                                    ...
                                                    PagerSettings-Mode="NumericFirstLast" OnPageIndexChanging="grdProductColorSalesReport_PageIndexChanging">
                                                    <Columns>
