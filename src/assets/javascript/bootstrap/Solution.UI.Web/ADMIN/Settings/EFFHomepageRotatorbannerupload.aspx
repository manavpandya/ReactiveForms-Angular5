<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true" CodeBehind="EFFHomepageRotatorbannerupload.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Settings.EFFHomepageRotatorbannerupload" %>
                                                                                ...
                                                                                <table cellpadding="0" cellspacing="0" width="100%">
                                                                                    ...
                                                                                    <tr class="table_bg">
                                                                                        ...
                                                                                        <td align="left">
                                                                                            ...
                                                                                            <asp:Label ID="lblImgSize1" runat="server" Text="Size should be 318 x 400"></asp:Label><%--Width=960px,Height=245--%>
                                                                                            <%--  <asp:RequiredFieldValidator ID="RFVName" runat="server" ControlToValidate="FileUploadBanner"
                                                ErrorMessage="Select File" CssClass="rferror" SetFocusOnError="True" ValidationGroup="AppConfig"></asp:RequiredFieldValidator>--%>
                                                                                            <div>
                                                                                                <br />
                                                                                ...
                                                                                <table cellpadding="0" cellspacing="0" width="100%">
                                                                                    ...
                                                                                    <tr class="table_bg">
                                                                                        ...
                                                                                        <td align="left">
                                                                                            ...
                                                                                            <asp:Label ID="lblImgSize2" runat="server" Text="Size should be 318 x 400"></asp:Label><%--Width=960px,Height=245--%>
                                                                                            <%--  <asp:RequiredFieldValidator ID="RFVName" runat="server" ControlToValidate="FileUploadBanner"
                                                ErrorMessage="Select File" CssClass="rferror" SetFocusOnError="True" ValidationGroup="AppConfig"></asp:RequiredFieldValidator>--%>
                                                                                            <div>
                                                                                                <br />
