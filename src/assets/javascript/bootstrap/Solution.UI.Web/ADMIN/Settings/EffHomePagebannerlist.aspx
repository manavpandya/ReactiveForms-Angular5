<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true" CodeBehind="EffHomePagebannerlist.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Settings.EffHomePagebannerlist" %>
                                        ...
                                        <tr>
                                            <th align="left" colspan="2">
                                                <div class="main-title-left">
                                                    <img class="img-left" title="EFF Home Page Banner" alt="EFF Home Page Banner" src="/App_Themes/<%=Page.Theme %>/Images/home-page-banner-icon.png" />
                                                    <h2>
                                                        <asp:Label ID="lblTitle" runat="server" Text="EFF Home Page Banner">
                                                        </asp:Label>
                                                    </h2>
                                                </div>
                                                <div style="float: right;">
                                                    <h2>
                                                        <a href='EFFHomepageRatotingbanner.aspx?id=<%=ddlStore.SelectedValue %>'>
                                                            <img src='/App_Themes/<%= Page.Theme %>/button/Add-Rotating-Banner.png' border='0' /></a>
                                                    </h2>
                                                </div>
                                            </th>
                                        </tr>
