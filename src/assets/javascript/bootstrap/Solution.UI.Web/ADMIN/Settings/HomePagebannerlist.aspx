<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true" CodeBehind="HomePagebannerlist.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Settings.HomePagebannerlist" %>
                                        ...
                                        <tr>
                                            <th align="left" colspan="2">
                                                <div class="main-title-left">
                                                    ...
                                                    <h2>
                                                        <asp:Label ID="lblTitle" runat="server" Text="Home Page Banner">
                                                        </asp:Label>
                                                    </h2>
                                                </div>
                                                <div style="float: right;">
                                                    <h2>
                                                        <a href='HomepageRatotingbanner.aspx?id=<%=ddlStore.SelectedValue %>'>
