<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true" CodeBehind="HomepageRatotingbanner.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Settings.HomepageRatotingbanner" %>
...
<script type="text/javascript" src="/App_Themes/<%=Page.Theme %>/js/jquery-alerts-main.js"></script>
    ...
    <script type="text/javascript">
        ...
        function gotonextlink() {
            ...
            if (tt > 0) {
                window.location.href = 'HomepageRotatorbannerupload.aspx?grouptype=new&&id=' + tt.toString() + '&storeid=' + document.getElementById('<%=ddlStore.ClientID %>').options[document.getElementById('<%=ddlStore.ClientID %>').selectedIndex].value;
            }
            else {
