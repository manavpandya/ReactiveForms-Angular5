...
{
    public partial class HomepageRatotingbanner : BasePage
    {
        ...
        {
            Int32 Id = Convert.ToInt32(CommonComponent.GetScalarCommonData("SELECT TOP 1 BannerTypeId FROM tb_RotatorHomebanner WHERE StoreID=" + ddlStore.SelectedValue.ToString() + " AND isnull(IsActive,0)=1"));
