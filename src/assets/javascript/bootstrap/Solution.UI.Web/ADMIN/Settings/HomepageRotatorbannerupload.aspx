<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true" CodeBehind="HomepageRotatorbannerupload.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Settings.HomepageRotatorbannerupload" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Checkfields() {
            ...
            var fup1 = document.getElementById('<%=FileUploadBannerMobile.ClientID %>');
            ...
            if (document.getElementById('<%=txtStartDate.ClientID %>') != null && document.getElementById('<%=txtStartDate.ClientID %>').value == '' && document.getElementById('<%=txtEndDate.ClientID %>') != null && document.getElementById('<%=txtEndDate.ClientID %>').value == '') {
                ...
                if (document.getElementById('<%=TxtbannerTitle.ClientID %>') != null && document.getElementById('<%=TxtbannerTitle.ClientID %>').value == '') {
                    ...
                    jAlert('Please select banner image file.', 'Required', '<%=FileUploadBanner.ClientID %>');
                    return false;
                }
                else if ((ext != "gif" && ext != "jpeg" && ext != "jpg" && ext != "png" && ext != "bmp") && document.getElementById('<%=imghdn.ClientID %>').value == '') {
                    jAlert('Please select only image file for banner.', 'Required', '<%=FileUploadBanner.ClientID %>');
                    return false;
                }
                if (fileName1 == '' && document.getElementById('<%=imghdnMobile.ClientID %>').value == '') {
                    jAlert('Please select mobile banner image file.', 'Required', '<%=FileUploadBannerMobile.ClientID %>');
                    return false;
                }
                if ((ext1 != "gif" && ext1 != "jpeg" && ext1 != "jpg" && ext1 != "png" && ext1 != "bmp") && document.getElementById('<%=imghdnMobile.ClientID %>').value == '') {
                    jAlert('Please select only image file for mobile banner.', 'Required', '<%=FileUploadBannerMobile.ClientID %>');
                    return false;
                }
            }
            else {
...
function getKeyCode(e) {
                                        ...
                                        <tr class="even-row">
                                            <td colspan="100%" colspan="2" valign="top">
                                                <table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                                ...
                                                                <fieldset class="fldset" style="width: 98%;">
                                                                    ...
                                                                    <table align="left" class="add-product" border="0" cellpadding="0" cellspacing="0"
                                                                        ...
                                                                        <tr style="display: none;">
                                                                            <td align="left" valign="top">&nbsp;&nbsp;Left Banner Text
                                                                            </td>
                                                                            <td align="left">
                                                                        ...
                                                                        <tr class="table_bg">
                                                                            ...
                                                                            <td align="left">
                                                                                ...
                                                                                <asp:Label ID="lblImgSize" Font-Bold="true" ForeColor="Red" runat="server" Text="Size should be 1920 x 700"></asp:Label><%--Width=960px,Height=245--%>
                                                                                <div>
                                                                                    <br />
                                                                         ...
                                                                         <tr class="table_bg">
                                                                            <td align="left" class="font-black01" valign="top">
                                                                                <span style="color: Red;">*</span> Mobile Banner Image :
                                                                            </td>
                                                                            <td align="left">
                                                                                <asp:FileUpload ID="FileUploadBannerMobile" runat="server" />
                                                                                <asp:Label ID="lblImgSizeMobile" Font-Bold="true" ForeColor="Red" runat="server" Text="Size should be 640 x 800"></asp:Label><%--Width=960px,Height=245--%>
                                                                                <div>
                                                                                    <br />
                                                                                    <img id="imgBannerMobile" runat="server" style="height: 100%" />
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                        <tr class="altrow" style="display: none;">
                                                            ...
                                                            <td align="left" width="48%" valign="top" id="tdSmallbanner">
                                                                                ...
                                                                                <table cellpadding="0" cellspacing="0" width="100%">
                                                                                    ...
                                                                                    <tr class="table_bg">
                                                                                        ...
                                                                                        <td align="left">
                                                                                            ...
                                                                                            <asp:Label ID="lblImgSize1" runat="server" Font-Bold="true" ForeColor="Red" Text="Size should be 318 x 400"></asp:Label><%--Width=960px,Height=245--%>
                                                ...
                                                ErrorMessage="Select File" CssClass="rferror" SetFocusOnError="True" ValidationGroup="AppConfig"></asp:RequiredFieldValidator>--%>
                                                                                            <div>
                                                                                                <br />
                                                                                                <img id="imgBanner1" runat="server" style="width: 100%" />
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr class="altrow" style="display: none;">
                                                                                ...
                                                                                <table cellpadding="0" cellspacing="0" width="100%">
                                                                                    ...
                                                                                    <tr class="table_bg">
                                                                                        ...
                                                                                        <td align="left">
                                                                                            ...
                                                                                            <asp:Label ID="lblImgSize2" runat="server" Font-Bold="true" ForeColor="Red" Text="Size should be 318 x 400"></asp:Label><%--Width=960px,Height=245--%>
                                                                                            <%--  <asp:RequiredFieldValidator ID="RFVName" runat="server" ControlToValidate="FileUploadBanner"
                                                ErrorMessage="Select File" CssClass="rferror" SetFocusOnError="True" ValidationGroup="AppConfig"></asp:RequiredFieldValidator>--%>
                                                                                            <div>
                                                                                                <br />
                                                                                                <img id="imgBanner2" runat="server" style="width: 100%" />
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr class="altrow">
                                                                                ...
                                                                                <table cellpadding="0" cellspacing="0" width="100%">
                                                                                    ...
                                                                                    <tr class="table_bg">
                                                                                        ...
                                                                                        <td align="left">
                                                                                            ...
                                                                                            <asp:Label ID="lblImgSize3" runat="server" Font-Bold="true" ForeColor="Red" Text="Size should be 318 x 400"></asp:Label><%--Width=960px,Height=245--%>
                                                                                            <%--  <asp:RequiredFieldValidator ID="RFVName" runat="server" ControlToValidate="FileUploadBanner"
                                                ErrorMessage="Select File" CssClass="rferror" SetFocusOnError="True" ValidationGroup="AppConfig"></asp:RequiredFieldValidator>--%>
                                                                                            <div>
                                                                                                <br />
                                                                                ...
                                                                                <table cellpadding="0" cellspacing="0" width="100%">
                                                                                    ...
                                                                                    <tr class="table_bg">
                                                                                        ...
                                                                                        <td align="left">
                                                                                            ...
                                                                                            <asp:Label ID="lblImgSize4" runat="server" Font-Bold="true" ForeColor="Red" Text="Size should be 318 x 400"></asp:Label><%--Width=960px,Height=445--%>
                                                                                            <%--  <asp:RequiredFieldValidator ID="RFVName" runat="server" ControlToValidate="FileUploadBanner"
                                                ErrorMessage="Select File" CssClass="rferror" SetFocusOnError="True" ValidationGroup="AppConfig"></asp:RequiredFieldValidator>--%>
                                                                                            <div>
                                                                                                <br />
    ...
    <div style="display: none;">
        ...
        <input type="hidden" id="imghdnMobile" runat="server" value="" />
        ...
        <input type="hidden" id="hdnidMobile" runat="server" value="0" />
