<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true" CodeBehind="SmallHomepageRatotingbanner.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Settings.SmallHomepageRatotingbanner" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<script type="text/javascript" src="/App_Themes/<%=Page.Theme %>/js/jquery-alerts-main.js"></script>
    <script type="text/javascript" src="/App_Themes/<%=Page.Theme %>/js/jquery-alerts.js"></script>
    <script type="text/javascript" src="/App_Themes/<%=Page.Theme %>/js/jqueryControl.js"></script>
    <script  type="text/javascript" src="/App_Themes/<%=Page.Theme %>/js/jquery.icheck.min.js"></script>
    <script  type="text/javascript" src="/App_Themes/<%=Page.Theme %>/js/CustomhtmlControl.js"></script>
    ...
    <script type="text/javascript">
        ...
        function gotonextlink() {
            ...
            else if (document.getElementById('flat-radio-3') != null && document.getElementById('flat-radio-3').checked == true) {
                tt = 4;
            }
            if (tt > 0) {
                window.location.href = 'SmallHomepageRotatorbanneruploadMVC.aspx?grouptype=new&id=' + tt.toString() + '&storeid=' + document.getElementById('<%=ddlStore.ClientID %>').options[document.getElementById('<%=ddlStore.ClientID %>').selectedIndex].value;
            }
            else {
                                        ...
                                        <tr>
                                            <th colspan="2">
                                                <div class="main-title-left">
                                                     <img class="img-left" title="Add Small Home Page Banner" alt="Add Small Home Page Banner" src="/App_Themes/<%=Page.Theme %>/Images/home-page-banner-icon.png" />
                                                    <h2>
                                                        <asp:Label ID="lblTitle" runat="server" Text="Add Small Home Page Banner">
                                                        </asp:Label>
                                                    </h2>
                                                </div>
                                                        ...
                                                        <td width="25%" valign="top">
                                                            <div style="-moz-border-radius: 5px 5px 5px 5px; background: #d7d7d7; padding: 5px;
                                                                ...
                                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                                    <tr>
                                                                        <td align="center" style="padding-left: 45%;">
                                                                           <%-- <input tabindex="7" type="radio" checked id="flat-radio" name="flat-radio" />--%>
                                                                            ...
                                                                            <label for="flat-radio" style="float: left; margin-top: 2px; margin-left: 2px;">
                                                                                Layout 1</label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td width="100%" style="padding: 5px;">
                                                                            <table cellpadding="0" cellspacing="0" style="border: dashed 1px #d7d7d7;" width="100%">
                                                                                <tr>
                                                                                    <td style="height: 221px; text-align: center; vertical-align: middle;">
                                                                                        1920 x 750
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                    ...
                                                                    <tr>
                                                                        <td width="100%" style="text-align:center;"><b>OR</b></td>
                                                                        ...
                                                                        <td align="center" width="100%" style="padding: 5px;padding-top:0px;">
                                                                            <table cellpadding="0" cellspacing="0" align="center" border="0" width="100%">
                                                                                ...
                                                                                <td>
                                                                                 ...
                                                                                 <tr>
                                                                                  <td style="height: 317px;width:50%; text-align: center; vertical-align: middle; border: dashed 1px #d7d7d7;padding-left:2px;padding-bottom:2px;"
                                                                                    ...
                                                                                    <td valign="top" style="width:50%" >
                                                                                        <table cellpadding="0" cellspacing="1" style="width:100%;vertical-align:top;">
                                                                                            <tr>
                                                                                                <td style="height: 317px;width:100%; text-align: center; vertical-align: middle; border: dashed 1px #d7d7d7;"
                                                                                                    align="center" valign="top">
                                                                                                    770 x 750
                                                                                                </td>
                                                                                            </tr>
                                                                ...
                                                                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border: solid 1px #d7d7d7;
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <asp:Literal ID="ltradio2" runat="server"></asp:Literal>
                                                                            ...
                                                                            <label for="flat-radio-2" style="float: left; margin-top: 2px; margin-left: 2px;">
                                                                                Layout 3</label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                                 ...
                                                                                 <tr>
                                                                                  <td style="height: 317px;width:80%; text-align: center; vertical-align: middle; border: dashed 1px #d7d7d7;padding-left:2px;padding-bottom:2px;"
                                                                                    ...
                                                                                    <td valign="top" style="width:100%" >
                                                                                        <table cellpadding="0" cellspacing="1" style="width:100%;vertical-align:top;">
                                                                                            <tr>
                                                                                                <td style="height: 317px;width:33%; text-align: center; vertical-align: center; border: dashed 1px #d7d7d7;"
                                                                                                    align="center">
                                                                                                    503 x 710
                                                                                                </td>
                                                                                                <td style="height: 317px;width:33%; text-align: center; vertical-align: center; border: dashed 1px #d7d7d7;"
                                                        ...
                                                        <td width="25%" valign="top">
                                                            <div style="-moz-border-radius: 5px 5px 5px 5px; background: #d7d7d7; padding: 5px;
                                                                ...
                                                                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border: solid 1px #d7d7d7;
                                                                    ...
                                                                    <tr>
                                                                        <td align="center" style="padding-left: 45%;">
                                                                        <asp:Literal ID="ltradio3" runat="server"></asp:Literal>
                                                                            <%--<input tabindex="7" type="radio" id="flat-radio-2" name="flat-radio" />--%>
                                                                            <label for="flat-radio-3" style="float: left; margin-top: 2px; margin-left: 2px;">
                                                                                Layout 4</label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                                 ...
                                                                                 <tr>
                                                                                  <td style="height: 317px;width:80%; text-align: center; vertical-align: middle; border: dashed 1px #d7d7d7;padding-left:2px;padding-bottom:2px;"
                                                                                    ...
                                                                                    <td valign="top" style="width:100%" >
                                                                                        <table cellpadding="0" cellspacing="1" style="width:100%;vertical-align:top;">
                                                                                            <tr>
                                                                                                <td style="height: 317px;width:25%; text-align: center; vertical-align: center; border: dashed 1px #d7d7d7;"
                                                                                                    align="center">
                                                                                                    355 x 400
                                                                                                </td>
                                                                                                <td style="height: 317px;width:25%; text-align: center; vertical-align: center; border: dashed 1px #d7d7d7;"
