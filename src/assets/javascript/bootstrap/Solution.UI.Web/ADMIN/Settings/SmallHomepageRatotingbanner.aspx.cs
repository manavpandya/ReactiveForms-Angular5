...
{
    public partial class SmallHomepageRatotingbanner : BasePage
    {
        ...
        {
            Int32 Id = Convert.ToInt32(CommonComponent.GetScalarCommonData("SELECT TOP 1 BannerTypeId FROM tb_RotatorHomebannerSmall WHERE StoreID=" + ddlStore.SelectedValue.ToString() + " AND isnull(IsActive,0)=1"));
            ...
            ltradio3.Text = "<input type=\"radio\" id=\"flat-radio-3\" name=\"flat-radio\" />";
            if (Id > 0)
            {
                if (Id == 1)
                {
                ...
                else if (Id == 4)
                {
                    ...
                    ltradio1.Text = "<input type=\"radio\" id=\"flat-radio-1\" name=\"flat-radio\" />";
                    ltradio2.Text = "<input type=\"radio\" id=\"flat-radio-2\" name=\"flat-radio\" />";
                    ltradio3.Text = "<input type=\"radio\" checked id=\"flat-radio-3\" name=\"flat-radio\" />";
                }
