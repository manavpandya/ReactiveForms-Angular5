<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true" CodeBehind="SmallHomepageRotatorbanneruploadMVC.aspx.cs" Inherits="Solution.UI.Web.ADMIN.Settings.SmallHomepageRotatorbanneruploadMVC" %>
...
function Checkfields6() {
    // document.getElementById('').value = '';
    var fup = document.getElementById('<%=FileUploadBanner6.ClientID %>');
    var fileName = fup.value;
    var ext = fileName.substring(fileName.lastIndexOf('.') + 1);
    ext = ext.toLowerCase();
    if (document.getElementById('<%=txtStartDate.ClientID %>') != null && document.getElementById('<%=txtStartDate.ClientID %>').value == '' && document.getElementById('<%=txtEndDate.ClientID %>') != null && document.getElementById('<%=txtEndDate.ClientID %>').value == '') {

                if (document.getElementById('<%=TxtbannerTitle6.ClientID %>') != null && document.getElementById('<%=TxtbannerTitle6.ClientID %>').value == '') {
                    jAlert('Please enter title.', 'Required', '<%=TxtbannerTitle6.ClientID %>');
                    return false;
                }
                else if (fileName == '' && document.getElementById('<%=imghdn2.ClientID %>').value == '') {
                    jAlert('Please select image file.', 'Required', '<%=FileUploadBanner6.ClientID %>');
            return false;
        }
        else if ((ext != "gif" && ext != "jpeg" && ext != "jpg" && ext != "png" && ext != "bmp") && document.getElementById('<%=imghdn6.ClientID %>').value == '') {
            jAlert('Please select only image file.', 'Required', '<%=FileUploadBanner6.ClientID %>');
            return false;
        }
}
else {
    ...
    var date1 = new Date(document.getElementById('<%=txtStartDate.ClientID %>').value);
        ...
        else if (fileName == '' && document.getElementById('<%=imghdn6.ClientID %>').value == '') {
            jAlert('Please select image file.', 'Required', '<%=FileUploadBanner6.ClientID %>');
            return false;
        }
        else if ((ext != "gif" && ext != "jpeg" && ext != "jpg" && ext != "png" && ext != "bmp") && document.getElementById('<%=imghdn6.ClientID %>').value == '') {
...
function getKeyCode(e) {
                                        ...
                                        <tr class="even-row">
                                            <td colspan="100%" colspan="2" valign="top">
                                                <table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="border-td-sub" colspan="4" width="100%" valign="top">
                                                            ...
                                                            <td class="border-td-sub" width="25%" valign="top">
                                                                <fieldset class="fldset" style="width: 98%;">
                                                                    ...
                                                                    <table align="left" class="add-product" border="0" cellpadding="0" cellspacing="0"
                                                                        ...
                                                                        <tr>
                                                                            <td align="left" valign="top" id="TxtBannerTexttr" runat="server">
                                                                                <span style="color: Red;">&nbsp;</span> Banner Text :
                                                                            </td>
                                                                            <td align="left" id="TxtBannerTexttr1" runat="server">
                                                                                <asp:TextBox ID="TxtBannerText" Width="350px" runat="server" CssClass="order-textfield"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr class="altrow">
                                                                            <td align="left" valign="top">
                                                                        ...
                                                                        <tr class="altrow">
                                                                            <td align="left" valign="top" id="TxtBannerTexttr4" runat="server">
                                                                                <span style="color: Red;">*</span>&nbsp;Banner&nbsp;Text&nbsp;Position :
                                                                            </td>
                                                                            <td align="left" id="TxtBannerTexttr5" runat="server">
                                                                                <asp:DropDownList ID="ddlbannertextposition" runat="server" CssClass="order-list">
                                                                        ...
                                                                        <tr>
                                                                            <td align="left" valign="top" id="TxtBannerTexttr6" runat="server">&nbsp;&nbsp;Banner Text
                                                                            </td>
                                                                            <td align="left" id="TxtBannerTexttr7" runat="server">
                                                                                <asp:TextBox ID="txtLeftBannerText" Width="350px" runat="server" TextMode="MultiLine"></asp:TextBox>
                                                                                <script type="text/javascript">
                                                                                    CKEDITOR.replace('<%= txtLeftBannerText.ClientID %>', { baseHref: '<%= ResolveUrl("~/ckeditor/") %>', height: 100 });
                                                ...
                                                ErrorMessage="Select File" CssClass="rferror" SetFocusOnError="True" ValidationGroup="AppConfig"></asp:RequiredFieldValidator>--%>
                                                                        ...
                                                                        <tr class="altrow" style="display: none;">
                                                                            <td align="left" valign="top">&nbsp;&nbsp; Display Order :
                                                                            </td>
                                                                            <td align="left">
                                                                            ...
                                                                            <fieldset class="fldset" style="width: 95%;">
                                                                                ...
                                                                                <table cellpadding="0" cellspacing="0" width="100%">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="left">
                                                                                            <asp:TextBox ID="TxtBannerText1" Width="350px" runat="server" CssClass="order-textfield"></asp:TextBox>
                                                                                        </td>
                                                                                    </tr>
                                                ...
                                                ErrorMessage="Select File" CssClass="rferror" SetFocusOnError="True" ValidationGroup="AppConfig"></asp:RequiredFieldValidator>--%>
                                                                                            <div>
                                                                                                <br />
                                                                                                <img id="imgBanner1" runat="server" style="height: 100%" />
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr class="altrow" style="display: none;">
                                                ...
                                                ErrorMessage="Select File" CssClass="rferror" SetFocusOnError="True" ValidationGroup="AppConfig"></asp:RequiredFieldValidator>--%>
                                                                                            <div>
                                                                                                <br />
                                                                                                <img id="imgBanner3" runat="server" style="width: 100%" />
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr class="altrow">
                                                                                ...
                                                                                <table cellpadding="0" cellspacing="0" width="100%">
                                                                                    ...
                                                                                    <tr class="table_bg">
                                                                                        ...
                                                                                        <td align="left">
                                                                                            ...
                                                                                            <br />
                                                                                            <br />
                                                                                            <asp:Label ID="lblImgSize4" runat="server" Text="Size should be 318 x 400"></asp:Label><%--Width=960px,Height=445--%>
                                                                                            <%--  <asp:RequiredFieldValidator ID="RFVName" runat="server" ControlToValidate="FileUploadBanner"
                                                ErrorMessage="Select File" CssClass="rferror" SetFocusOnError="True" ValidationGroup="AppConfig"></asp:RequiredFieldValidator>--%>
                                                                                            <div>
                                                                                                <br />
                                                                                                <img id="imgBanner4" runat="server" style="width: 100%" />
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr class="altrow">
                                                                            ...
                                                                            <fieldset class="fldset" style="width: 95%;">
                                                                                ...
                                                                                <table cellpadding="0" cellspacing="0" width="100%">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="left">
                                                                                            <asp:TextBox ID="TxtBannerText2" Width="350px" runat="server" CssClass="order-textfield"></asp:TextBox>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr class="altrow">
                                                                                        <td align="left" valign="top">
                                                ...
                                                ErrorMessage="Select File" CssClass="rferror" SetFocusOnError="True" ValidationGroup="AppConfig"></asp:RequiredFieldValidator>--%>
                                                                                            <div>
                                                                                                <br />
                                                                                                <img id="imgBanner2" runat="server" style="height: 100%" />
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr class="altrow" style="display: none;">
                                                                        ...
                                                                        <td align="left" valign="top">
                                                                            <fieldset class="fldset" style="width: 95%;">
                                                                                ...
                                                                                <table cellpadding="0" cellspacing="0" width="100%">
                                                                                    <tr>
                                                                                        <td colspan="2" align="Center">
                                                                                            <asp:Label ID="lblMsg6" runat="server" CssClass="error"></asp:Label>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr class="altrow">
                                                                                        <td align="left" valign="top">
                                                                                     ...
                                                                                     <tr>
                                                                                        ...
                                                                                        <td align="left">
                                                                                            <asp:TextBox ID="TxtBannerText6" Width="350px" runat="server" CssClass="order-textfield"></asp:TextBox>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr class="altrow">
                                                                                        <td align="left" valign="top">
                                                                                    ...
                                                                                    <tr class="table_bg">
                                                                                        ...
                                                                                        <td align="left">
                                                                                            <asp:FileUpload ID="FileUploadBanner6" runat="server" />
                                                                                            <br />
                                                                                            <br />
                                                                                            <asp:Label ID="lblImgSize6" runat="server" Font-Bold="true" ForeColor="Red" Text="Size should be 355 x 400"></asp:Label><%--Width=960px,Height=445--%>
                                                                                            <div>
                                                                                                <br />
                                                                                                <img id="imgBanner6" runat="server" style="width: 100%" />
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr class="altrow" style="display: none;">
                                                                                        ...
                                                                                        <td align="left">
                                                                                            <asp:TextBox ID="TxtDisplayOrder6" Width="40px" Style="text-align: center" MaxLength="4"
                                                                                                onkeypress="return keyRestrict(event,'0143456789');" runat="server" CssClass="order-textfield"></asp:TextBox>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr style="display: none;">
                                                                                        ...
                                                                                        <td align="left">
                                                                                            <asp:CheckBox ID="chkActive6" runat="server" />
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td align="left" height="30" valign="top" style="width: 137px"></td>
                                                                                        <td align="left">
                                                                                            <asp:ImageButton ID="imgSave5" runat="server" AlternateText="Save" ToolTip="Save"
                                                                                                OnClick="imgSave5_Click" OnClientClick="return Checkfields6();" />
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                            </fieldset>
                                                ...
                                                ErrorMessage="Select File" CssClass="rferror" SetFocusOnError="True" ValidationGroup="AppConfig"></asp:RequiredFieldValidator>--%>
                                                                                            <div>
                                                                                                <br />
                                                                                                <img id="imgBanner5" runat="server" style="width: 100%" />
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr class="altrow" style="display: none;">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="left" height="30" valign="top" style="width: 137px"></td>
                                                                                        <td align="left">
                                                                                            <asp:ImageButton ID="imgSave6" runat="server" AlternateText="Save" ToolTip="Save"
                                                                                                OnClick="imgSave6_Click" OnClientClick="return Checkfields5();" />
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                            </fieldset>
    ...
    <div style="display: none;">
        ...
        <input type="hidden" id="imghdn6" runat="server" value="" />
        ...
        <input type="hidden" id="hdnid6" runat="server" value="0" />
