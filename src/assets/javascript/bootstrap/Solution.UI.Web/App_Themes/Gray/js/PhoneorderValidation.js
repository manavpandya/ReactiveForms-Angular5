...
function ValidatePage() {
    ...
    if (document.getElementById("ContentPlaceHolder1_txtB_FName") != null && document.getElementById("ContentPlaceHolder1_txtB_FName").value.replace(/^\s+|\s+$/g, "") == '') {
        ...
        else if (!CheckBillZipCodeLength()) {
            return false;
        }
        else if (!CheckBillZipCode()) {
            return false;
        }
...
function ValidateShippingFields() {
    ...
    if (document.getElementById("ContentPlaceHolder1_txtS_FName") != null && document.getElementById("ContentPlaceHolder1_txtS_FName").value.replace(/^\s+|\s+$/g, "") == '') {
        ...
        else if (!CheckShipZipCodeLength()) {
            return false;
        }
else if (!CheckShipZipCode()) {
            return false;
        }
...
function checkcreditcard() {
    ...
    if (document.getElementById('ContentPlaceHolder1_rdoCreditCard') != null && document.getElementById('ContentPlaceHolder1_rdoCreditCard').checked == false && document.getElementById('ContentPlaceHolder1_rdoCheque') != null && document.getElementById('ContentPlaceHolder1_rdoCheque').checked == false) {
...
function checkbilllength() {

    if (document.getElementById("ContentPlaceHolder1_txtB_FName") != null && document.getElementById("ContentPlaceHolder1_txtB_FName").value.replace(/^\s+|\s+$/g, "") != '' && document.getElementById("ContentPlaceHolder1_txtB_LName") != null && document.getElementById("ContentPlaceHolder1_txtB_LName").value.replace(/^\s+|\s+$/g, "") != '') {

        var len = document.getElementById("ContentPlaceHolder1_txtB_FName").value.length;
        var len2 = document.getElementById("ContentPlaceHolder1_txtB_LName").value.length;
        var totlen = parseInt(len) + parseInt(len2) + parseInt(1);

        if (totlen > 35) {
            
            jAlert("Billing FirstName and LastName length should be less than or equal to 35 Characters.", "Required Information", "ContentPlaceHolder1_txtB_FName");
            //$('html, body').animate({ scrollTop: $('#ContentPlaceHolder1_txtB_FName').offset().top }, 'slow');
            document.getElementById("ContentPlaceHolder1_txtB_FName").focus();
            return false;
        }
...
function checkshipplength() {
    if (document.getElementById("ContentPlaceHolder1_txtS_FName") != null && document.getElementById("ContentPlaceHolder1_txtS_FName").value.replace(/^\s+|\s+$/g, "") != '' && document.getElementById("ContentPlaceHolder1_txtS_LNAme") != null && document.getElementById("ContentPlaceHolder1_txtS_LNAme").value.replace(/^\s+|\s+$/g, "") != '') {

        var len = document.getElementById("ContentPlaceHolder1_txtS_FName").value.length;
        var len2 = document.getElementById("ContentPlaceHolder1_txtS_LNAme").value.length;
        var totlen = parseInt(len) + parseInt(len2) + parseInt(1);
        if (parseInt(totlen) > parseInt(35)) {
            jAlert("Shipping FirstName and LastName length should be less than or equal to 35 Characters.", "Required Information", "ContentPlaceHolder1_txtS_FName");
            //$('html, body').animate({ scrollTop: $('#ContentPlaceHolder1_txtS_FName').offset().top }, 'slow');
            document.getElementById("ContentPlaceHolder1_txtS_FName").focus();
            return false;
        }
...
function checkshippaddresslen() {
    if (document.getElementById("ContentPlaceHolder1_txtS_Add1") != null && document.getElementById("ContentPlaceHolder1_txtS_Add1").value.replace(/^\s+|\s+$/g, "") != '') {

        var len = document.getElementById("ContentPlaceHolder1_txtS_Add1").value.length;

        var totlen = parseInt(len);

        if (totlen > 30) {
            
jAlert("Please use Shipping Address Line 2 for additional characters.", "Required Information", "ContentPlaceHolder1_txtS_Add1");
            
            document.getElementById("ContentPlaceHolder1_txtS_Add1").focus();
            return false;
        }
...
function checkbilladdresslen() {
    if (document.getElementById("ContentPlaceHolder1_txtB_Add1") != null && document.getElementById("ContentPlaceHolder1_txtB_Add1").value.replace(/^\s+|\s+$/g, "") != '') {

        var len = document.getElementById("ContentPlaceHolder1_txtB_Add1").value.length;

        var totlen = parseInt(len);

        if (totlen > 30) {
	jAlert("Please use Billing Address Line 2 for additional characters.", "Required Information", "ContentPlaceHolder1_txtB_Add1");
           
            document.getElementById("ContentPlaceHolder1_txtB_Add1").focus();
            return false;
        }
...
function CheckBillZipCode() {
    if (document.getElementById("ContentPlaceHolder1_txtB_Zip") != null && document.getElementById("ContentPlaceHolder1_txtB_Zip").value.replace(/^\s+|\s+$/g, "") != '') {
        var mm = true;
        if (document.getElementById("ContentPlaceHolder1_ddlB_Country") != null && document.getElementById("ContentPlaceHolder1_ddlB_Country").options[document.getElementById("ContentPlaceHolder1_ddlB_Country").selectedIndex].value == 1) {


            mm = validateNumeric(document.getElementById("ContentPlaceHolder1_txtB_Zip").value);
            if (mm == false) {
                jAlert("Please enter valid Billing Zip Code. (e.g.: 12345)", "Required Information", "ContentPlaceHolder1_txtB_Zip");
                $('html, body').animate({ scrollTop: $('#ContentPlaceHolder1_txtB_Zip').offset().top }, 'slow');
                document.getElementById("ContentPlaceHolder1_txtB_Zip").focus();
                return false;
            }
            else {
                return true;
...
function CheckShipZipCode() {
    if (document.getElementById("ContentPlaceHolder1_txtS_Zip") != null && document.getElementById("ContentPlaceHolder1_txtS_Zip").value.replace(/^\s+|\s+$/g, "") != '') {
        var mm = true;
        if (document.getElementById("ContentPlaceHolder1_ddlS_Country") != null && document.getElementById("ContentPlaceHolder1_ddlS_Country").options[document.getElementById("ContentPlaceHolder1_ddlS_Country").selectedIndex].value == 1) {


            mm = validateNumeric(document.getElementById("ContentPlaceHolder1_txtS_Zip").value);
            if (mm == false) {
                jAlert("Please enter valid Shipping Zip Code. (e.g.: 12345)", "Required Information", "ContentPlaceHolder1_txtS_Zip");
                $('html, body').animate({ scrollTop: $('#ContentPlaceHolder1_txtS_Zip').offset().top }, 'slow');
                document.getElementById("ContentPlaceHolder1_txtS_Zip").focus();
                return false;
            }
            else {
                return true;
...
function CheckBillZipCodeLength() {
    if (document.getElementById("ContentPlaceHolder1_txtB_Zip") != null && document.getElementById("ContentPlaceHolder1_txtB_Zip").value.replace(/^\s+|\s+$/g, "") != '') {
       
        if (document.getElementById("ContentPlaceHolder1_ddlB_Country") != null && document.getElementById("ContentPlaceHolder1_ddlB_Country").options[document.getElementById("ContentPlaceHolder1_ddlB_Country").selectedIndex].value == '1') {

            var len = document.getElementById("ContentPlaceHolder1_txtB_Zip").value.length;
           
            var totlen = parseInt(len);

            if (totlen < 5) {
                jAlert("Billing Zipcode length should be at least 5, Please enter valid Billing ZipCode.", "Required Information", "ContentPlaceHolder1_txtB_Zip");
                $('html, body').animate({ scrollTop: $('#ContentPlaceHolder1_txtB_Zip').offset().top }, 'slow');
                document.getElementById("ContentPlaceHolder1_txtB_Zip").focus();
                return false;
            }
...
function CheckShipZipCodeLength() {
    if (document.getElementById("ContentPlaceHolder1_txtS_Zip") != null && document.getElementById("ContentPlaceHolder1_txtS_Zip").value.replace(/^\s+|\s+$/g, "") != '') {
        
        if (document.getElementById("ContentPlaceHolder1_ddlS_Country") != null && document.getElementById("ContentPlaceHolder1_ddlS_Country").options[document.getElementById("ContentPlaceHolder1_ddlS_Country").selectedIndex].value == '1') {
            var len = document.getElementById("ContentPlaceHolder1_txtS_Zip").value.length;

            var totlen = parseInt(len);

         
            if (totlen < 5) {
                jAlert("Shipping Zipcode length should be at least 5, Please enter valid Shipping ZipCode.", "Required Information", "ContentPlaceHolder1_txtS_Zip");
                $('html, body').animate({ scrollTop: $('#ContentPlaceHolder1_txtS_Zip').offset().top }, 'slow');
                document.getElementById("ContentPlaceHolder1_txtS_Zip").focus();
                return false;
            }
...
function validateNumeric(numValue) {
    if ((parseFloat(numValue) == parseInt(numValue)) && !isNaN(numValue)) {
        return true;
    } else {
        return false;
    }
