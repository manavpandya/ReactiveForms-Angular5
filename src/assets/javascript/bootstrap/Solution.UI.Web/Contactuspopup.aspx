<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contactuspopup.aspx.cs" Inherits="Solution.UI.Web.Contactuspopup" %>
...
<body style="background: none;">
    <form id="form1" runat="server">
        <div style="overflow-y: auto; height: 800px; width: 98%">
            <asp:Panel ID="pnlcontactus" runat="server" DefaultButton="btnsubmit">
                ...
                <div class="content-main">
                    ...
                    <div class="static-main" style=" padding-top: 0px;">
                        <div class="static-main-box">
                            ...
                            <br />
                            <table width="96%" cellspacing="0" cellpadding="3" border="0" class="table-none" style="margin-left: 4px;">
                                <tbody>
                                  <%--  <tr>
                                                    ...
                                                    <td style="padding: 0 0 0 7px;">
                                                        <div id="divother" runat="Server" style="display: none; float: left;">
                                                            ...
                                                            <asp:TextBox ID="txtother" onkeypress="return isNumberKey(event)" runat="server"
                                                                CssClass="specify-fild" Width="100px" MaxLength="70" Style="margin-top: 5px; margin-left: 5px;"></asp:TextBox>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtinformation" Style="height:50px;" TextMode="MultiLine" runat="server" CssClass="contact-textaria"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr >
                                        <td valign="middle">
                                        ...
                                        <td>
                                            ...
                                            <input type="button" value="" title="Reload" id="btnreload" style="background: url(/images/reload-icon.png) no-repeat transparent; width: 31px; height: 29px; border: none; cursor: pointer; margin: 8px 0 0 5px;"
