<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ItemPage.aspx.cs" Inherits="Solution.UI.Web.ItemPage" %>
...
PriceChangeondropdown();
    ...
    <script type="text/javascript">
        ...
        function PriceChangeondropdown() {
            ...
            {
                document.getElementById('ContentPlaceHolder1_btnAddToCart').disabled = true;
            }
...
if (document.getElementById('ContentPlaceHolder1_btnAddToCart') != null) {
    document.getElementById('ContentPlaceHolder1_btnAddToCart').disabled = false;
}
                                }
                            },
                            Error: function (x, e) {
...
$.ajax(
        ...
        function ChangeCustomprice() {
            ...
            if (document.getElementById('ContentPlaceHolder1_ddlcustomstyle').selectedIndex != 0 && document.getElementById('ContentPlaceHolder1_ddlcustomlength').selectedIndex != 0 && document.getElementById('ContentPlaceHolder1_ddlcustomwidth').selectedIndex != 0 && document.getElementById('ContentPlaceHolder1_dlcustomqty').selectedIndex != 0) {
                ...
                var oid = '';
                if (document.getElementById('<%=ddlcustomoptin.ClientID %>') != null) {
                      oid = document.getElementById('<%=ddlcustomoptin.ClientID %>').options[document.getElementById('<%=ddlcustomoptin.ClientID %>').selectedIndex].value;
                }
                    ...
                    <div class="item-left-row1" id="boxContainer">
                        ...
                        <div class="more-images">
                            ...
                            <div style="display:none;">
                                  <asp:ImageButton ID="btnAddTocartSwatch" runat="server" AlternateText="Order Swatch" 
...
&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=21"
                    ...
                    <div class="item-main-title">
                        ...
                        <div class="rating" id="divrationmain" runat="server" itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating">
...
<asp:Literal ID="ltmetaprice" runat="server"></asp:Literal>
                                                    <div class="price-detail-left" style="width: 100%;">
                                                        <div class="item-pricepro">
                                                            ...
                                                            <div class="item-pricepro-right" style="display: none;">
                                                                <div class="moneyback-guarantee-pro" id="divmoneybackbanner" runat="server" visible="false">
                                                                   <div class="moneyback-guarantee-box"><span></span></div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="price-qty">
                                                            <div style="float: left; padding: 10px 0 0 0;">
                                                             ...
                                                             <div id="divswatchimage" runat="server" style="float: left; padding: 10px 0 0 5px;">
                                                                <a href="javascript:void(0);" title="Order Swatch" style="margin: auto;" onclick="javascript:document.getElementById('ContentPlaceHolder1_btnAddTocartSwatch').click();">
                                                                    <img src="/images/click-to-order-swatch.jpg" title="Order Swatch" alt="Order Swatch" /></a>
                                                            </div>
                                                            <div id="divpricequtoteformadetomeasure" runat="server" style="float: left; padding: 0px 10px 0 5px;">
                                                                ...
                                                                <div class="main-div-help-bg">
                                                                    <div class="main-div-help">
                                                                        <a href="javascript:void(0);" onclick="priceQuoteDiff();" title=" title="DON'T SEE YOUR SIZE">
                    ...
                    <div class="item-right-row1">
                        ...
                        <div class="item-right-row1-bg" id="divproperty3">
                            <span>Item Code:
                                <asp:Literal ID="litModelNumber" runat="server"></asp:Literal></span>
                            <div style="float: left; width: 100%; cursor: pointer;" class="description-Feature" id="aproductfeature" onclick="showhidefeatures();">
                                Show More Products Details
                            </div>
                             <div style="float: left; width: 100%; display: none;" id="divfeature">
                            <asp:Literal ID="ltfeature" runat="server"></asp:Literal>
                                 </div>
                        </div>
                    </div>
                    <div class="item-right-row1" id="divProductProperty" runat="server">
                        <div class="description-Feature" id="divproperty" style="cursor: pointer; padding-left: 8px;">
                            Product Properties 
                        </div>
                        <div class="item-right-row1-bg" id="divproperty1">

                            <div class="properties1" id="divLightControl" runat="server" visible="false" style="background: none; border: none; width: 675px;padding-left: 3px;">
