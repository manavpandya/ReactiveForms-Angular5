...
{
    public partial class ItemPageRating : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["PID"] != null)
                {
                    ...
                    //liswatch.Attributes.Add("onclick", "InsertProductSwatch(" + Request.QueryString["PID"].ToString() + ",'" + liswatch.ClientID.ToString() + "'); return false;");
                    ...
                    Page.ClientScript.RegisterStartupScript(Page.GetType(), "tadisplayscript", strscript.ToString(), true);
                }
                else
                {
                    Response.Redirect("/index.aspx");
            ...
            //Page.ClientScript.RegisterStartupScript(Page.GetType(), "tadisplay", "window.onunload=function{document.getElementById('divtaball').style.display = '';}", true);
            ...
            if (dsproduct != null && dsproduct.Tables.Count > 0 && dsproduct.Tables[0].Rows.Count > 0)
            {
                ...
                else
                {
                    ...
                    if (DataSwatch != null && DataSwatch.Tables.Count > 0 && DataSwatch.Tables[0].Rows.Count > 0)
                    {
                        ...
                        liswatch.Attributes.Remove("onclick");
                        liswatch.Attributes.Add("onclick", "InsertProductSwatch(" + Swatchid.ToString() + ",'" + liswatch.ClientID.ToString() + "'); return false;");
                        if (Convert.ToInt32(DataSwatch.Tables[0].Rows[0]["Inventory"].ToString()) > 0)
                        {
                            ...
                            if (swatchprice > decimal.Zero)
                            {
                                ...
                                else if (swatchprice > swatchsaleprice)
                                {
                                    ...
                                    ltSwatchPrice.Text = " <span>Swatch Price:</span> <strong style='color: #B92127;font-size:16px;'>" + Convert.ToDecimal(swatchsaleprice.ToString()).ToString("C") + "</strong>" + StrSalePriceTag;
                                    hdnswatchprice.Value = Convert.ToString(swatchsaleprice.ToString());
                                }
                                else
                                {
                                    ltSwatchPrice.Text = " <span>Swatch Price:</span> <strong style='color: #B92127;font-size:16px;'>" + Convert.ToDecimal(DataSwatch.Tables[0].Rows[0]["price"].ToString()).ToString("C") + "</strong>" + StrSalePriceTag;
                ...
                if (!string.IsNullOrEmpty(dsproduct.Tables[0].Rows[0]["PDFName"].ToString()))
                {
                    ...
                    if (File.Exists(Server.MapPath(ViewState["PdfPath"].ToString())))
                    {
                ...
                //{
                    ...
                    {
                        btnAddToCart.OnClientClick = "InsertProductSwatch(" + Request.QueryString["PID"].ToString() + ",'ContentPlaceHolder1_btnAddToCart'); return false;";
                    }
                    else
                    {
                        btnAddToCart.OnClientClick = "InsertProduct(" + Request.QueryString["PID"].ToString() + ",'ContentPlaceHolder1_btnAddToCart'); return false;";
                    }
                ...
                if (!String.IsNullOrEmpty(dsproduct.Tables[0].Rows[0]["Imagename"].ToString()))
                {
                    if (File.Exists(Server.MapPath(AppLogic.AppConfigs("ImagePathProduct") + "icon/" + dsproduct.Tables[0].Rows[0]["Imagename"].ToString())))
                    {
                        ...
                        if (!string.IsNullOrEmpty(StrTagName))
                        {
                            ...
                            lblTag.Text += "<img  title='" + StrTagName.ToString().Trim() + "' src=\"/images/" + StrTagName.ToString().Trim() + ".png\" alt=\"" + StrTagName.ToString().Trim() + "\" class='" + StrTagName.ToString().ToLower() + "Rating' />";
                ...
                else
                {
                    divzioom.Visible = false;
                    imgMain.Src = AppLogic.AppConfigs("ImagePathProduct") + "icon/image_not_available.jpg?" + rd.Next(10000).ToString();
                    //ltrMainImage.Text = "<img src=\"" + AppLogic.AppConfigs("ImagePathProduct") + "icon/image_not_available.jpg?" + rd.Next(10000).ToString() + "\" alt=\"\"  title=\"\" style=\"vertical-align: middle;width: 322px; height: 312px;\" />";
                }
                // Video by LPR
                ...
                try
                {
                    ...
                    string imagepathforpinit = AppLogic.AppConfigs("ImagePathProduct") + "icon/" + dsproduct.Tables[0].Rows[0]["Imagename"].ToString();
                ...
                dsVariant = CommonComponent.GetCommonDataSet("SELECT * FROM tb_ProductVariant WHERE ProductID=" + productID + " AND isnull(ParentId,0)=0 ORDER BY CASE WHEN ISNULL(VariantName,'') = 'Width' THEN 0 WHEN ISNULL(VariantName,'') = 'Length' THEN 0 ELSE 1 END, DisplayOrder");
                string strvarinat = "";
                        ...
                        else
                        {
                            if ((dsVariant.Tables[0].Rows[i]["VariantName"].ToString().ToLower().IndexOf("width") > -1 || dsVariant.Tables[0].Rows[i]["VariantName"].ToString().ToLower().IndexOf("length") > -1))
                            {
                                if (IsWidth == false)
                                {
                                    ...
                                    strvarinat += "<div class=\"pro-properties-left\">SELECT MEASUREMENTS <span></span></div><input type=\"hidden\" name=\"hdnvariantname-" + dsVariant.Tables[0].Rows[i]["VariantID"].ToString() + "\" value=\"" + dsVariant.Tables[0].Rows[i]["VariantName"].ToString() + "\" />";
                                }
                            }
                            else
                            {
                                strvarinat += "<div class=\"readymade-detail-pt1\" >";
                                strvarinat += "<div class=\"pro-properties-left\" id=\"divvariantname-" + dsVariant.Tables[0].Rows[i]["VariantID"].ToString() + "\">" + dsVariant.Tables[0].Rows[i]["VariantName"].ToString() + "</div><input type=\"hidden\" name=\"hdnvariantname-" + dsVariant.Tables[0].Rows[i]["VariantID"].ToString() + "\" value=\"" + dsVariant.Tables[0].Rows[i]["VariantName"].ToString() + "\" />";
                            }
                        }
                        if (dsVariantvalue != null && dsVariantvalue.Tables.Count > 0 && dsVariantvalue.Tables[0].Rows.Count > 0)
                        {
                            ...
                            if (!string.IsNullOrEmpty(dsVariant.Tables[0].Rows[i]["VariantName"].ToString()) && dsVariant.Tables[0].Rows[i]["VariantName"].ToString().ToLower().IndexOf("color") > -1)
                            {
                                ...
                                if (IsVariColor)
                                {
                                    strvarinat += "<div class=\"pro-properties-pt1\" id=\"divvariantname-" + dsVariant.Tables[0].Rows[i]["VariantID"].ToString() + "\"><span>" + dsVariant.Tables[0].Rows[i]["VariantName"].ToString() + "</span><input type=\"hidden\" name=\"hdnvariantname-" + dsVariant.Tables[0].Rows[i]["VariantID"].ToString() + "\" value=\"" + dsVariant.Tables[0].Rows[i]["VariantName"].ToString() + "\" />";
                            ...
                            else
                            {
                                if ((dsVariant.Tables[0].Rows[i]["VariantName"].ToString().ToLower().IndexOf("length") > -1) || (dsVariant.Tables[0].Rows[i]["VariantName"].ToString().ToLower().IndexOf("width") > -1))
                                {
                                    ...
                                    {
                                        strvarinat += "  <div class=\"pro-properties-right\" id='divSelectvariant-" + dsVariant.Tables[0].Rows[i]["VariantID"].ToString() + "'>###width-length####";
                                    }
                                }
                                else
                                {
                                    strvarinat += "  <div class=\"pro-properties-right\" id='divSelectvariant-" + dsVariant.Tables[0].Rows[i]["VariantID"].ToString() + "'>";
                                }
                            }
                            ...
                            if ((dsVariant.Tables[0].Rows[i]["VariantName"].ToString().ToLower().IndexOf("width") > -1) || (dsVariant.Tables[0].Rows[i]["VariantName"].ToString().ToLower().IndexOf("length") > -1))
                            {
                                if (dsVariant.Tables[0].Rows[i]["VariantName"].ToString().ToLower().IndexOf("length") > -1)
                                    strwidthlenght += "<div class=\"option-pt1\"><span  id=\"divvariantname-" + dsVariant.Tables[0].Rows[i]["VariantID"].ToString() + "\">Length</span>";
                                else
                                    strwidthlenght += "<div class=\"option-pt1\"><span  id=\"divvariantname-" + dsVariant.Tables[0].Rows[i]["VariantID"].ToString() + "\">Width</span>";

                                strwidthlenght += "<select ####onchange#### name=\"Selectvariant-" + dsVariant.Tables[0].Rows[i]["VariantID"].ToString() + "\" class=\"option2\" id=\"Selectvariant-" + dsVariant.Tables[0].Rows[i]["VariantID"].ToString() + "\" >";
                            }
                            else
                            {
                                strvarinat += "<select ####onchange#### name=\"Selectvariant-" + dsVariant.Tables[0].Rows[i]["VariantID"].ToString() + "\" class=\"option1\" id=\"Selectvariant-" + dsVariant.Tables[0].Rows[i]["VariantID"].ToString() + "\" >";
                            }
                            ...
                            for (int j = 0; j < dsVariantvalue.Tables[0].Rows.Count; j++)
                            {
                                ...
                                else
                                {
                                    if (dsVariant.Tables[0].Rows[i]["VariantName"].ToString().ToLower().IndexOf("color") > -1)
                                    {
                                        if (Session["VID"] != null && Convert.ToString(Session["VID"]) != "" && (dsVariantvalue.Tables[0].Rows[j]["VariantValue"].ToString().ToLower() == Convert.ToString(Session["VID"]).ToLower()))
                                        {
                                            strvarinat += "<option value=\"" + dsVariantvalue.Tables[0].Rows[j]["VariantValueId"].ToString() + "\" selected=\"true\" ####selectded####>" + dsVariantvalue.Tables[0].Rows[j]["VariantValue"].ToString() + StrBuy1onsale + strPrice + "</option>";
                                        }
                                        else { strvarinat += "<option value=\"" + dsVariantvalue.Tables[0].Rows[j]["VariantValueId"].ToString() + "\" ####selectded####>" + dsVariantvalue.Tables[0].Rows[j]["VariantValue"].ToString() + StrBuy1onsale + strPrice + "</option>"; }
                                    }
                                    else
                                    {
                                        if ((dsVariant.Tables[0].Rows[i]["VariantName"].ToString().ToLower().IndexOf("width") > -1) || (dsVariant.Tables[0].Rows[i]["VariantName"].ToString().ToLower().IndexOf("length") > -1))
                                        {
                                            strwidthlenght += "<option value=\"" + dsVariantvalue.Tables[0].Rows[j]["VariantValueId"].ToString() + "\" ####selectded####>" + dsVariantvalue.Tables[0].Rows[j]["VariantValue"].ToString() + StrBuy1onsale + strPrice + "</option>";
                                        }
                                        else
                                        {
                                ...
                                if (isChild == false && dsVariantparent.Tables.Count > 0 && dsVariantparent.Tables[0].Rows.Count > 0)
                                {
                                    ...
                                    strvarinatchild += "<div class=\"pro-properties-left\" id=\"divvariantname-" + dsVariantparent.Tables[0].Rows[0]["VariantID"].ToString() + "\">" + dsVariantparent.Tables[0].Rows[0]["VariantName"].ToString() + "</div><input type=\"hidden\" name=\"hdnvariantname-" + dsVariantparent.Tables[0].Rows[0]["VariantID"].ToString() + "\" value=\"" + dsVariantparent.Tables[0].Rows[0]["VariantName"].ToString() + "\" />";
                                    strvarinatchild += "  <div class=\"pro-properties-right\" id='divSelectvariant-" + dsVariantparent.Tables[0].Rows[0]["VariantID"].ToString() + "'>";
                                    strvarinatchild += "<select onchange=\"PriceChangeondropdown();\" name=\"Selectvariant-" + dsVariantparent.Tables[0].Rows[0]["VariantID"].ToString() + "\" class=\"option1\" id=\"Selectvariant-" + dsVariantparent.Tables[0].Rows[0]["VariantID"].ToString() + "\" >";
                            ...
                            if (dsVariant.Tables[0].Rows[i]["VariantName"].ToString().ToLower().IndexOf("width") > -1 || dsVariant.Tables[0].Rows[i]["VariantName"].ToString().ToLower().IndexOf("length") > -1)
                            {
                                ...
                                strwidthlenght += "<select class=\"option2\" name=\"Selectvariant-" + dsVariant.Tables[0].Rows[i]["VariantID"].ToString() + "\" id=\"Selectvariant-" + dsVariant.Tables[0].Rows[i]["VariantID"].ToString() + "\">";
        ...
        private void GetRecentlyProduct(string ProductID, int OrgProductID)
        {
            ...
            if (dsRecently != null && dsRecently.Tables.Count > 0 && dsRecently.Tables[0].Rows.Count > 0)
            {
                ...
                for (Int32 i = 0; i < dsRecently.Tables[0].Rows.Count; i++)
                {
                    ...
                    ltrRecently.Text += " <img src='/images/add-to-cart.png' alt='Add To Cart' class='preview' width='150' height='30' title='Add To Cart'></a>";
                    // Bind TagName
                    ...
                    //    {
                    //        ltrRecently.Text += "<img title='" + StrTagName.ToString().Trim() + "' src=\"/images/" + StrTagName.ToString().Trim() + ".png\" alt=\"" + StrTagName.ToString().Trim() + "\" class='" + StrTagName.ToString().ToLower() + "' style='position: absolute; top: 110px; left: 4px;' />";
                    //    }
                    //}
                    ...
                    ltrRecently.Text += "<h2 class='bs-box-h2' style='height:37px;'><a title=\"" + SetAttribute(dsRecently.Tables[0].Rows[i]["Tooltip"].ToString()) + "\" href=\"/" + dsRecently.Tables[0].Rows[i]["ProductURL"].ToString() + "\">" + SetName(dsRecently.Tables[0].Rows[i]["Sortname"].ToString()) + "</a></h2>";
        ...
        private void GetYoumayalsoLikeProduct(int ProductID)
        {
            ...
            if (dsYouMay != null && dsYouMay.Tables.Count > 0 && dsYouMay.Tables[0].Rows.Count > 0)
            {
                ...
                for (Int32 i = 0; i < dsYouMay.Tables[0].Rows.Count; i++)
                {
                    ...
                    ltrYoumay.Text += " <img src='/images/add-to-cart.png' alt='Add To Cart' class='preview' width='150' height='30' title='Add To Cart'></a>";
                    // Bind TagName
                    ...
                    //    if (File.Exists(Server.MapPath(AppLogic.AppConfigs("ImagePathProduct") + "icon/" + dsYouMay.Tables[0].Rows[i]["imagename"].ToString())))
                    //    {
                    //        ltrYoumay.Text += "<img title='" + StrTagName.ToString().Trim() + "' src=\"/images/" + StrTagName.ToString().Trim() + ".png\" alt=\"" + StrTagName.ToString().Trim() + "\" class='" + StrTagName.ToString().ToLower() + "' style='position: absolute; top: 110px; left: 4px;' />";
                    //    }
                    //}
                    ...
                    ltrYoumay.Text += "<h2 class='bs-box-h2' style='height:37px;'><a title=\"" + SetAttribute(dsYouMay.Tables[0].Rows[i]["Tooltip"].ToString()) + "\" href=\"/" + dsYouMay.Tables[0].Rows[i]["ProductURL"].ToString() + "\">" + SetName(dsYouMay.Tables[0].Rows[i]["Sortname"].ToString()) + "</a></h2>";
        ...
        private void GetOptinalAccesories(String SKUs)
        {
            ...
            if (dsOA != null && dsOA.Tables.Count > 0 && dsOA.Tables[0].Rows.Count > 0)
            {
                for (Int32 i = 0; i < dsOA.Tables[0].Rows.Count; i++)
                {
                    ...
                    ltrOptionalAccesories.Text += " <img src='/images/add-to-cart.png' alt='Add To Cart' class='preview' width='150' height='30' title='Add To Cart'></a>";
                    // Bind TagName
                    ...
                    ltrOptionalAccesories.Text += "<h2 class='bs-box-h2' style='height:37px;'><a title=\"" + SetAttribute(dsOA.Tables[0].Rows[i]["Tooltip"].ToString()) + "\" href=\"/" + dsOA.Tables[0].Rows[i]["ProductURL"].ToString() + "\">" + SetName(dsOA.Tables[0].Rows[i]["Name"].ToString()) + "</a></h2>";
                ...
                if (strImagePath != AppLogic.AppConfigs("ImagePathProduct") + "micro/image_not_available.jpg")
                {
                    ...
                    try
                    {
                        ...
                        if (!string.IsNullOrEmpty(StrMainImgDesc) && StrMainImgDesc.Length > 0)
                        {
                            ...
                            strMoreImg.Append("<div>" + Server.HtmlEncode(StrMainImgDesc.ToString()) + "</div>");
                        }
                    }
                    catch { }
                }
