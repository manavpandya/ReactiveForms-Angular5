<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ItemPageRatingNew.aspx.cs" Inherits="Solution.UI.Web.ItemPageRatingNew" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowModelHelpShipping(id) {
            ...
            document.getElementById('frmdisplay1').height = '743px';
            document.getElementById('frmdisplay1').width = '620px';
            document.getElementById('popupContact1').setAttribute("style", "z-index: 1000001; top: 0px; padding: 0px;width:620px;height:733px;");
            document.getElementById('popupContact1').style.width = '620px';
            document.getElementById('popupContact1').style.height = '733px';
            window.scrollTo(0, 0);
                ...
                for (var iS = 0; iS < allselect.length; iS++) {
                    ...
                    if (eltSelect.selectedIndex != 0) {
                        ...
                        if (eltSelect.options[0].text.toLowerCase().indexOf('header design') > -1) {
                            document.getElementById(valsel1).innerHTML = "<span id=" + eltSelect.id.replace('Selectvariant-', 'spancolspan-') + ">" + document.getElementById(eltSelect.id.replace('Selectvariant-', 'spancolspan-')).innerHTML + "</span>" + eltSelect.options[0].text.toLowerCase().replace('select ', '').replace('select', '') + ':<strong style="font-weight:normal;color:#B92127; margin-left:5px;">' + eltSelect.options[eltSelect.selectedIndex].text.toString().replace('($', ' - $').replace(')', '') + '</strong>';
                        }
                        else {
                            document.getElementById(valsel1).innerHTML = "<span id=" + eltSelect.id.replace('Selectvariant-', 'spancolspan-') + ">" + document.getElementById(eltSelect.id.replace('Selectvariant-', 'spancolspan-')).innerHTML + "</span>" + eltSelect.options[0].text + ':<strong style="font-weight:normal;color:#B92127; margin-left:5px;">' + eltSelect.options[eltSelect.selectedIndex].text.toString().replace('($', ' - $').replace(')', '') + '</strong>';
                        }
                        //divselvalue
                        //}
                ...
                $.ajax(
                        {
                            ...
                            success: function (msg) {
                                if (document.getElementById('diestimatedate') != null) {
                                    $('#diestimatedate').html('<span class="readymade-detail-left" style="width: 100% !important;font-size:14px !important;color:#B92127;">' + msg.d + '</span>');
                               ...
                               $.ajax(
                                           {
                                               ...
                                               success: function (msg) {
                                                   ...
                                                   if (document.getElementById('divmeadetomeasure') != null) {
                                                       ...
                                                       $('#divmeadetomeasure').html('<span class="readymade-detail-left" style="width: 100% !important;font-size:14px !important;color:#B92127;">' + msg.d + '</span>');
    ...
    <script type="text/javascript">
        ...
        function ShowModelHelpShipping(id) {
            ...
            document.getElementById('frmdisplay1').height = '743px';
            document.getElementById('frmdisplay1').width = '620px';
            document.getElementById('popupContact1').setAttribute("style", "z-index: 1000001; top: 0px; padding: 0px;width:630px;height:733px;background: none repeat scroll 0 0 rgba(3, 3, 3, 0.3) !important; padding: 10px !important;border:none !important;");
            document.getElementById('popupContact1').style.width = '620px';
            document.getElementById('popupContact1').style.height = '733px';
            window.scrollTo(0, 0);
            document.getElementById('btnhelpdescri').click();
    ...
    <div class="static-main">
        <div class="review-rating-main">
            <div class="item-bg">
                <div class="item-row1">
                    <div class="item-left">
                        <div class="item-main-title" style="padding-top: 0 !important;"><a id="aback" runat="server" title="Back">
                            <img src="/images/back.jpg" alt="" title="" class="img-left"></a></div>
                                            ...
                                            <div class="readymade-detail">
                                                ...
                                                <div class="price-detail">
                                                    <div class="price-detail-left" style="width: 100%;">
                                                        <div class="price-qty">
                                                            <div id="div1" runat="server" style="float: left; width: 24%; padding: 10px 0 0 0;">
                                                                <span>Quantity :</span>
                                                                <asp:TextBox ID="txtQty" runat="server" MaxLength="4" TabIndex="0" Text="1" CssClass="price-qty-input"
                                                                    onkeypress="return onKeyPressBlockNumbers1(event);" onkeyup="PriceChangeondropdown();"></asp:TextBox><br />
                                                                <br />
                                                        ...
                                                        <div class="price-qty">
                                                            <div id="divQuantity" runat="server" style="float: left; width: 100%; padding: 10px 0 0 0;">
                                                                ...
                                                                <div class="price-quote-small" id="divpricequtoteformadetomeasure" runat="server" style="float:right;padding:0;margin-right:5px;">
                                    <div class="item-right-row1-title" style="border:none;width:auto !important;float:right !important;">
                                             <div class="main-div-help-bg">
  <div class="main-div-help">
    <a href="javascript:void(0);" onclick="priceQuoteDiff();" title="Need Design Help"><h2>WE'RE HERE TO HELP</h2>
    <p><strong>Custom Price Request</strong>, Ideas and Advice</p></a>
  </div>
</div>
                                    </div>
                                </div>
                                        ...
                                        <div style="float: right; line-height: 25px; padding-right: 2px; padding-top: 2px;"><a title="Learn More" href="javascript:void(0);" onclick="ShowModelForPleatGuide();" style="color: #B92127">LEARN MORE</a></div>
                                                    ...
                                                    <div class="readymade-detail-right-pro" id="divcolspancustomvalue-1" style="display: none;">
                                                        ...
                                                        <div style="float: right; width: 100%; margin-bottom: 5px; text-align: right;">
                                                            <img src="/images/next-option.png" alt="Next" title="Next" border="0" style="cursor: pointer;" onclick="if(document.getElementById('ContentPlaceHolder1_ddlcustomstyle') != null && document.getElementById('ContentPlaceHolder1_ddlcustomstyle').selectedIndex == 0){jAlert('Please Select Header.','Message');}else{varianttabhideshowcustom(2);}" /></div>
                                        ...
                                        <div id="divselvaluecustom-4" style="float: right; line-height: 25px; padding-right: 2px;"></div>
                                                ...
                                                <div class="readymade-detail-right-pro" id="divcolspancustomvalue-4" style="display: none;">
                                                    <div class="selector fixedWidth" id="uniform-lift_pos_select_right">
                                                        <span style="-moz-user-select: none;" id="dlcustomqty-ddl">Quantity</span>
                                            ...
                                            <div class="readymade-detail-pt1" style="display: none; margin-bottom: 5px;" id="divmeadetomeasure">
                                            </div>
                                            <div class="price-qty">

                                            <div class="readymade-detail-pt1">
                                                <div class="price-detail-left" style="width: 380px;">
                                                    <p id="divcustomprice" style="width: 65%; margin-top: 14px;">
                                                ...
                                                <div style="width: 80%; float: left;">
                                                    ...
                                                    <div class="price-select-box-row" style="width: 80%; float: left;">
                                                        ...
                                                        <a href="javascript:void(0);" onclick="javascript:window.parent.ShowModelForPleatGuidequote();">
                                                            <img width="16" height="16" style="padding: 2px 0 0 2px" class="img-left" title="Help" alt="Help" src="/images/help-icon.png"></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="price-select-box" style="width: 100% !important; padding-bottom: 5px; padding-top: 5px;">
    ...
    ControlID="btnsubmit" /> </Triggers>--%>
        ...
        <div style="display: none;">
            ...
            <div id="divretrunpolicy">
                ...
                <div style="float: left; width: 100%; margin: 0px; padding: 0px; max-height: 500px; overflow-y: auto;">
                   <%-- <link href="/css/style.css" rel="stylesheet" type="text/css" />--%>
                    <div style="background: none repeat scroll 0 0 #F2F2F2; color: #D50000; font-family: Arial,Helvetica,sans-serif; font-size: 13px; margin: 0 0 15px; padding: 5px 0;">
        ...
        <div class="item-main">
            <div class="item-bg">
                <div class="item-row1">
                    ...
                    <div class="item-left">
                        <div class="item-left-row1" id="boxContainer" style="position: relative;">
                        ...
                        <div class="item-main-title">
                            ...
                            <div class="rating">
                                ...
                                <p>
                                    ...
                                    <a id="awrite" runat="server">Write a Review</a>
                                </p>
                            </div>
                        </div>
                        <div class="item-right-row1" id="divdiscription" runat="server">
                            <div class="item-right-row1-title1">
                                <span>Product Description</span><asp:ImageButton ID="btnAddTocartSwatch" runat="server"
                        ...
                        <div class="item-right-row1" id="divProductProperty" runat="server">
                            <div class="item-right-row1-title" id="divproperty" style="cursor: pointer;">
                                <span style="float: left;">Product Properties</span><span style="flot: right;"><img
                                    src="/images/expand.gif" alt="Expand" title="Expand" id="imgPro" style="float: right; margin: 0;"></span>
                            </div>
            ...
            <div class="item-row2">
                <div class="item-left" style="padding: 0px !important;">
...
&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=21"
                        ...
                        <div id="divBookmarkLinks" runat="server" class="item-left-row2">
                            ...
                            <a href="javascript:void(0);" onclick="ShowModelForPleatGuide();" title="Pleat Guide">Pleat Guide</a>| <a href="javascript:void(0);" onclick="ShowModelForfaq();" title="FAQ">FAQ</a>|<a href="javascript:void(0);"
                                onclick="ShowModelForMeasuringguide();" title="Measuring Guide">Measuring Guide</a>|<a
                                    href="javascript:void(0);" title="Design Guide">Design Guide</a> <a visible="false"
                    ...
                    <div class="item-left-row6" id="divrecently" runat="server">
                        <div class="item-left-row6-title" style="border-top: solid 1px #ddd !important;">
                            Recently Viewed
                        </div>
                        <div class="bs-main">
                            <div class="jcarousel-skin-tango1">
