<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PriceMatchAmazonProduct.aspx.cs"
    Inherits="Solution.UI.Web.PriceMatchAmazonProduct" %>
...
//            }
            ...
            document.getElementById('txtItem1').innerHTML = '<%=Request.QueryString["id"]%>';
        }
...
<body style="background: none;" onload="windowloadurl();">
