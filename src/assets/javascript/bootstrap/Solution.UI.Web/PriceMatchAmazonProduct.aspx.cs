...
{
    public partial class PriceMatchAmazonProduct : System.Web.UI.Page
    {
        ...
        private void SendMail(String AddressTo)
        {
            ...
            dsMailTemplate = objCustomer.GetEmailTamplate("PriceMatch", Convert.ToInt32(3));
            ...
            if (dsMailTemplate != null && dsMailTemplate.Tables.Count > 0 && dsMailTemplate.Tables[0].Rows.Count > 0)
            {
                ...
                dsTopic = TopicComponent.GetTopicList("InvoiceSignature", Convert.ToInt32(3));
