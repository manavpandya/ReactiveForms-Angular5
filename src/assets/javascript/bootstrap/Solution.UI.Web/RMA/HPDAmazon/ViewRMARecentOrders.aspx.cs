...
namespace Solution.UI.Web.RMA.HPDAmazon
{
    public partial class ViewRMARecentOrders : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //{
            lnkBack.HRef = "/RMA/HPDAmazon/ReturnItem.aspx";
            //}
                ...
                if (dr != null && dr.Length > 0)
                {
                    ...
                    foreach (DataRow drOrderNums in dr)
                    {
                        ...
                        if (dsOrder != null && dsOrder.Tables.Count > 0 && dsOrder.Tables[0].Rows.Count > 0)
                        {
                            ...
                            Table.Append("<br/><br/><a href='/RMA/HPDAmazon/invoice.aspx?ONo=" + Server.UrlEncode(SecurityComponent.Encrypt(Convert.ToString(drOrderNums["OrderNumber"].ToString()))) + "' target=\"_blank\"\">View Invoice</a>  ");
                            Table.Append("</td>");
                            Table.Append("</tr>");
                            Table.Append("<tr>");
                                ...
                                for (Int32 i = 0; i < DsCartDetail.Tables[0].Rows.Count; i++)
                                {
                                    ...
                                    if (!string.IsNullOrEmpty(dsOrder.Tables[0].Rows[0]["ShippingTrackingNumber"].ToString()))
                                    {
                                        ...
                                        if ((DsCartDetail.Tables[0].Rows[i]["MainCategory"].ToString() == null) || (DsCartDetail.Tables[0].Rows[i]["MainCategory"].ToString() == ""))
                                        {
                                            ...
                                            Table.Append("<td align='left' width='83%' valign='top'><label style='color:#EA702F;'>" + Convert.ToString(DsCartDetail.Tables[0].Rows[i]["Name"].ToString()) + "</a><br />" + ltrvartable.Text + "</label>");
                                            Table.Append("</td>");
                                        }
                                        else
                                        {
                                            ...
                                            Table.Append("<td align='left'  width='83%' valign='top' ><label style='color:#EA702F;'>" + Convert.ToString(DsCartDetail.Tables[0].Rows[i]["Name"].ToString()) + "<br />" + ltrvartable.Text + "</label>");
                                            Table.Append("</td>");
                                        }
                                        Table.Append("</tr>");
                                        if (isReturnitem == true)
                                    ...
                                    else
                                    {
                                        ...
                                        //        Table.Append("<td align='left' width='10%' style='vAlign:top;' ><a href='javascript:void(0);'><img width='110pxc' style='border-width:0px;'  Title=\"" + Convert.ToString(DsCartDetail.Tables[0].Rows[i]["Name"].ToString()) + "\" src=\"" + GetMicroImage(Convert.ToString(DsCartDetail.Tables[0].Rows[i]["ImageName"].ToString())) + "\" alt=\"" + Convert.ToString(DsCartDetail.Tables[0].Rows[i]["Name"].ToString()) + "\"></a>");
                                        //        Table.Append("</td>");
                                        //        Table.Append("<td align='left' width='83%' valign='top'><label style='color:#EA702F;'>" + Convert.ToString(DsCartDetail.Tables[0].Rows[i]["Name"].ToString()) + "</label><br />" + ltrvartable.Text + "");
                                        //    }
                                        //    Table.Append("</td>");
                                        //}
                                        //else
                                        ...
                                        if ((DsCartDetail.Tables[0].Rows[i]["MainCategory"].ToString() == null) || (DsCartDetail.Tables[0].Rows[i]["MainCategory"].ToString() == ""))
                                        {
                                            ...
                                            Table.Append("</td>");
                                            //Table.Append("<td align='left' width='83%' valign='top'><a  href='/" + Convert.ToString(DsCartDetail.Tables[0].Rows[i]["SEName"].ToString()) + "-" + Convert.ToString(DsCartDetail.Tables[0].Rows[i]["RefProductID"].ToString()) + ".aspx'>" + Convert.ToString(DsCartDetail.Tables[0].Rows[i]["Name"].ToString()) + "</a></a><br />" + ltrvartable.Text + "");
                                            Table.Append("<td align='left' width='83%' valign='top'><label style='color:#B92127;'>" + Convert.ToString(DsCartDetail.Tables[0].Rows[i]["Name"].ToString()) + "<br />" + ltrvartable.Text + "</label>");
                                            Table.Append("</td>");
                                        }
                                        else
                                        {
                                        ...
                                        else
                                        {
                                            ...
                                            if (isShipped)
                                            {
                                                ...
                                                {
                                                    Table.Append("<a style='font-weight:bold;' href=\"mailto:" + AppLogic.AppConfigs("ContactMail_ToAddress").ToString() + "\"><img src=\"/images/send_e_Mail_for_request.gif\" border=\"0\" /></a>&nbsp;");
                                                }
                                                Table.Append("</td>");
                                                Table.Append("</tr>");
                                            }
