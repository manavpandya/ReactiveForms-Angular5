<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Invoice.aspx.cs" Inherits="Solution.UI.Web.RMA.HPDYahoo.Invoice" %>
...
<body>
        ...
        <tr class="Printinvoice">
            <td valign="middle" align="left">
                <a title="Print Invoice" href="javascript:window.print();">
                    <img title="PRINT INVOICE" alt="PRINT INVOICE" src="/RMA/HPDYahoo/images/print_invoice.png"
    ...
    <table width="624" border="0" align="center" cellpadding="0" cellspacing="0" class="popup_docwidth">
                        ...
                        <td>
                            <a href="#" title="">
                                <%--<img style="margin: 5px;" src="<%=Solution.Bussines.Components.Common.AppLogic.AppConfigs("LIVE_SERVER")%>/images/logo.png"
                                    alt="" border="0" />--%>
                                <img  border="0" style="margin: 5px;" src="" class="img_left" id="imgStoreLogo"
                                    runat="server" /></a>
                        </td>
        ...
        <%--   <tr>
            <td>
                <img alt="" title="" width="640" height="281" id="imgwelcomeBanner" runat="server" />
            </td>
        </tr>--%>
        <tr>
            <td>
