<%@ Page Title="" Language="C#" MasterPageFile="~/RMA/HPDYahoo/HPDYahoo.Master" AutoEventWireup="true"
    CodeBehind="ReturnMerchandise.aspx.cs" Inherits="Solution.UI.Web.RMA.HPDYahoo.ReturnMerchandise" %>
            ...
            <div class="static-main-box">
                <table cellspacing="0" cellpadding="0" border="0" class="table-none" width="100%">
                    <tbody>
                        ...
                        <tr id="trRreturnProduct" runat="server" visible="false">
                            <td>
                                <table cellspacing="0" cellpadding="0" border="0" width="100%" class="table_none">
                                    <tbody>
                                        <tr>
                                            <th style="padding: 2px 3px; padding-left: 10px; height: 20px" colspan="2" align="left">
                                                Return Item Details
                                            </th>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <ul>
                                                    <li><span style="color: #000000;"></span>&nbsp;Products must be Sealed, Unopened, and
                                                        in Original Packaging.</li><li><span style="color: #000000;"></span>&nbsp;Please CLEARLY
                        ...
                        <tr>
                            <td align="left" colspan="4">
                                <div id="divreturn" runat="server" style="height: 70px; width: 100%; overflow: auto;
                                ...
                                I have read and understood the return police of greenbatteries.com
