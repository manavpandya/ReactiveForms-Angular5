        ...
        protected void btnsubmit_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                ...
                if (InputCount > 1)
                {
                    ...
                    ds = CommonComponent.GetCommonDataSet("select DISTINCT CustomerID from tb_order" + str + "  where storeid=" + storid + " " + WhereClause);
                    ...
                    custid = Convert.ToInt32(CommonComponent.GetScalarCommonData(" select top 1 CustomerID from tb_order" + str + " where storeid=" + storid + " " + WhereClause));
                }
                if (custid > 0)
                {
