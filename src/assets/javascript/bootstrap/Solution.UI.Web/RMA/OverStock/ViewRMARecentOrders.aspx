<%@ Page Title="" Language="C#" MasterPageFile="~/RMA/OverStock/RMAOverStock.Master" AutoEventWireup="true" CodeBehind="ViewRMARecentOrders.aspx.cs" Inherits="Solution.UI.Web.RMA.OverStock.ViewRMARecentOrders" %>
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td style="float: right; width: 5%;">
                        <span><a id="lnkBack" runat="server" href="MyAccount.aspx" style="color: #B92127; text-decoration: underline;"
                            title="BACK">
