<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReturnPackageSlip.aspx.cs" Inherits="Solution.UI.Web.RMA.Sears.ReturnPackageSlip" %>
...
<body>
    ...
    <table width="624" border="0" align="center" cellpadding="0" cellspacing="0" class="popup_docwidth">
        <tr>
            <td>
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td>
                            <img style="margin: 5px;" src="/RMA/Sears/Images/Store_3.png" border="0" />
                        </td>
        ...
        <%-- <tr>
            <td>
                <img src="<%=Solution.Bussines.Components.Common.AppLogic.AppConfigs("LIVE_SERVER")%>/images/welcome.png"
                    alt="" title="" width="640" />
            </td>
        </tr>--%>
        <tr>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="popup_cantain">
                                        ...
                                        <table style="width: 100%;">
                                            <tr>
                                                <td style="width: 50%; text-align: left;">
                                                    <table style="width: 100%;">
                                                        <tr>
                                                            <td>Order Number: <strong style="color: #F00" id="lblOrderId">
                                                                <asp:Literal ID="ltrorderNumber" runat="server"></asp:Literal></strong>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>RMA Number: <strong style="color: #F00" id="lblRMANoId">
                                                                <asp:Label ID="lblRMANo" runat="server"></asp:Label>
                                                            </strong>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Order Date: <strong id="lblDate">
                                                                <asp:Literal ID="ltrOrderdate" runat="server"></asp:Literal></strong>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Return Date:<strong id="lblRMADate">
                                ...
                                <tr>
                                    <td>
                                        <b>Ship To: </b>
                                        <br />
                                        <asp:Literal ID="ltrShipToAddr" runat="server"></asp:Literal>
                                    </td>
                                </tr>
                                <%--  <tr>
                                    <td>
        ...
        <tr>
            <td class="pop_bottom_link">&copy; 2013.
