...
namespace Solution.UI.Web.RMA.Sears
{
    public partial class ViewRMARecentOrders : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //{
            lnkBack.HRef = "/rma/Sears/returnitem.aspx";
            //}
            ...
            if (DsOrder != null && DsOrder.Tables.Count > 0 && DsOrder.Tables[0].Rows.Count > 0)
            {
                ...
                if (dr != null && dr.Length > 0)
                {
                    ...
                    foreach (DataRow drOrderNums in dr)
                    {
                        ...
                        dsOrder = objOrder.GetViewRecentForRMAOrderByOrderID(Convert.ToInt32(drOrderNums["OrderNumber"].ToString()), Convert.ToInt32(GetConfigvalue("StoreID", TempStoreID)));
                        if (dsOrder != null && dsOrder.Tables.Count > 0 && dsOrder.Tables[0].Rows.Count > 0)
                        {
                            ...
                            DsCartDetail = objOrder.GetCartItemForViewRecentOrder(Convert.ToInt32(dsOrder.Tables[0].Rows[0]["ShoppingCardID"].ToString()), Convert.ToInt32(dsOrder.Tables[0].Rows[0]["OrderNumber"].ToString()), Convert.ToInt32(GetConfigvalue("StoreID",TempStoreID)));
