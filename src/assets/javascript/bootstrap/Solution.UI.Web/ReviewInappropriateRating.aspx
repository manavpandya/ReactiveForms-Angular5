<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReviewInappropriateRating.aspx.cs"
    Inherits="Solution.UI.Web.ReviewInappropriateRating" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function checkfields() {
            ...
            if (document.getElementById('<%=txtLink.ClientID %>') != null && document.getElementById('<%=txtLink.ClientID %>').value == '') {
                alert("Please enter Link to Inappropriate Content.");
                document.getElementById('<%=txtLink.ClientID %>').focus();
                return false;
            }
            if (document.getElementById('<%=txtMessage.ClientID %>') != null && document.getElementById('<%=txtMessage.ClientID %>').value == '') {
...
<body>
                ...
                <table width="100%" border="0" cellpadding="4" cellspacing="0" style="width: 570px">
                    ...
                    <tr>
                        <td style="width: 180px;">
                            <span class="checkout-red">*</span>Name
                        </td>
                        <td style="width: 10px;">
                            :
                        </td>
                        <td>
                            <asp:TextBox ID="txtName" runat="server" CssClass="name-input" MaxLength="50"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <span class="checkout-red">*</span>Link to Inappropriate Content
                        </td>
                        <td>
                            :
                        </td>
                        <td>
                            <asp:TextBox ID="txtLink" runat="server" CssClass="name-input"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <span class="checkout-red">*</span>Message
                        </td>
                        <td>
                            :
                        </td>
                        <td>
                            <asp:TextBox ID="txtMessage" TextMode="MultiLine" Columns="45" Rows="5" runat="server"
                                CssClass="contact-textaria" MaxLength="20"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
    ...
    <div id="prepage" style="position: absolute; font-family: arial; font-size: 16; left: 0px;
        ...
        height: 515px; width: 1015px; z-index: 1000; display: none;">
