<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RomanItemPageRating.aspx.cs" Inherits="Solution.UI.Web.RomanItemPageRating" %>
 ...
 <style>
    ...
    <script type="text/javascript">
        ...
        function ShowModelForfaq() {
            ...
            window.scrollTo(0, 0);
            document.getElementById('btnhelpdescri').click();
            document.getElementById("frmdisplay1").contentWindow.document.body.innerHTML = '<link href="/css/style.css" rel="stylesheet" type="text/css" /><div class=\"static-title\"><span style=\"padding-left: 10px;\">FAQ</span></div>' + document.getElementById('divfaq').innerHTML;
        }
        ...
        function ShowModelForPleatGuide() {
            ...
            window.scrollTo(0, 0);
            document.getElementById('btnhelpdescri').click();
            document.getElementById("frmdisplay1").contentWindow.document.body.innerHTML = '<link href="/css/style.css" rel="stylesheet" type="text/css" />' + document.getElementById('divPleatGuide').innerHTML;
        }
                ...
                $.ajax(
                                    {
                                        ...
                                        success: function (msg) {
                                            ...
                                            document.getElementById('ContentPlaceHolder1_divYourPrice').innerHTML = '<tt>Your Price :</tt> <strong>$' + saleprice.toFixed(2) + '</strong> <span>' + document.getElementById('ContentPlaceHolder1_hdnSalePriceTag').value + '</span>';
    ...
    <script type="text/javascript">
        ...
        function ShowInventoryMessage(result) {
            ...
            window.scrollTo(0, 0);
            document.getElementById("frmdisplay").contentWindow.document.body.innerHTML = '<link href="/css/style.css" rel="stylesheet" type="text/css" />' + result;
            centerPopup();
            loadPopup();
        }
    </script>
           ...
           <div class="item-row1">
               ...
               <div class="item-right">
                        <div class="item-main-title">
                            <h1><asp:Literal ID="ltrProductName" runat="server"></asp:Literal></h1>
                            </div>
                                                        ...
                                                        <div class="price-detail">
                                                            <div class="price-detail-left" style="width: 100%;">
                                                                ...
                                                                <p id="divYourPrice" runat="server">
                                                                    <tt>Your Price :</tt> <strong>$--&nbsp;<asp:Literal ID="ltYourPrice" runat="server"></asp:Literal></strong>(Per Panel)
                                                            ...
                                                            <div class="item-details-box" style="margin-bottom: 10px; display: none; position: relative;
                                                                ...
                                                                <div id="divmain" style="display: none;">
                                                                    ...
                                                                    <p style="padding: 0px 0 0 5px;">
                                                                        ...
                                                                        Monogram fonts should have exactly 3 initials.</p>
                                                                    ...
                                                                    <span class="item-link"><a href="javascript:void(0);" style="display: block;" onclick="checkTest();">
                                                                        [ + ] Add Another Personalized Product</a> <a href="javascript:void(0);" style="display: none;"
        ...
        <div id="divProductReview" runat="server" class="item-left-row5" style="border-top: 1px solid #DDDDDD;">
            ...
            <div class="review-detail-bg" id="divPostComment" runat="server" style="width: 50%;">
                ...
                <div id="ContentPlaceHolder1_upProductReview">
                    <div id="ContentPlaceHolder1_pnlpostComment" onkeypress="javascript:return WebForm_FireDefaultButton(event,'ContentPlaceHolder1_btnsubmit')">
                    ...
                    <div class="item-main-title">
                        ...
                        <div class="rating">
                            ...
                            <p>
                                ...
                                <a id="awrite" runat="server">Write a Review</a></p>
                        </div>
                    </div>
                            ...
                            <p class="item-pro-title" id="divNextBack" runat="server">
                                ...
                                <a href="javascript:void(0);" style="margin-left: 15px;" class="item-prev" onmouseout="document.getElementById('ContentPlaceHolder1_imgPrev').style.display = 'none';"
                                    ...
                                    <img style="border: 1px solid #eee; width: 100px; height: 120px; position: absolute;
                                        display: none; z-index: 1;" id="imgPrev" runat="server" />
                                </a>
                    ...
                    <div class="item-right-row1" id="divdiscription" runat="server">
                        <div class="item-right-row1-title1">
                            <span>Product Description</span><asp:ImageButton ID="btnAddTocartSwatch" runat="server"
                                ToolTip="Order Swatch" ImageUrl="/images/swatch-add-to-cart.jpg" CssClass="order-swatch" /></div>
                    ...
                    <div class="item-right-row1" id="divProductProperty" runat="server">
                        ...
                        <div class="item-right-row1-bg" id="divproperty1" style="display: none;">
                            <div class="properties-main">
                                <div class="properties1" id="divLightControl" runat="server" visible="false" style="background: none;
                                    border: none; width: 675px;">
                                    ...
                                    <div class="item-detail-row31" id="divPrivacy" runat="server" visible="false" style="width: 213px;
...
&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=21" scrolling="no" frameborder="0" style="border: none;
                                    ...
                                    <div class="img-left">
                                        <img src="/images/instagram.png" alt="Instagram" title="Instagram" border="0" style="height: 20px" />&nbsp;</div>
                        ...
                        <div id="divBookmarkLinks" runat="server" class="item-left-row2">
                            <a id="lnkPriceMatch" runat="server" visible="false" title="PRICE MATCH" href="javascript:void(0);">
                                Price Match</a>
                            <label id="lblafterpricematch" runat="server">
                            </label>
                            <a href="javascript:void(0);" onclick="ShowModelForPleatGuide();" title="Pleat Guide">
                                Pleat Guide</a>| <a href="javascript:void(0);" onclick="ShowModelForfaq();" title="FAQ">
                                    FAQ</a>|<a href="javascript:void(0);" onclick="ShowModelForMeasuringguide();" title="Measuring Guide">Measuring
                                        Guide</a>|<a href="javascript:void(0);" title="Design Guide">Design Guide</a>
