<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="subcategory.aspx.cs" Inherits="Solution.UI.Web.subcategory" %>
...
&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=21" scrolling="no"
    ...
    <%--</div>--%>
    <div class="option-pro-main" id="hideIndexOptionDiv" runat="server"  visible="false">
            ...
            <ContentTemplate>
                ...
                <div id="topNumber" runat="server">
                    <div class="numbering" style="border-bottom: 1px solid #DDDDDD;">
                        <p style="width: 5%; font-weight: bold; margin-top: 5px;" id="divtopitemcount" runat="server" class="numbering-pt1">
                        ...
                        <p id="Div2" runat="server" style="padding-left: 13px; width: 9%; font-weight: bold;
                            vertical-align: middle;" class="numbering-pt2">
                        ...
                        <p style="width: 15%; font-weight: bold; margin-top: 2px;" class="numbering-pt3">
                         ...
                         By Color :
                            <asp:DropDownList ID="ddltopcolor" runat="server" CssClass="select-box" AutoPostBack="True"
                                onchange="javascript:document.getElementById('ContentPlaceHolder1_hdnallpages').value='11';Loader();"
                                OnSelectedIndexChanged="ddltopcolor_SelectedIndexChanged">
                                ...
                                <div class="fp-box" id="Probox" runat="server">
                                    <div class="fp-display">
                                        <div class="fp-box-div" id="proDisplay" runat="server">
                                            <div class="img-center" id="divswatchlistadd" runat="server">
                                        ...
                                        <div class="add-to-compare">
                                            <span><span>
                                                <input type="checkbox" id="add_to_compare<%#Eval("ProductID")%>" onchange="comaprebutonclick('add_to_compare<%#Eval("ProductID")%>');"
                                                    onclick="comaprebutonclick('add_to_compare<%#Eval("ProductID")%>');" />&nbsp;&nbsp;Add
                                                        ...
                                                        <div class="img-center" id="divswatchlistadd" runat="server">
                                                            <a id="innerAddtoCart" runat="server">
                                                                <asp:Image ImageUrl='<%# GetIconImageProduct(Convert.ToString(Eval("ImageName"))) %>'
                                                                    ...
                                                                    ToolTip='<%# Server.HtmlEncode(Convert.ToString(Eval("Name")))%>' runat="server"
                                                                    Width="230" Height="309" /></a>
                                                            <img id="imgAddToCart" runat="server" src="/images/quick-view-addtocart.png" alt="ADD TO CART"
                                                                class="preview" width="135" height="30" title="ADD TO CART" style="cursor: pointer;" />
                                                            <input type="hidden" id="hdnImgName" runat="server" value='<%#Eval("ImageName") %>' />
                                                            <asp:Literal ID="lblTag" runat="server"></asp:Literal>
                                                            <asp:Label ID="lblTName" Visible="false" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"TagName")%>'></asp:Label>
                                                        </div>
                ...
                <div id="topBottom" runat="server">
                    ...
                    <div class="numbering" style="border-bottom: 1px solid #DDDDDD;">
                        <p style="width: 5%; font-weight: bold; margin-top: 5px;" id="divbottomitemcount"
                            runat="server" class="numbering-pt1">
                        ...
                        <p style="width: 15%; font-weight: bold; margin-top: 2px;" class="numbering-pt3">
                          ...
                          <p style="width: 17%; font-weight: bold; margin-top: 2px;" class="numbering-pt3">
                         By Color :
                            <asp:DropDownList ID="ddlbottomcolor" runat="server" CssClass="select-box" AutoPostBack="True"
                                onchange="javascript:document.getElementById('ContentPlaceHolder1_hdnallpages').value='11';Loader();"
                                OnSelectedIndexChanged="ddlbottomcolor_SelectedIndexChanged">
