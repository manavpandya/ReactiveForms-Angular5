...
{
    public partial class TellAfriendPopup : System.Web.UI.Page
    {
        /// <summary>
        ...
        private void SendEmail(String ToAddress)
        {
            ...
            dsMailTemplate = objCustomer.GetEmailTamplate("TellAFriend", Convert.ToInt32(AppLogic.AppConfigs("StoreID")));
