<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WarhouseVendorProducts.aspx.cs"
    Inherits="Solution.UI.Web.WarhouseVendorProducts" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>WarHouse Vendor Product</title>
                                                                ...
                                                                <asp:TemplateField>
                                                                    ...
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <asp:DropDownList OnSelectedIndexChanged="availdays_SelectedIndexChanged" AutoPostBack="true"
                                                                            ID="drpAvailDays" runat="server" CssClass="select-box">
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" border="0" style="border: solid 1px #dfdfdf;"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center" valign="top" style="padding: 10px;">
                                                                            <asp:TextBox ID="txtNotes" runat="server" class="text-field" Height="75px" TextMode="MultiLine"
                                                                                Width="700px">
                                                                            </asp:TextBox>
                                                                        </td>
                                                                    </tr>
                                            ...
                                            <tr>
                                                <td align="center" style="padding-bottom: 10px;">
                                                    <asp:ImageButton ID="btnsubmit" runat="server" alt="SUBMIT" title="SUBMIT" OnClientClick="loader();"
                                                        OnClick="btnsubmit_Click" ImageUrl="/images/finish.jpg" />
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
