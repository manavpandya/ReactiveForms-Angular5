...
function ValidationNotLogin() {
    ...
    if (CreateAccORLoginValidation()) {
		...
		if (document.getElementById('ContentPlaceHolder1_rdlPaymentType_0') != null) {
                    document.getElementById('ContentPlaceHolder1_rdlPaymentType_1').checked = false;
                    document.getElementById('ContentPlaceHolder1_rdlPaymentType_0').checked = true;
                }
            ...
            if (document.getElementById('ContentPlaceHolder1_chkreturnpolicy') != null && document.getElementById('ContentPlaceHolder1_chkreturnpolicy').checked == false) {
                ...
                {
                     if(document.getElementById('ContentPlaceHolder1_btnPlaceOrder') != null)
{
document.getElementById('ContentPlaceHolder1_btnPlaceOrder').style.display = 'none';
}
if (document.getElementById('ContentPlaceHolder1_btncreditcard') != null) {
                                document.getElementById('ContentPlaceHolder1_btncreditcard').style.display = 'none';
                            }
                            if (document.getElementById('ContentPlaceHolder1_btnpaypal') != null) {
                                document.getElementById('ContentPlaceHolder1_btnpaypal').style.display = 'none';
                            }
...
document.getElementById('prepage').style.display = 'none';
                ...
                return true;
                    ...
                    if (document.getElementById('ContentPlaceHolder1_hdnischargelogic') != null && document.getElementById('ContentPlaceHolder1_hdnischargelogic').value == "1") {
                        if (document.getElementById('ContentPlaceHolder1_rdlPaymentType_0') != null) {
                            document.getElementById('ContentPlaceHolder1_rdlPaymentType_0').checked = false;
if (document.getElementById('ContentPlaceHolder1_hdnNext') != null && document.getElementById('ContentPlaceHolder1_hdnNext').value == "3") {  
                 }
                        }
                    }
                    return false;
...
function ValidationLoginuserOtherPayment() {
    ...
    if (ValidatePage()) {
		...
		if (document.getElementById('ContentPlaceHolder1_rdlPaymentType_1') != null) {
                    document.getElementById('ContentPlaceHolder1_rdlPaymentType_1').checked = true;
                    document.getElementById('ContentPlaceHolder1_rdlPaymentType_0').checked = false;
                }
...
if (document.getElementById('ContentPlaceHolder1_chkCreateNewAccountGuest') != null && document.getElementById('ContentPlaceHolder1_chkCreateNewAccountGuest').checked == true) {
     
    copyemail('ContentPlaceHolder1_txtGuestemail', 'ContentPlaceHolder1_txtBillEmail', 'ContentPlaceHolder1_txtShipEmailAddress');
}
else if (document.getElementById('ContentPlaceHolder1_chkCreateNewAccount') != null && document.getElementById('ContentPlaceHolder1_chkCreateNewAccount').checked == true) {
 
    copyemail('ContentPlaceHolder1_txtCreateEmail', 'ContentPlaceHolder1_txtBillEmail', 'ContentPlaceHolder1_txtShipEmailAddress');
}
...
function ValidatePage() {
    ...
    if (document.getElementById("ContentPlaceHolder1_txtBillFirstname") != null && document.getElementById("ContentPlaceHolder1_txtBillFirstname").value.replace(/^\s+|\s+$/g, "") == '') {
       ...
       // }
        ...
        else if (document.getElementById("ContentPlaceHolder1_chkcopy") != null) {
...
function checkcreditcard() {
    ...
    if (document.getElementById('ContentPlaceHolder1_hdnischargelogic') != null && document.getElementById('ContentPlaceHolder1_hdnischargelogic').value == "1")
    {
        ...
        if (document.getElementById('ContentPlaceHolder1_rdlPaymentType_0') != null && document.getElementById('ContentPlaceHolder1_rdlPaymentType_0').checked == false) {
...
function checkShippingdata() {
    ...
    if (document.getElementById("ContentPlaceHolder1_ddlShipCounry") != null && document.getElementById("ContentPlaceHolder1_ddlShipCounry").selectedIndex == 0) {

        alert("Please Select Shipping Country.");
        $('html, body').animate({ scrollTop: $('#ContentPlaceHolder1_ddlShipCounry').offset().top - 100 }, 'slow');
        document.getElementById("ContentPlaceHolder1_ddlShipCounry").focus();
        ...
        alert("Please Select Shipping State.");
        $('html, body').animate({ scrollTop: $('#ContentPlaceHolder1_ddlShipState').offset().top - 100 }, 'slow');
        document.getElementById("ContentPlaceHolder1_ddlShipState").focus();
        ...
        alert("Please Enter Shipping Zip Code.");
        $('html, body').animate({ scrollTop: $('#ContentPlaceHolder1_txtShipZipCode').offset().top - 100 }, 'slow');
        document.getElementById("ContentPlaceHolder1_txtShipZipCode").focus();
...
function ShowShipButton() {
    ...
    if (document.getElementById("ContentPlaceHolder1_btnReloadShipping") != null) {
        if (document.getElementById("ContentPlaceHolder1_btnReloadShipping").style.display == "none") {
            document.getElementById("ContentPlaceHolder1_btnReloadShipping").style.display = "block";
        }
    }
...
function ValidatebtnNextGuest() {
    if (CreateAccORLoginValidation()) {

        if (document.getElementById("ContentPlaceHolder1_trbillrow").style.display == "none") {
            document.getElementById("ContentPlaceHolder1_trbillrow").style.display = '';
        }

        if (document.getElementById("ContentPlaceHolder1_trcardnumdetail").style.display == "none") {
            document.getElementById("ContentPlaceHolder1_trcardnumdetail").style.display = '';
        }
        document.getElementById("ContentPlaceHolder1_btnNextGuest").style.display = "none"
...
/*function ValidatebtnNextAddress() {
    if (ValidatePage()) {
      
        if (document.getElementById("ContentPlaceHolder1_trshipping").style.display == "none") {
            document.getElementById("ContentPlaceHolder1_trshipping").style.display = '';
        }
        document.getElementById("ContentPlaceHolder1_btnNextAddress").style.display = "none";
        document.getElementById("ContentPlaceHolder1_hdnNext").value = "2";
        document.getElementById("ContentPlaceHolder1_btnNextShipping").style.display = '';
        return false;
    }
    else {
        return false;
...
function ValidatebtnNextShipping() {
    if (ShippingValidation()) {
       
        //document.getElementById("ContentPlaceHolder1_btnNextShipping").style.display = "none";
        document.getElementById("ContentPlaceHolder1_hdnNext").value = "3";
...
function CheckemailExists()
{
    ...
    document.getElementById("ContentPlaceHolder1_btnNextCreateAcc").style.display = "none";
    document.getElementById("ContentPlaceHolder1_hdnNext").value = "1";
    document.getElementById("ContentPlaceHolder1_btnNextAddress").style.display = '';
}
function ValidatebtnNextCreateAcc() {
    if (CreateAccORLoginValidation()) {
...
if (document.getElementById('prepage') != null) {
    ...
    if (document.getElementById('ContentPlaceHolder1_hdnNext') != null) {
        if (document.getElementById('ContentPlaceHolder1_hdnNext').value != null && document.getElementById('ContentPlaceHolder1_hdnNext').value != " ") {
            var hdnval = document.getElementById('ContentPlaceHolder1_hdnNext').value;
           
            if (parseInt(hdnval) >= 0) {
                if (document.getElementById('ContentPlaceHolder1_chkCreateNewAccount') != null) {
                ...
                if (document.getElementById('ContentPlaceHolder1_chkReturningAcHolder') != null) {
                ...
                if (document.getElementById('ContentPlaceHolder1_chkCreateNewAccountGuest') != null) {
                    if (document.getElementById('ContentPlaceHolder1_chkCreateNewAccountGuest').checked) {
                        document.getElementById("ContentPlaceHolder1_trCreAccChangePass01").style.display = "none";
                        document.getElementById("ContentPlaceHolder1_trCreAccChangePass02").style.display = "none";
                        document.getElementById("ContentPlaceHolder1_trguest").style.display = '';
		 ...
		 document.getElementById("ContentPlaceHolder1_trordernotes").style.display = "none";
            ...
            if (parseInt(hdnval) >= 3) {
                document.getElementById("ContentPlaceHolder1_btnNextAddress").style.display = "none";
                document.getElementById("ContentPlaceHolder1_btnNextCreateAcc").style.display = "none";
                document.getElementById("ContentPlaceHolder1_btnNextGuest").style.display = "none";
              
                document.getElementById("ContentPlaceHolder1_trPaymentMethods").style.display = '';
                document.getElementById("ContentPlaceHolder1_divplaceorder").style.display = '';
                document.getElementById("ContentPlaceHolder1_btnNextShipping").style.display = "none";
		 document.getElementById("ContentPlaceHolder1_trordernotes").style.display = '';
...
function checkradiopostback() {
    if (document.getElementById('ContentPlaceHolder1_rdlPaymentType') != null) {
        var tableHTml = document.getElementById('ContentPlaceHolder1_rdlPaymentType').innerHTML;

        tableHTml = tableHTml.replace("javascript:setTimeout('__doPostBack(\\'ctl00$ContentPlaceHolder1$rdlPaymentType$0\\',\\'\\')', 0)", "");
        tableHTml = tableHTml.replace("setTimeout('__doPostBack(\\'ctl00$ContentPlaceHolder1$rdlPaymentType$0\\',\\'\\')', 0)", "");

        document.getElementById('ContentPlaceHolder1_rdlPaymentType').innerHTML = tableHTml;
    }

}

function ValidationLoginuserradio() {
...
if (document.getElementById('ContentPlaceHolder1_hdnNext') != null && document.getElementById('ContentPlaceHolder1_hdnNext').value == "3") {  
                ...
                else { Loader(); __doPostBack("ctl00$ContentPlaceHolder1$rdlPaymentType$0", ""); return false; }
            }
            else {
                if (document.getElementById('ContentPlaceHolder1_rdlPaymentType_0') != null) {
                    document.getElementById('ContentPlaceHolder1_rdlPaymentType_0').checked = false;
...
function ValidationNotLoginradio() {
...
if (document.getElementById('ContentPlaceHolder1_hdnNext') != null && document.getElementById('ContentPlaceHolder1_hdnNext').value == "3") {    
                        ...
                        Loader();
                        __doPostBack("ctl00$ContentPlaceHolder1$rdlPaymentType$0", "");
                        return false;
                    }
                }
                else {
