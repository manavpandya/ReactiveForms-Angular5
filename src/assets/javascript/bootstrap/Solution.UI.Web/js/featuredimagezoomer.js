...
var featuredimagezoomer = {
    loadinggif: '/images/imgloader.gif', //full path or URL to "loading" gif
    ...
    showimage: function ($, $tracker, $mag, showstatus) {
        ...
        $mag.css({ left: magcoords.left - 7, top: coords.top - 1 }).show(); //position magnifier DIV on page
        //specs.$statusdiv.html(''+specs.curpower+'');
    ...
    init: function ($, $img, options) {
        ...
        $magnifier = $('<div class="magnifyarea" style="position:absolute;height:700px;width:700px;left:-10000px;top:-10000px;visibility:hidden;overflow:hidden;border:1px solid #ebebeb;z-index:100000;background-color:#fff;" />')
        ...
        $tracker = $('<div class="zoomtracker image-zoomer" style="cursor:progress;position:absolute;left:' + o.left + 'px;top:' + o.top + 'px;height:' + h + 'px;width:' + w + 'px;" />')
        ...
        $tracker.one('mouseover', function (e) {
            ...
            $bigimage.bind('loadevt', function () { //magnified image ONLOAD event function (to be triggered later)
                ...
                $statusdiv.empty().css({ border: '0px', background: 'none', padding: '4px', font: 'bold 13px Arial', opacity: 0.8 }).hide().removeClass('preloadevt');
