...
function checkfields() {
    ...
    if (document.getElementById('ContentPlaceHolder1_txtFirstName') != null && document.getElementById('ContentPlaceHolder1_txtFirstName').value.trim() == '') {
        alert('Please enter First Name.');
        document.getElementById('ContentPlaceHolder1_txtFirstName').focus();
        return false;
    }
    if (document.getElementById('ContentPlaceHolder1_txtLastName') != null && document.getElementById('ContentPlaceHolder1_txtLastName').value.trim() == '') {
        alert("Please enter Last Name.");
        document.getElementById('ContentPlaceHolder1_txtLastName').focus();
        return false;
    }

    if (document.getElementById('ContentPlaceHolder1_txttelephone') != null && document.getElementById('ContentPlaceHolder1_txttelephone').value.trim() == '') {
        alert("Please enter phone Number.");
        document.getElementById('ContentPlaceHolder1_txttelephone').focus();
        return false;
    }
    if (document.getElementById('ContentPlaceHolder1_txtEmail') != null && document.getElementById('ContentPlaceHolder1_txtEmail').value.trim() == '') {
        alert("Please enter Email.");
        document.getElementById('ContentPlaceHolder1_txtEmail').focus();
        return false;
    }
    else if (document.getElementById('ContentPlaceHolder1_txtEmail') != null && document.getElementById('ContentPlaceHolder1_txtEmail').value != '' && !checkemail1(document.getElementById('ContentPlaceHolder1_txtEmail').value.trim())) {
...
function clearfields() {
    ...
    document.getElementById('ContentPlaceHolder1_txtInstruction').value = '';
