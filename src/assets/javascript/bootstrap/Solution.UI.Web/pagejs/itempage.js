...
function showhidefeatures() {
    if (document.getElementById('aproductfeature') != null) {
        if (document.getElementById('divfeature') != null) {
            $('#divfeature').slideToggle();
        }
        if (document.getElementById('aproductfeature').innerHTML.toString().toLowerCase().indexOf('show') > -1) {
            document.getElementById('aproductfeature').innerHTML = 'Hide More Products Details';
        }
        else {
            document.getElementById('aproductfeature').innerHTML = 'Show More Products Details';
        }
...
function ChangeCustomprice() {
    ...
    if (document.getElementById('ContentPlaceHolder1_ddlcustomstyle') != null) {
        if (document.getElementById('ContentPlaceHolder1_ddlcustomstyle').selectedIndex == 0) {
            document.getElementById('ContentPlaceHolder1_ddlcustomstyle').innerHTML = '';
        }
        else {
            if (document.getElementById('divheaderimg') != null) {

                if (document.getElementById('ContentPlaceHolder1_ddlcustomstyle').options[document.getElementById('ContentPlaceHolder1_ddlcustomstyle').selectedIndex].text.toString().toLowerCase().indexOf("pole pocket") > -1) {
                    document.getElementById('divheaderimg').innerHTML = '<img src="/images/pole_pocket_header.jpg" alt="Pole Pocket" title="Pole Pocket" />';
                }
                else if (document.getElementById('ContentPlaceHolder1_ddlcustomstyle').options[document.getElementById('ContentPlaceHolder1_ddlcustomstyle').selectedIndex].text.toString().toLowerCase().indexOf("french pleat") > -1) {
                    document.getElementById('divheaderimg').innerHTML = '<img src="/images/french_pleat.jpg" alt="French Pleat" title="French Pleat" />';
                }
                else if (document.getElementById('ContentPlaceHolder1_ddlcustomstyle').options[document.getElementById('ContentPlaceHolder1_ddlcustomstyle').selectedIndex].text.toString().toLowerCase().indexOf("inverted pleat") > -1) {
                    document.getElementById('divheaderimg').innerHTML = '<img src="/images/inverted_pleat.jpg" alt="Inverted Pleat" title="Inverted Pleat" />';
                }
                else if (document.getElementById('ContentPlaceHolder1_ddlcustomstyle').options[document.getElementById('ContentPlaceHolder1_ddlcustomstyle').selectedIndex].text.toString().toLowerCase().indexOf("parisian pleat") > -1) {
                    document.getElementById('divheaderimg').innerHTML = '<img src="/images/parisian_pleat.jpg" alt="Parisian Pleat" title="Parisian Pleat" />';
                }
                else if (document.getElementById('ContentPlaceHolder1_ddlcustomstyle').options[document.getElementById('ContentPlaceHolder1_ddlcustomstyle').selectedIndex].text.toString().toLowerCase().indexOf("goblet pleat") > -1) {
                    document.getElementById('divheaderimg').innerHTML = '<img src="/images/goblet_pleat.jpg" alt="Goblet Pleat" title="Goblet Pleat" />';
                }
            }
        ...
        $.ajax(
                           {
                               ...
                               success: function (msg) {
                                   ...
                                   if (document.getElementById('divcustomprice') != null) {
                                       ...
                                       $('#divcustomprice').html('$' + msg.d + '' + SalePriceTag);
                                       if (document.getElementById('ContentPlaceHolder1_btnAddTocartMade') != null) {
...
function ShowModelForPleatGuide() {
   ...
   // document.getElementById('btnhelpdescri').click();
    ...
    //$('.fancybox-iframe').src = '';
    //alert('test');
    //$('.fancybox-iframe').contents().html('<link href="' + root + '/css/style.css" rel="stylesheet" type="text/css" />' + document.getElementById('divPleatGuide').innerHTML);
}
